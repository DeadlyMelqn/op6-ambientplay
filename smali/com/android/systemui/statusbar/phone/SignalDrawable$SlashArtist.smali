...
.method draw(IILandroid/graphics/Canvas;Landroid/graphics/Paint;)V
    ...
    invoke-direct {p0, v2, p2}, Lcom/android/systemui/statusbar/phone/SignalDrawable$SlashArtist;->scale(FI)F
    ...
    invoke-direct {p0, v3, p1}, Lcom/android/systemui/statusbar/phone/SignalDrawable$SlashArtist;->scale(FI)F
    ...
    invoke-direct {p0, v4, p2}, Lcom/android/systemui/statusbar/phone/SignalDrawable$SlashArtist;->scale(FI)F
    ...
    invoke-direct {p0, v5, p1}, Lcom/android/systemui/statusbar/phone/SignalDrawable$SlashArtist;->scale(FI)F

    move-result v5

    .line 482
    invoke-virtual {p0, v2, v3, v4, v5}, Lcom/android/systemui/statusbar/phone/SignalDrawable$SlashArtist;->updateRect(FFFF)V

    .line 488
    iget-object v2, p0, Lcom/android/systemui/statusbar/phone/SignalDrawable$SlashArtist;->mPath:Landroid/graphics/Path;
    ...
    iget-object v3, p0, Lcom/android/systemui/statusbar/phone/SignalDrawable$SlashArtist;->mSlashRect:Landroid/graphics/RectF;
    ...
    invoke-virtual {v0, v6, v2, v3}, Landroid/graphics/Matrix;->setRotate(FFF)V
