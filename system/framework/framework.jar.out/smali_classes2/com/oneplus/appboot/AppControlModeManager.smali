...
.method public static getAllAppControlModes(I)Ljava/util/List;
    ...
    invoke-interface {v1, p0}, Lcom/oneplus/os/IOnePlusService;->getAllAppControlModes(I)Ljava/util/List;
    :try_end_0
...
.method public static getAppControlMode(Ljava/lang/String;I)I
    ...
    invoke-interface {v1, p0, p1}, Lcom/oneplus/os/IOnePlusService;->getAppControlMode(Ljava/lang/String;I)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static getAppControlState(I)I
    ...
    invoke-interface {v1, p0}, Lcom/oneplus/os/IOnePlusService;->getAppControlState(I)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static setAppControlMode(Ljava/lang/String;II)I
    ...
    invoke-interface {v1, p0, p1, p2}, Lcom/oneplus/os/IOnePlusService;->setAppControlMode(Ljava/lang/String;II)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static setAppControlState(II)I
    ...
    invoke-interface {v1, p0, p1}, Lcom/oneplus/os/IOnePlusService;->setAppControlState(II)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
