...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 461
    .local v55, "_result":Landroid/security/keymaster/ExportResult;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 449
    .end local v9    # "_arg4":I
    .end local v55    # "_result":Landroid/security/keymaster/ExportResult;
    :cond_8
    const/16 v21, 0x0
    ...
    .restart local v9    # "_arg4":I
    .restart local v55    # "_result":Landroid/security/keymaster/ExportResult;
    :cond_a
    const/4 v4, 0x0
    ...
    .line 494
    .local v58, "_result":Landroid/security/keymaster/OperationResult;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v58    # "_result":Landroid/security/keymaster/OperationResult;
    :cond_b
    const/16 v41, 0x0
    ...
    .restart local v58    # "_result":Landroid/security/keymaster/OperationResult;
    :cond_d
    const/4 v4, 0x0
    ...
    .line 622
    .local v52, "_arg2":Landroid/security/keymaster/KeymasterCertificateChain;
    move-object/from16 v0, p0
    ...
    .line 618
    .end local v52    # "_arg2":Landroid/security/keymaster/KeymasterCertificateChain;
    .end local v54    # "_result":I
    :cond_13
    const/4 v13, 0x0
    ...
    .line 630
    .end local v13    # "_arg1":Landroid/security/keymaster/KeymasterArguments;
    .restart local v52    # "_arg2":Landroid/security/keymaster/KeymasterCertificateChain;
    .restart local v54    # "_result":I
    :cond_14
    const/4 v4, 0x0
    ...
    .line 646
    .local v50, "_arg1":Landroid/security/keymaster/KeymasterCertificateChain;
    move-object/from16 v0, p0
    ...
    .line 642
    .end local v50    # "_arg1":Landroid/security/keymaster/KeymasterCertificateChain;
    .end local v54    # "_result":I
    :cond_15
    const/16 v48, 0x0

    .local v48, "_arg0":Landroid/security/keymaster/KeymasterArguments;
    goto :goto_15

    .line 654
    .end local v48    # "_arg0":Landroid/security/keymaster/KeymasterArguments;
    .restart local v50    # "_arg1":Landroid/security/keymaster/KeymasterCertificateChain;
    .restart local v54    # "_result":I
    :cond_16
    const/4 v4, 0x0
