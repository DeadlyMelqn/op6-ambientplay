...
.method static synthetic -get0(Landroid/telecom/Call;)Ljava/util/List;
    .locals 1
    .param p0, "-this"    # Landroid/telecom/Call;
...
.method static synthetic lambda$-android_telecom_Call_73393(Landroid/telecom/Call$Callback;Landroid/telecom/Call;I)V
    .locals 0
...
.method static synthetic lambda$-android_telecom_Call_73734(Landroid/telecom/Call$Callback;Landroid/telecom/Call;I)V
    .locals 0
    .param p0, "callback"    # Landroid/telecom/Call$Callback;
    .param p1, "call"    # Landroid/telecom/Call;
    .param p2, "reason"    # I
...
.method static synthetic lambda$-android_telecom_Call_80443(Landroid/telecom/Call$Callback;Landroid/telecom/Call;ZLandroid/telecom/Call$RttCall;)V
    .locals 0
    .param p0, "callback"    # Landroid/telecom/Call$Callback;
    .param p1, "call"    # Landroid/telecom/Call;
    .param p2, "enabled"    # Z
...
.method static synthetic lambda$-android_telecom_Call_80882(Landroid/telecom/Call$Callback;Landroid/telecom/Call;I)V
    .locals 0
    .param p0, "callback"    # Landroid/telecom/Call$Callback;
    .param p1, "call"    # Landroid/telecom/Call;
    .param p2, "mode"    # I
...
.method final internalUpdate(Landroid/telecom/ParcelableCall;Ljava/util/Map;)V
    ...
    .line 1722
    .local v13, "details":Landroid/telecom/Call$Details;
    ...
    .line 1728
    .local v8, "cannedTextResponsesChanged":Z
    move-object/from16 v0, p0
    ...
    .line 1737
    .local v16, "newVideoCallImpl":Landroid/telecom/VideoCallImpl;
    ...
    .line 1753
    .local v21, "parentId":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 1759
    .local v9, "childCallIds":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    move-object/from16 v0, p0
    ...
    .line 1767
    .local v11, "conferenceableCallIds":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .line 1768
    .local v12, "conferenceableCalls":Ljava/util/List;, "Ljava/util/List<Landroid/telecom/Call;>;"
    invoke-interface {v11}, Ljava/lang/Iterable;->iterator()Ljava/util/Iterator;

    move-result-object v18

    .local v18, "otherId$iterator":Ljava/util/Iterator;
    :cond_7
    :goto_2
    ...
    .line 1769
    .local v17, "otherId":Ljava/lang/String;
    ...
    .line 1737
    .end local v9    # "childCallIds":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local v10    # "childrenChanged":Z
    .end local v11    # "conferenceableCallIds":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local v12    # "conferenceableCalls":Ljava/util/List;, "Ljava/util/List<Landroid/telecom/Call;>;"
    .end local v17    # "otherId":Ljava/lang/String;
    .end local v18    # "otherId$iterator":Ljava/util/Iterator;
    .end local v20    # "parentChanged":Z
    .end local v21    # "parentId":Ljava/lang/String;
    .end local v23    # "state":I
    .end local v24    # "stateChanged":Z
    :cond_8
    const/16 v25, 0x0

    .local v25, "videoCallChanged":Z
    goto/16 :goto_0

    .line 1747
    .end local v25    # "videoCallChanged":Z
    .restart local v23    # "state":I
    :cond_9
    const/16 v24, 0x0

    .restart local v24    # "stateChanged":Z
    goto/16 :goto_1

    .line 1774
    .restart local v9    # "childCallIds":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .restart local v10    # "childrenChanged":Z
    .restart local v11    # "conferenceableCallIds":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .restart local v12    # "conferenceableCalls":Ljava/util/List;, "Ljava/util/List<Landroid/telecom/Call;>;"
    .restart local v18    # "otherId$iterator":Ljava/util/Iterator;
    .restart local v20    # "parentChanged":Z
    .restart local v21    # "parentId":Ljava/lang/String;
    :cond_a
    move-object/from16 v0, p0
    ...
    .line 1781
    .local v15, "isRttChanged":Z
    const/16 v22, 0x0

    .line 1782
    .local v22, "rttModeChanged":Z
    ...
    .line 1784
    .local v19, "parcelableRttCall":Landroid/telecom/ParcelableRttCall;
    ...
    .line 1788
    .local v4, "receiveStream":Ljava/io/InputStreamReader;
    ...
    .line 1792
    .local v5, "transmitStream":Ljava/io/OutputStreamWriter;
    ...
    .end local v4    # "receiveStream":Ljava/io/InputStreamReader;
    .end local v5    # "transmitStream":Ljava/io/OutputStreamWriter;
    .end local v19    # "parcelableRttCall":Landroid/telecom/ParcelableRttCall;
    :cond_d
    :goto_4
    if-eqz v24, :cond_e
    ...
    .line 1796
    .restart local v2    # "newRttCall":Landroid/telecom/Call$RttCall;
    .restart local v4    # "receiveStream":Ljava/io/InputStreamReader;
    .restart local v5    # "transmitStream":Ljava/io/OutputStreamWriter;
    .restart local v19    # "parcelableRttCall":Landroid/telecom/ParcelableRttCall;
    :cond_17
    move-object/from16 v0, p0
