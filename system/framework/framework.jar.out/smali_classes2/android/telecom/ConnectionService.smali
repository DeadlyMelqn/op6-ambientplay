...
.method static synthetic -get0(Landroid/telecom/ConnectionService;)Landroid/telecom/ConnectionServiceAdapter;
    .locals 1
    .param p0, "-this"    # Landroid/telecom/ConnectionService;
...
.method static synthetic -wrap10(Landroid/telecom/ConnectionService;Ljava/lang/String;Landroid/os/Bundle;)V
    .locals 0
    .param p0, "-this"    # Landroid/telecom/ConnectionService;
...
.method static synthetic -wrap11(Landroid/telecom/ConnectionService;Ljava/lang/String;Landroid/telecom/Connection$RttTextStream;)V
    .locals 0
    .param p0, "-this"    # Landroid/telecom/ConnectionService;
    .param p1, "callId"    # Ljava/lang/String;
...
.method static synthetic -wrap14(Landroid/telecom/ConnectionService;Ljava/lang/String;)V
    .locals 0
    .param p0, "-this"    # Landroid/telecom/ConnectionService;
    .param p1, "callId"    # Ljava/lang/String;
...
.method static synthetic -wrap17(Landroid/telecom/ConnectionService;Ljava/lang/String;Landroid/telecom/CallAudioState;)V
    .locals 0
    .param p0, "-this"    # Landroid/telecom/ConnectionService;
    .param p1, "callId"    # Ljava/lang/String;
...
.method static synthetic -wrap19(Landroid/telecom/ConnectionService;Ljava/lang/String;C)V
    .locals 0
    .param p0, "-this"    # Landroid/telecom/ConnectionService;
    .param p1, "callId"    # Ljava/lang/String;
    .param p2, "digit"    # C
...
.method static synthetic -wrap22(Landroid/telecom/ConnectionService;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0
    .param p0, "-this"    # Landroid/telecom/ConnectionService;
    .param p1, "callId"    # Ljava/lang/String;
...
.method static synthetic -wrap24(Landroid/telecom/ConnectionService;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
    .locals 0
    .param p0, "-this"    # Landroid/telecom/ConnectionService;
    .param p1, "callId"    # Ljava/lang/String;
...
.method static synthetic -wrap27(Landroid/telecom/ConnectionService;Ljava/lang/String;Landroid/telecom/Connection$RttTextStream;)V
    .locals 0
    .param p0, "-this"    # Landroid/telecom/ConnectionService;
    .param p1, "callId"    # Ljava/lang/String;
    .param p2, "rttTextStream"    # Landroid/telecom/Connection$RttTextStream;
...
.method static synthetic -wrap31(Landroid/telecom/ConnectionService;Ljava/lang/String;)V
    .locals 0
    .param p0, "-this"    # Landroid/telecom/ConnectionService;
    .param p1, "callId"    # Ljava/lang/String;
...
.method static synthetic -wrap7(Landroid/telecom/ConnectionService;Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;Landroid/telecom/ConnectionRequest;Z)V
    .locals 0
    .param p0, "-this"    # Landroid/telecom/ConnectionService;
...
.method static synthetic -wrap8(Landroid/telecom/ConnectionService;Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;Landroid/telecom/ConnectionRequest;ZZ)V
    .locals 0
    .param p0, "-this"    # Landroid/telecom/ConnectionService;
    .param p1, "callManagerAccount"    # Landroid/telecom/PhoneAccountHandle;
    .param p2, "callId"    # Ljava/lang/String;
...
.method private createConnection(Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;Landroid/telecom/ConnectionRequest;ZZ)V
    ...
    .line 1391
    const-string/jumbo v4, "createConnection,callId is null, return."
    ...
    .line 1404
    .local v27, "connection":Landroid/telecom/Connection;
    :goto_0
    ...
    .line 1411
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->getState()I
    ...
    .line 1415
    :cond_2
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->getAddress()Landroid/net/Uri;

    move-result-object v26

    .line 1416
    .local v26, "address":Landroid/net/Uri;
    if-nez v26, :cond_7
    ...
    .line 1418
    invoke-static/range {v28 .. v28}, Landroid/telecom/Connection;->toLogSafePhoneNumber(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1420
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->getConnectionCapabilities()I
    ...
    .line 1421
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->getConnectionProperties()I
    ...
    .line 1432
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->getSupportedAudioRoutes()I
    ...
    .line 1434
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->getAddressPresentation()I

    move-result v11

    .line 1435
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->getCallerDisplayName()Ljava/lang/String;

    move-result-object v12

    .line 1436
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->getCallerDisplayNamePresentation()I

    move-result v13

    .line 1437
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->getVideoProvider()Landroid/telecom/Connection$VideoProvider;
    ...
    .line 1439
    :goto_2
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->getVideoState()I

    move-result v15

    .line 1440
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->isRingbackRequested()Z

    move-result v16

    .line 1441
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->getAudioModeIsVoip()Z

    move-result v17

    .line 1442
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->getConnectTimeMillis()J

    move-result-wide v18

    .line 1443
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->getConnectElapsedTimeMillis()J

    move-result-wide v20

    .line 1444
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->getStatusHints()Landroid/telecom/StatusHints;

    move-result-object v22

    .line 1445
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->getDisconnectCause()Landroid/telecom/DisconnectCause;

    move-result-object v23

    .line 1446
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->getConferenceables()Ljava/util/List;
    ...
    .line 1447
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->getExtras()Landroid/os/Bundle;

    move-result-object v25

    .line 1427
    invoke-direct/range {v4 .. v25}, Landroid/telecom/ParcelableConnection;-><init>(Landroid/telecom/PhoneAccountHandle;IIIILandroid/net/Uri;ILjava/lang/String;ILcom/android/internal/telecom/IVideoProvider;IZZJJLandroid/telecom/StatusHints;Landroid/telecom/DisconnectCause;Ljava/util/List;Landroid/os/Bundle;)V
    ...
    .line 1453
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/Connection;->onShowIncomingCallUi()V
    ...
    .line 1402
    .end local v26    # "address":Landroid/net/Uri;
    .end local v27    # "connection":Landroid/telecom/Connection;
    ...
    .restart local v27    # "connection":Landroid/telecom/Connection;
    goto/16 :goto_0
    ...
    .line 1416
    .restart local v26    # "address":Landroid/net/Uri;
    :cond_7
...
.method private stopRtt(Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Landroid/telecom/Connection;->unsetRttProperty()V
...
.method public final addConference(Landroid/telecom/Conference;)V
    ...
    .local v17, "connection$iterator":Ljava/util/Iterator;
    :cond_0
    :goto_0
    ...
    check-cast v16, Landroid/telecom/Connection;

    .line 1857
    .local v16, "connection":Landroid/telecom/Connection;
    move-object/from16 v0, p0
    ...
    .line 1861
    .end local v16    # "connection":Landroid/telecom/Connection;
    :cond_1
    ...
    .line 1872
    invoke-virtual/range {p1 .. p1}, Landroid/telecom/Conference;->getConnectElapsedTime()J
    ...
    .line 1882
    .restart local v16    # "connection":Landroid/telecom/Connection;
    move-object/from16 v0, p0
    ...
    .line 1883
    .local v18, "connectionId":Ljava/lang/String;
    if-eqz v18, :cond_2
    ...
    .end local v16    # "connection":Landroid/telecom/Connection;
    .end local v18    # "connectionId":Ljava/lang/String;
    :cond_3
    invoke-virtual/range {p1 .. p1}, Landroid/telecom/Conference;->getVideoProvider()Landroid/telecom/Connection$VideoProvider;
    ...
    .end local v17    # "connection$iterator":Ljava/util/Iterator;
    :cond_4
    return-void
.end method
...
.method public final addExistingConnection(Landroid/telecom/PhoneAccountHandle;Landroid/telecom/Connection;Landroid/telecom/Conference;)V
    ...
    .line 1917
    .local v22, "emptyList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    const/16 v24, 0x0

    .line 1918
    .local v24, "conferenceId":Ljava/lang/String;
    if-eqz p3, :cond_0
    ...
    .end local v24    # "conferenceId":Ljava/lang/String;
    ...
    .end local v22    # "emptyList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :cond_1
    return-void

    .line 1933
    .restart local v22    # "emptyList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :cond_2
    invoke-virtual/range {p2 .. p2}, Landroid/telecom/Connection;->getVideoProvider()Landroid/telecom/Connection$VideoProvider;
