...
.method public createFromParcel(Landroid/os/Parcel;)Landroid/telecom/ParcelableCall;
    ...
    .line 308
    .local v32, "classLoader":Ljava/lang/ClassLoader;
    ...
    .line 317
    .local v13, "handle":Landroid/net/Uri;
    invoke-virtual/range {p1 .. p1}, Landroid/os/Parcel;->readInt()I

    move-result v14

    .line 318
    .local v14, "handlePresentation":I
    invoke-virtual/range {p1 .. p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v15

    .line 319
    .local v15, "callerDisplayName":Ljava/lang/String;
    invoke-virtual/range {p1 .. p1}, Landroid/os/Parcel;->readInt()I

    move-result v16

    .line 320
    .local v16, "callerDisplayNamePresentation":I
    move-object/from16 v0, p1
    ...
    .line 324
    .local v19, "isVideoCallProviderChanged":Z
    :goto_0
    ...
    .line 326
    .local v23, "parentCallId":Ljava/lang/String;
    new-instance v24, Ljava/util/ArrayList;

    invoke-direct/range {v24 .. v24}, Ljava/util/ArrayList;-><init>()V

    .line 327
    .local v24, "childCallIds":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    move-object/from16 v0, p1
    ...
    .line 329
    .local v25, "statusHints":Landroid/telecom/StatusHints;
    invoke-virtual/range {p1 .. p1}, Landroid/os/Parcel;->readInt()I

    move-result v26

    .line 330
    .local v26, "videoState":I
    new-instance v27, Ljava/util/ArrayList;

    invoke-direct/range {v27 .. v27}, Ljava/util/ArrayList;-><init>()V

    .line 331
    .local v27, "conferenceableCallIds":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    move-object/from16 v0, p1
    ...
    .line 333
    .local v28, "intentExtras":Landroid/os/Bundle;
    move-object/from16 v0, p1
    ...
    .line 335
    .local v10, "supportedAudioRoutes":I
    invoke-virtual/range {p1 .. p1}, Landroid/os/Parcel;->readByte()B
    ...
    .line 337
    .local v22, "rttCall":Landroid/telecom/ParcelableRttCall;
    invoke-virtual/range {p1 .. p1}, Landroid/os/Parcel;->readLong()J
    ...
    .line 322
    .end local v10    # "supportedAudioRoutes":I
    .end local v19    # "isVideoCallProviderChanged":Z
    .end local v20    # "videoCallProvider":Lcom/android/internal/telecom/IVideoProvider;
    .end local v21    # "isRttCallChanged":Z
    .end local v22    # "rttCall":Landroid/telecom/ParcelableRttCall;
    .end local v23    # "parentCallId":Ljava/lang/String;
    .end local v24    # "childCallIds":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local v25    # "statusHints":Landroid/telecom/StatusHints;
    .end local v26    # "videoState":I
    .end local v27    # "conferenceableCallIds":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local v28    # "intentExtras":Landroid/os/Bundle;
    .end local v29    # "extras":Landroid/os/Bundle;
    .end local v30    # "creationTimeMillis":J
    :cond_0
    const/16 v19, 0x0

    .restart local v19    # "isVideoCallProviderChanged":Z
    goto :goto_0

    .line 335
    .restart local v10    # "supportedAudioRoutes":I
    .restart local v20    # "videoCallProvider":Lcom/android/internal/telecom/IVideoProvider;
    .restart local v23    # "parentCallId":Ljava/lang/String;
    .restart local v24    # "childCallIds":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .restart local v25    # "statusHints":Landroid/telecom/StatusHints;
    .restart local v26    # "videoState":I
    .restart local v27    # "conferenceableCallIds":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .restart local v28    # "intentExtras":Landroid/os/Bundle;
    .restart local v29    # "extras":Landroid/os/Bundle;
    :cond_1
    const/16 v21, 0x0

    .restart local v21    # "isRttCallChanged":Z
    goto :goto_1
.end method
