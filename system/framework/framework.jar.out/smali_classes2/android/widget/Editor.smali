...
# direct methods
.method static synthetic -get0(Landroid/widget/Editor;)Z
    .locals 1
    .param p0, "-this"    # Landroid/widget/Editor;
...
.method static synthetic -get10(Landroid/widget/Editor;)I
    .locals 1
    .param p0, "-this"    # Landroid/widget/Editor;
...
.method static synthetic -get11(Landroid/widget/Editor;)Landroid/graphics/Rect;
    .locals 1
    .param p0, "-this"    # Landroid/widget/Editor;
...
.method static synthetic -get12(Landroid/widget/Editor;)Landroid/view/ActionMode;
    .locals 1
    .param p0, "-this"    # Landroid/widget/Editor;
...
.method static synthetic -get2(Landroid/widget/Editor;)F
    .locals 1
    .param p0, "-this"    # Landroid/widget/Editor;
...
.method static synthetic -get4(Landroid/widget/Editor;)Lcom/android/internal/logging/MetricsLogger;
    .locals 1
    .param p0, "-this"    # Landroid/widget/Editor;
...
.method static synthetic -get9(Landroid/widget/Editor;)Landroid/widget/Editor$SuggestionHelper;
    .locals 1
    .param p0, "-this"    # Landroid/widget/Editor;
...
.method static synthetic -set0(Landroid/widget/Editor;Landroid/widget/Editor$CorrectionHighlighter;)Landroid/widget/Editor$CorrectionHighlighter;
    .locals 0
    .param p0, "-this"    # Landroid/widget/Editor;
    .param p1, "-value"    # Landroid/widget/Editor$CorrectionHighlighter;
...
.method static synthetic -wrap14(Landroid/widget/Editor;Landroid/graphics/drawable/Drawable;F)I
    .locals 1
    .param p0, "-this"    # Landroid/widget/Editor;
...
.method static synthetic -wrap15(Landroid/widget/Editor;Landroid/text/Layout;IF)I
    .locals 1
    .param p0, "-this"    # Landroid/widget/Editor;
...
.method static synthetic -wrap16(Landroid/widget/Editor;IZ)I
    .locals 1
    .param p0, "-this"    # Landroid/widget/Editor;
    .param p1, "offset"    # I
...
.method static synthetic -wrap19(Landroid/widget/Editor;II)J
    .locals 2
    .param p0, "-this"    # Landroid/widget/Editor;
...
.method static synthetic -wrap21(Landroid/widget/Editor;Landroid/widget/Editor$SuggestionInfo;)V
    .locals 0
    .param p0, "-this"    # Landroid/widget/Editor;
...
.method static synthetic -wrap22(Landroid/widget/Editor;)V
    .locals 0
    .param p0, "-this"    # Landroid/widget/Editor;
...
.method static synthetic -wrap24(Landroid/widget/Editor;Landroid/view/MotionEvent;)V
    .locals 0
    .param p0, "-this"    # Landroid/widget/Editor;
...
.method static synthetic -wrap25(Landroid/widget/Editor;IIZ)V
    .locals 0
    .param p0, "-this"    # Landroid/widget/Editor;
    .param p1, "start"    # I
    .param p2, "end"    # I
...
.method static synthetic -wrap9(Ljava/lang/CharSequence;II)Z
    .locals 1
...
.method private drawHardwareAccelerated(Landroid/graphics/Canvas;Landroid/text/Layout;Landroid/graphics/Path;Landroid/graphics/Paint;I)V
    ...
    .line 1695
    .local v33, "dynamicLayout":Landroid/text/DynamicLayout;
    ...
    .line 1718
    .local v19, "startIndexToFindAvailableRenderNode":I
    move/from16 v35, v18
    ...
    .line 1722
    .restart local v31    # "blockIndex":I
    move/from16 v0, v17
    ...
    .end local v17    # "i":I
    .end local v18    # "numberOfBlocks":I
    .end local v19    # "startIndexToFindAvailableRenderNode":I
    .end local v32    # "blockSet":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Integer;>;"
    .end local v33    # "dynamicLayout":Landroid/text/DynamicLayout;
    .end local v34    # "indexFirstChangedBlock":I
    .end local v35    # "lastIndex":I
    .end local v38    # "startBlock":I
    :goto_4
    return-void
...
.method private drawHardwareAcceleratedInner(Landroid/graphics/Canvas;Landroid/text/Layout;Landroid/graphics/Path;Landroid/graphics/Paint;I[I[IIII)I
    ...
    .line 1786
    .local v6, "blockDisplayListIsInvalid":Z
    move-object/from16 v0, p0
    ...
    .line 1787
    .local v5, "blockDisplayList":Landroid/view/RenderNode;
    move-object/from16 v0, p0
    ...
    .line 1769
    .end local v4    # "blockBeginLine":I
    .end local v5    # "blockDisplayList":Landroid/view/RenderNode;
    .end local v6    # "blockDisplayListIsInvalid":Z
    ...
    .line 1789
    .restart local v5    # "blockDisplayList":Landroid/view/RenderNode;
    .restart local v6    # "blockDisplayListIsInvalid":Z
    :cond_5
    ...
    .restart local v4    # "blockBeginLine":I
    goto :goto_1
    ...
    .restart local v14    # "max":F
    .restart local v15    # "min":F
    ...
    .line 1812
    .local v11, "displayListCanvas":Landroid/view/DisplayListCanvas;
    neg-int v0, v12
    ...
    .line 1825
    .end local v11    # "displayListCanvas":Landroid/view/DisplayListCanvas;
    :cond_8
    move/from16 v0, v17
    ...
    .restart local v4    # "blockBeginLine":I
    .restart local v10    # "bottom":I
    .restart local v11    # "displayListCanvas":Landroid/view/DisplayListCanvas;
    .restart local v12    # "left":I
    .restart local v16    # "right":I
    .restart local v17    # "top":I
...
.method private startDragAndDrop()V
    ...
    invoke-virtual {v5}, Landroid/widget/SelectionActionModeHelper;->onSelectionDrag()V
...
.method onCreateContextMenu(Landroid/view/ContextMenu;)V
    ...
    .line 2615
    invoke-interface {p1, v10, v10, v7, v8}, Landroid/view/ContextMenu;->addSubMenu(IIII)Landroid/view/SubMenu;
    ...
    invoke-interface {v5, v10, v10, v0, v7}, Landroid/view/SubMenu;->add(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    .line 2631
    invoke-interface {p1, v10, v7, v8, v9}, Landroid/view/ContextMenu;->add(IIII)Landroid/view/MenuItem;
    ...
    .line 2646
    invoke-interface {p1, v10, v7, v11, v8}, Landroid/view/ContextMenu;->add(IIII)Landroid/view/MenuItem;
    ...
    invoke-virtual {v8}, Landroid/widget/TextView;->canPasteAsPlainText()Z
    ...
    invoke-virtual {v8}, Landroid/widget/TextView;->canRequestAutofill()Z
...
.method onDrop(Landroid/view/DragEvent;)V
    ...
    .end local v14    # "min":I
    .end local v16    # "offset":I
    .end local v17    # "originalLength":I
    :catchall_1
    move-exception v22
...
.method startSelectionActionModeInternal()Z
    ...
    invoke-direct {v0, p0, v6}, Landroid/widget/Editor$TextActionModeCallback;-><init>(Landroid/widget/Editor;Z)V

    .line 2103
    .local v0, "actionModeCallback":Landroid/view/ActionMode$Callback;
    iget-object v3, p0, Landroid/widget/Editor;->mTextView:Landroid/widget/TextView;

    invoke-virtual {v3, v0, v6}, Landroid/widget/TextView;->startActionMode(Landroid/view/ActionMode$Callback;I)Landroid/view/ActionMode;
    ...
    invoke-virtual {v1, v3, v4, v5}, Landroid/view/inputmethod/InputMethodManager;->showSoftInput(Landroid/view/View;ILandroid/os/ResultReceiver;)Z
