...
# direct methods
.method constructor <init>(Landroid/service/media/MediaBrowserService;Landroid/service/media/MediaBrowserService;Ljava/lang/Object;Landroid/service/media/MediaBrowserService$ConnectionRecord;Ljava/lang/String;Landroid/os/ResultReceiver;)V
    .locals 0
    ...
    iput-object p4, p0, Landroid/service/media/MediaBrowserService$4;->val$connection:Landroid/service/media/MediaBrowserService$ConnectionRecord;

    iput-object p5, p0, Landroid/service/media/MediaBrowserService$4;->val$itemId:Ljava/lang/String;

    iput-object p6, p0, Landroid/service/media/MediaBrowserService$4;->val$receiver:Landroid/os/ResultReceiver;
...
.method onResultSent(Landroid/media/browse/MediaBrowser$MediaItem;I)V
    ...
    .line 714
    iget-object v1, p0, Landroid/service/media/MediaBrowserService$4;->this$0:Landroid/service/media/MediaBrowserService;

    invoke-static {v1}, Landroid/service/media/MediaBrowserService;->-get0(Landroid/service/media/MediaBrowserService;)Landroid/util/ArrayMap;

    move-result-object v1

    iget-object v2, p0, Landroid/service/media/MediaBrowserService$4;->val$connection:Landroid/service/media/MediaBrowserService$ConnectionRecord;
