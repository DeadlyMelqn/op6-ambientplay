...
.method synthetic constructor <init>(Landroid/os/Parcel;Landroid/service/autofill/FillContext;)V
    .locals 0
    .param p1, "parcel"    # Landroid/os/Parcel;
    .param p2, "-this1"    # Landroid/service/autofill/FillContext;
...
.method public findViewNodeByAutofillId(Landroid/view/autofill/AutofillId;)Landroid/app/assist/AssistStructure$ViewNode;
    ...
    .line 187
    .local v2, "nodesToProcess":Ljava/util/LinkedList;, "Ljava/util/LinkedList<Landroid/app/assist/AssistStructure$ViewNode;>;"
...
.method public findViewNodesByAutofillIds([Landroid/view/autofill/AutofillId;)[Landroid/app/assist/AssistStructure$ViewNode;
    ...
    .line 118
    .local v7, "nodesToProcess":Ljava/util/LinkedList;, "Ljava/util/LinkedList<Landroid/app/assist/AssistStructure$ViewNode;>;"
    array-length v9, p1

    new-array v0, v9, [Landroid/app/assist/AssistStructure$ViewNode;

    .line 121
    .local v0, "foundNodes":[Landroid/app/assist/AssistStructure$ViewNode;
    ...
    .line 123
    .local v5, "missingNodeIndexes":Landroid/util/SparseIntArray;
    const/4 v1, 0x0
    ...
    .line 130
    .restart local v4    # "lookupTableIndex":I
    :cond_0
    invoke-virtual {v5, v1, v11}, Landroid/util/SparseIntArray;->put(II)V
    ...
    .line 145
    .local v6, "node":Landroid/app/assist/AssistStructure$ViewNode;
    const/4 v1, 0x0
    ...
    .end local v2    # "id":Landroid/view/autofill/AutofillId;
    .end local v3    # "index":I
    .end local v6    # "node":Landroid/app/assist/AssistStructure$ViewNode;
    :cond_7
    const/4 v1, 0x0
    ...
    invoke-virtual {v9, v10, v12}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
