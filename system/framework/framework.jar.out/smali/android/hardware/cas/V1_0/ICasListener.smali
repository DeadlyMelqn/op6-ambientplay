...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/cas/V1_0/ICasListener;
    ...
    .line 12
    :cond_0
    const-string/jumbo v5, "android.hardware.cas@1.0::ICasListener"
    ...
    instance-of v5, v3, Landroid/hardware/cas/V1_0/ICasListener;

    if-eqz v5, :cond_1

    .line 15
    check-cast v3, Landroid/hardware/cas/V1_0/ICasListener;
    ...
    :cond_1
    new-instance v4, Landroid/hardware/cas/V1_0/ICasListener$Proxy;

    invoke-direct {v4, p0}, Landroid/hardware/cas/V1_0/ICasListener$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 21
    .local v4, "proxy":Landroid/hardware/cas/V1_0/ICasListener;
    :try_start_0
    invoke-interface {v4}, Landroid/hardware/cas/V1_0/ICasListener;->interfaceChain()Ljava/util/ArrayList;
