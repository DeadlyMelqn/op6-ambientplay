...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 54
    .local v5, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/hardware/radio/RadioManager$ModuleProperties;>;"
    ...
    .line 60
    .end local v5    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/hardware/radio/RadioManager$ModuleProperties;>;"
    :sswitch_2
    ...
    .line 74
    .local v3, "_arg3":Landroid/hardware/radio/ITunerCallback;
    ...
    .line 75
    .local v4, "_result":Landroid/hardware/radio/ITuner;
    invoke-virtual {p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v3    # "_arg3":Landroid/hardware/radio/ITunerCallback;
    .end local v4    # "_result":Landroid/hardware/radio/ITuner;
    :cond_1
    const/4 v1, 0x0

    .local v1, "_arg1":Landroid/hardware/radio/RadioManager$BandConfig;
    goto :goto_0

    .line 71
    .end local v1    # "_arg1":Landroid/hardware/radio/RadioManager$BandConfig;
    :cond_2
    const/4 v2, 0x0
