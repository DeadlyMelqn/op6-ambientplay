...
.method protected final dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 254
    iget-object v7, p0, Landroid/net/wifi/WifiNetworkScoreCache;->mLock:Ljava/lang/Object;

    monitor-enter v7

    .line 255
    :try_start_0
    iget-object v6, p0, Landroid/net/wifi/WifiNetworkScoreCache;->mCache:Landroid/util/LruCache;
    ...
    .local v4, "score$iterator":Ljava/util/Iterator;
    :goto_0
    ...
    .end local v4    # "score$iterator":Ljava/util/Iterator;
    :catchall_0
    move-exception v6
    ...
    .line 258
    .restart local v4    # "score$iterator":Ljava/util/Iterator;
    :cond_0
    :try_start_1
    const-string/jumbo v6, "  Network scores for latest ScanResults:"
    ...
    .local v2, "scanResult$iterator":Ljava/util/Iterator;
    :goto_1
...
.method public getScoredNetwork(Landroid/net/NetworkKey;)Landroid/net/ScoredNetwork;
    ...
    .line 207
    :cond_1
    iget-object v2, p0, Landroid/net/wifi/WifiNetworkScoreCache;->mLock:Ljava/lang/Object;
...
.method public getScoredNetwork(Landroid/net/wifi/ScanResult;)Landroid/net/ScoredNetwork;
    ...
    .line 191
    :cond_0
    iget-object v3, p0, Landroid/net/wifi/WifiNetworkScoreCache;->mLock:Ljava/lang/Object;
...
.method public final updateScores(Ljava/util/List;)V
    ...
    .line 99
    .local v0, "changed":Z
    iget-object v5, p0, Landroid/net/wifi/WifiNetworkScoreCache;->mLock:Ljava/lang/Object;
    ...
    .line 102
    .local v3, "networkKey":Ljava/lang/String;
    if-nez v3, :cond_4
    ...
    .end local v3    # "networkKey":Ljava/lang/String;
    :catchall_0
    move-exception v4
    ...
    .restart local v3    # "networkKey":Ljava/lang/String;
    :cond_4
    :try_start_1
    iget-object v4, p0, Landroid/net/wifi/WifiNetworkScoreCache;->mCache:Landroid/util/LruCache;
