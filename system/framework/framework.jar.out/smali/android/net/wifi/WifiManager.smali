...
.method static synthetic -get0(Landroid/net/wifi/WifiManager;)I
    .locals 1
    .param p0, "-this"    # Landroid/net/wifi/WifiManager;
...
.method public static calculateSignalLevel(II)I
    ...
    const-string/jumbo v3, "CTS signal level"
...
.method public blackListWifiDevice(Ljava/lang/String;Z)Z
    ...
    invoke-interface {v1, p1, p2}, Landroid/net/wifi/IWifiManager;->blackListWifiDevice(Ljava/lang/String;Z)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public enablePktLog(Z)Z
    ...
    invoke-interface {v1, p1}, Landroid/net/wifi/IWifiManager;->enablePktLog(Z)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getTetherSoftApSta(I)Ljava/util/List;
    ...
    invoke-interface {v1, p1}, Landroid/net/wifi/IWifiManager;->getTetherSoftApSta(I)Ljava/util/List;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public runFtmCommand(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-interface {v1, p1, p2}, Landroid/net/wifi/IWifiManager;->runFtmCommand(Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setCountryCodeFromMcc(IZ)V
    ...
    invoke-interface {v1, p1, p2}, Landroid/net/wifi/IWifiManager;->setCountryCodeFromMcc(IZ)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setFtmMode(Z)Z
    ...
    invoke-interface {v1, p1}, Landroid/net/wifi/IWifiManager;->setFtmMode(Z)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setWifiEnabled(Z)Z
    ...
    invoke-interface {v3, v4, p1}, Landroid/net/wifi/IWifiManager;->setWifiEnabled(Ljava/lang/String;Z)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public startLocalOnlyHotspot(Landroid/net/wifi/WifiManager$LocalOnlyHotspotCallback;Landroid/os/Handler;)V
    ...
    .line 2080
    .local v3, "proxy":Landroid/net/wifi/WifiManager$LocalOnlyHotspotCallbackProxy;
    :try_start_1
    iget-object v5, p0, Landroid/net/wifi/WifiManager;->mContext:Landroid/content/Context;
    ...
    .end local v3    # "proxy":Landroid/net/wifi/WifiManager$LocalOnlyHotspotCallbackProxy;
    ...
    .restart local v3    # "proxy":Landroid/net/wifi/WifiManager$LocalOnlyHotspotCallbackProxy;
