...
.method public static createImageThumbnail(Ljava/lang/String;I)Landroid/graphics/Bitmap;
    ...
    const-string/jumbo v14, "createImageThumbnail: decoding thumbnail here"
...
.method private static createThumbnailFromEXIF(Ljava/lang/String;IILandroid/media/ThumbnailUtils$SizedThumbnailBitmap;)V
    ...
    const-string/jumbo v16, "createThumbnailFromEXIF: "
    ...
    iget v14, v7, Landroid/media/MediaFile$MediaFileType;->fileType:I

    invoke-static {v14}, Landroid/media/MediaFile;->isRawImageFileType(I)Z
    ...
    .line 491
    .local v8, "fullOptions":Landroid/graphics/BitmapFactory$Options;
    ...
    invoke-static {v12, v15, v14, v5}, Landroid/graphics/BitmapFactory;->decodeByteArray([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v5, v0, v1}, Landroid/media/ThumbnailUtils;->computeSampleSize(Landroid/graphics/BitmapFactory$Options;II)I
    ...
    invoke-static {v8, v0, v1}, Landroid/media/ThumbnailUtils;->computeSampleSize(Landroid/graphics/BitmapFactory$Options;II)I
    ...
    .line 511
    iget v13, v5, Landroid/graphics/BitmapFactory$Options;->outWidth:I
    ...
    iput-object v14, v0, Landroid/media/ThumbnailUtils$SizedThumbnailBitmap;->mBitmap:Landroid/graphics/Bitmap;

    .line 516
    move-object/from16 v0, p3

    iget-object v14, v0, Landroid/media/ThumbnailUtils$SizedThumbnailBitmap;->mBitmap:Landroid/graphics/Bitmap;
    ...
    iput-object v12, v0, Landroid/media/ThumbnailUtils$SizedThumbnailBitmap;->mThumbnailData:[B

    .line 518
    move-object/from16 v0, p3

    iput v13, v0, Landroid/media/ThumbnailUtils$SizedThumbnailBitmap;->mThumbnailWidth:I

    .line 519
    move-object/from16 v0, p3

    iput v10, v0, Landroid/media/ThumbnailUtils$SizedThumbnailBitmap;->mThumbnailHeight:I
    ...
    .end local v8    # "fullOptions":Landroid/graphics/BitmapFactory$Options;
    .end local v9    # "fullThumbWidth":I
    :cond_3
    const/4 v11, 0x0

    .local v11, "isRawImage":Z
    goto :goto_0

    .line 486
    .end local v11    # "isRawImage":Z
    ...
    .restart local v8    # "fullOptions":Landroid/graphics/BitmapFactory$Options;
    .restart local v9    # "fullThumbWidth":I
    :cond_4
    const/4 v14, 0x0
