...
.method static synthetic -get0(Landroid/media/MediaCas;)Landroid/media/MediaCas$EventHandler;
    .locals 1
    .param p0, "-this"    # Landroid/media/MediaCas;
...
.method static synthetic -wrap0(Landroid/media/MediaCas;Ljava/util/ArrayList;)[B
    .locals 1
    .param p0, "-this"    # Landroid/media/MediaCas;
    .param p1, "byteArray"    # Ljava/util/ArrayList;
...
.method public static enumeratePlugins()[Landroid/media/MediaCas$PluginDescriptor;
    ...
    .line 337
    .local v4, "service":Landroid/hardware/cas/V1_0/IMediaCasService;
    if-eqz v4, :cond_2
    ...
    .line 341
    .local v0, "descriptors":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/hardware/cas/V1_0/HidlCasPluginDescriptor;>;"
    ...
    .line 349
    .end local v0    # "descriptors":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/hardware/cas/V1_0/HidlCasPluginDescriptor;>;"
    .end local v2    # "i":I
...
.method public static isSystemIdSupported(I)Z
    ...
    .line 320
    .local v1, "service":Landroid/hardware/cas/V1_0/IMediaCasService;
    if-eqz v1, :cond_0
...
.method public openSession()Landroid/media/MediaCas$Session;
    ...
    .line 475
    .local v0, "cb":Landroid/media/MediaCas$OpenSessionCallback;
    iget-object v2, p0, Landroid/media/MediaCas;->mICas:Landroid/hardware/cas/V1_0/ICas;
    ...
    .line 478
    .end local v0    # "cb":Landroid/media/MediaCas$OpenSessionCallback;
    :catch_0
    move-exception v1
