...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 55
    .local v47, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/media/tv/TvInputInfo;>;"
    ...
    .end local v47    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/media/tv/TvInputInfo;>;"
    :sswitch_2
    const-string/jumbo v4, "android.media.tv.ITvInputManager"
    ...
    .line 67
    .local v42, "_result":Landroid/media/tv/TvInputInfo;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v42    # "_result":Landroid/media/tv/TvInputInfo;
    :sswitch_3
    const-string/jumbo v4, "android.media.tv.ITvInputManager"
    ...
    .local v20, "_arg0":Landroid/media/tv/TvInputInfo;
    goto :goto_1

    .line 95
    .end local v20    # "_arg0":Landroid/media/tv/TvInputInfo;
    :sswitch_4
    const-string/jumbo v4, "android.media.tv.ITvInputManager"
    ...
    .line 111
    .local v45, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/media/tv/TvContentRatingSystemInfo;>;"
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 117
    .end local v16    # "_arg0":I
    .end local v45    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/media/tv/TvContentRatingSystemInfo;>;"
    :sswitch_6
    const-string/jumbo v4, "android.media.tv.ITvInputManager"
    ...
    .line 121
    .local v19, "_arg0":Landroid/media/tv/ITvInputManagerCallback;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 128
    .end local v12    # "_arg1":I
    .end local v19    # "_arg0":Landroid/media/tv/ITvInputManagerCallback;
    :sswitch_7
    const-string/jumbo v4, "android.media.tv.ITvInputManager"
    ...
    .line 132
    .restart local v19    # "_arg0":Landroid/media/tv/ITvInputManagerCallback;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 151
    .end local v12    # "_arg1":I
    .end local v23    # "_arg0":Z
    :cond_3
    const/16 v23, 0x0

    .restart local v23    # "_arg0":Z
    goto :goto_3
    ...
    .local v33, "_arg1":Landroid/view/Surface;
    goto :goto_6

    .line 261
    .end local v11    # "_arg0":Landroid/os/IBinder;
    .end local v33    # "_arg1":Landroid/view/Surface;
    :sswitch_12
    const-string/jumbo v4, "android.media.tv.ITvInputManager"
    ...
    .local v38, "_arg2":Landroid/os/Bundle;
    goto :goto_8

    .line 316
    .end local v11    # "_arg0":Landroid/os/IBinder;
    .end local v38    # "_arg2":Landroid/os/Bundle;
    :sswitch_15
    const-string/jumbo v4, "android.media.tv.ITvInputManager"
    ...
    .restart local v38    # "_arg2":Landroid/os/Bundle;
    goto :goto_a
    ...
    .local v35, "_arg2":Landroid/graphics/Rect;
    goto :goto_b

    .line 384
    .end local v11    # "_arg0":Landroid/os/IBinder;
    .end local v32    # "_arg1":Landroid/os/IBinder;
    .end local v35    # "_arg2":Landroid/graphics/Rect;
    :sswitch_19
    const-string/jumbo v4, "android.media.tv.ITvInputManager"
    ...
    .local v25, "_arg1":Landroid/graphics/Rect;
    goto :goto_c

    .line 402
    .end local v11    # "_arg0":Landroid/os/IBinder;
    .end local v25    # "_arg1":Landroid/graphics/Rect;
    :sswitch_1a
    const-string/jumbo v4, "android.media.tv.ITvInputManager"
    ...
    .local v28, "_arg1":Landroid/media/PlaybackParams;
    goto :goto_e

    .line 497
    .end local v11    # "_arg0":Landroid/os/IBinder;
    .end local v28    # "_arg1":Landroid/media/PlaybackParams;
    :sswitch_21
    const-string/jumbo v4, "android.media.tv.ITvInputManager"
    ...
    .line 541
    .local v46, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/media/tv/TvInputHardwareInfo;>;"
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 547
    .end local v46    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/media/tv/TvInputHardwareInfo;>;"
    :sswitch_25
    const-string/jumbo v4, "android.media.tv.ITvInputManager"
    ...
    .line 553
    .local v30, "_arg1":Landroid/media/tv/ITvInputHardwareCallback;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 562
    .local v41, "_result":Landroid/media/tv/ITvInputHardware;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 557
    .end local v8    # "_arg3":I
    .end local v41    # "_result":Landroid/media/tv/ITvInputHardware;
    :cond_11
    const/16 v36, 0x0

    .local v36, "_arg2":Landroid/media/tv/TvInputInfo;
    goto :goto_11

    .line 563
    .end local v36    # "_arg2":Landroid/media/tv/TvInputInfo;
    .restart local v8    # "_arg3":I
    .restart local v41    # "_result":Landroid/media/tv/ITvInputHardware;
    :cond_12
    const/4 v4, 0x0
    ...
    .end local v8    # "_arg3":I
    .end local v16    # "_arg0":I
    .end local v30    # "_arg1":Landroid/media/tv/ITvInputHardwareCallback;
    .end local v41    # "_result":Landroid/media/tv/ITvInputHardware;
    :sswitch_26
    const-string/jumbo v4, "android.media.tv.ITvInputManager"
    ...
    .line 574
    .local v29, "_arg1":Landroid/media/tv/ITvInputHardware;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .end local v13    # "_arg2":I
    .end local v16    # "_arg0":I
    .end local v29    # "_arg1":Landroid/media/tv/ITvInputHardware;
    :sswitch_27
    const-string/jumbo v4, "android.media.tv.ITvInputManager"
    ...
    .line 587
    .local v48, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/media/tv/TvStreamConfig;>;"
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v12    # "_arg1":I
    .end local v22    # "_arg0":Ljava/lang/String;
    .end local v48    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/media/tv/TvStreamConfig;>;"
    :sswitch_28
    const-string/jumbo v4, "android.media.tv.ITvInputManager"
    ...
    .restart local v33    # "_arg1":Landroid/view/Surface;
    goto :goto_13
    ...
    .local v37, "_arg2":Landroid/media/tv/TvStreamConfig;
    goto :goto_14

    .line 614
    .end local v37    # "_arg2":Landroid/media/tv/TvStreamConfig;
    .restart local v8    # "_arg3":I
    .restart local v50    # "_result":Z
    :cond_15
    const/4 v4, 0x0
    ...
    .line 631
    .local v44, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/media/tv/DvbDeviceInfo;>;"
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 637
    .end local v44    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/media/tv/DvbDeviceInfo;>;"
    :sswitch_2b
    const-string/jumbo v4, "android.media.tv.ITvInputManager"
    ...
    .local v18, "_arg0":Landroid/media/tv/DvbDeviceInfo;
    goto :goto_17

    .line 654
    .end local v18    # "_arg0":Landroid/media/tv/DvbDeviceInfo;
    .restart local v12    # "_arg1":I
    ...
    .local v17, "_arg0":Landroid/content/Intent;
    goto :goto_19

    .line 676
    .end local v17    # "_arg0":Landroid/content/Intent;
    :sswitch_2d
    const-string/jumbo v4, "android.media.tv.ITvInputManager"
    ...
    .local v21, "_arg0":Landroid/net/Uri;
    goto :goto_1a
