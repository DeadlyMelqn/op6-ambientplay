...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .local v0, "_arg0":Landroid/os/IncidentReportArgs;
    goto :goto_0

    .line 64
    .end local v0    # "_arg0":Landroid/os/IncidentReportArgs;
    :sswitch_2
    const-string/jumbo v3, "android.os.IIncidentManager"
    ...
    .line 75
    .local v1, "_arg1":Landroid/os/IIncidentReportStatusListener;
    invoke-virtual {p2}, Landroid/os/Parcel;->readRawFileDescriptor()Ljava/io/FileDescriptor;

    move-result-object v2

    .line 76
    .local v2, "_arg2":Ljava/io/FileDescriptor;
    ...
    .line 70
    .end local v1    # "_arg1":Landroid/os/IIncidentReportStatusListener;
    .end local v2    # "_arg2":Ljava/io/FileDescriptor;
    :cond_1
    const/4 v0, 0x0

    .restart local v0    # "_arg0":Landroid/os/IncidentReportArgs;
    goto :goto_1
