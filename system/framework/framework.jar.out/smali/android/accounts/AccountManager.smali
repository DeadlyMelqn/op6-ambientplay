...
.method static synthetic -get0(Landroid/accounts/AccountManager;)Ljava/util/HashMap;
    .locals 1
    .param p0, "-this"    # Landroid/accounts/AccountManager;
...
.method static synthetic -wrap2(Landroid/accounts/AccountManager;Ljava/lang/String;[Ljava/lang/String;Landroid/accounts/AccountManagerCallback;Landroid/os/Handler;)V
    ...
    .param p3, "callback"    # Landroid/accounts/AccountManagerCallback;
...
.method public getAccountsAndVisibilityForPackage(Ljava/lang/String;Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 970
    .local v1, "result":Ljava/util/Map;, "Ljava/util/Map<Landroid/accounts/Account;Ljava/lang/Integer;>;"
    return-object v1

    .line 971
    .end local v1    # "result":Ljava/util/Map;, "Ljava/util/Map<Landroid/accounts/Account;Ljava/lang/Integer;>;"
    :catch_0
    move-exception v0
...
.method public removeOnAccountsUpdatedListener(Landroid/accounts/OnAccountsUpdateListener;)V
    ...
    .line 2981
    .local v0, "accountTypes":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    if-eqz v0, :cond_3
    ...
    .local v1, "accountsArray":[Ljava/lang/String;
    goto :goto_0

    .line 2993
    .end local v1    # "accountsArray":[Ljava/lang/String;
    :catch_0
    move-exception v2
    ...
    .line 2974
    .end local v0    # "accountTypes":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
