...
.method _onGetInstantAppIntentFilter([ILjava/lang/String;Ljava/lang/String;Landroid/app/InstantAppResolverService$InstantAppResolutionCallback;)V
    ...
    .line 112
    .local v0, "response":Landroid/content/pm/EphemeralResolveInfo;
    ...
    .line 113
    .local v1, "resultList":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/InstantAppResolveInfo;>;"
...
.method _onGetInstantAppResolveInfo([ILjava/lang/String;Landroid/app/InstantAppResolverService$InstantAppResolutionCallback;)V
    ...
    .line 96
    .local v1, "response":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/EphemeralResolveInfo;>;"
    if-nez v1, :cond_1
    ...
    .line 98
    .local v3, "resultList":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/InstantAppResolveInfo;>;"
    const/4 v0, 0x0
    ...
    .line 96
    .end local v0    # "i":I
    .end local v2    # "responseSize":I
    .end local v3    # "resultList":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/InstantAppResolveInfo;>;"
    :cond_1
    invoke-interface {v1}, Ljava/util/List;->size()I

    move-result v2

    .restart local v2    # "responseSize":I
    goto :goto_0

    .line 101
    .restart local v0    # "i":I
    .restart local v3    # "resultList":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/InstantAppResolveInfo;>;"
    :cond_2
