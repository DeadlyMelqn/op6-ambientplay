...
.method static synthetic -get1(Lcom/android/server/appwidget/AppWidgetServiceImpl;)Landroid/app/AppOpsManager;
    .locals 1
    .param p0, "-this"    # Lcom/android/server/appwidget/AppWidgetServiceImpl;
...
.method private updateAppBootPackages()V
    ...
    :cond_2
    iget-object v5, p0, Lcom/android/server/appwidget/AppWidgetServiceImpl;->mAppBoot:Lcom/android/server/am/OnePlusAppBootManager;

    invoke-virtual {v5, v3}, Lcom/android/server/am/OnePlusAppBootManager;->updateWidgetPackages(Ljava/util/HashSet;)V
...
.method private updateAppWidgetInstanceLocked(Lcom/android/server/appwidget/AppWidgetServiceImpl$Widget;Landroid/widget/RemoteViews;Z)V
    ...
    .line 1981
    iput-object v4, p1, Lcom/android/server/appwidget/AppWidgetServiceImpl$Widget;->views:Landroid/widget/RemoteViews;
...
.method private updateOHPDPackages()V
    ...
    .line 2961
    .local v2, "pkgSet":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    ...
    invoke-virtual {v4, v2}, Lcom/android/server/am/OnePlusHighPowerDetector;->updateWidgetPackages(Ljava/util/HashSet;)V
...
.method addWidgetLocked(Lcom/android/server/appwidget/AppWidgetServiceImpl$Widget;)V
    ...
    .line 2879
    iget-object v1, p0, Lcom/android/server/appwidget/AppWidgetServiceImpl;->mAppBoot:Lcom/android/server/am/OnePlusAppBootManager;
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/am/OnePlusAppBootManager;->updateWidgetPackage(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/am/OnePlusHighPowerDetector;->updateWidgetPackage(Ljava/lang/String;Z)V
...
.method public bindAppWidgetId(Ljava/lang/String;IILandroid/content/ComponentName;Landroid/os/Bundle;)Z
    ...
    .line 1167
    iget-object v6, v0, Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;->id:Lcom/android/server/appwidget/AppWidgetServiceImpl$ProviderId;
    ...
    .line 1168
    iget-object v6, p0, Lcom/android/server/appwidget/AppWidgetServiceImpl;->mAppBoot:Lcom/android/server/am/OnePlusAppBootManager;

    iget-object v8, v0, Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;->id:Lcom/android/server/appwidget/AppWidgetServiceImpl$ProviderId;
    ...
    invoke-virtual {v6, v8, v9}, Lcom/android/server/am/OnePlusAppBootManager;->updateWidgetPackage(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v6, v8, v9}, Lcom/android/server/am/OnePlusHighPowerDetector;->updateWidgetPackage(Ljava/lang/String;Z)V
    :try_end_6
...
.method public getInstalledProvidersForProfile(IILjava/lang/String;)Landroid/content/pm/ParceledListSlice;
    ...
    .local v1, "inPackage":Z
    goto :goto_1

    .line 1724
    .end local v1    # "inPackage":Z
    :cond_4
...
.method public updateAppWidgetProvider(Landroid/content/ComponentName;Landroid/widget/RemoteViews;)V
    ...
    .line 1622
    .local v7, "userId":I
    sget-boolean v9, Lcom/android/server/appwidget/AppWidgetServiceImpl;->DEBUG_ONEPLUS:Z
    ...
    const-string/jumbo v11, "updateAppWidgetProvider(): pkg:"
    ...
    invoke-virtual {v9, v10}, Lcom/android/server/appwidget/AppWidgetServiceImpl$SecurityPolicy;->enforceCallFromPackage(Ljava/lang/String;)V
    ...
    invoke-direct {v6, v9, p1, v11}, Lcom/android/server/appwidget/AppWidgetServiceImpl$ProviderId;-><init>(ILandroid/content/ComponentName;Lcom/android/server/appwidget/AppWidgetServiceImpl$ProviderId;)V

    .line 1635
    .local v6, "providerId":Lcom/android/server/appwidget/AppWidgetServiceImpl$ProviderId;
    invoke-direct {p0, v6}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->lookupProviderLocked(Lcom/android/server/appwidget/AppWidgetServiceImpl$ProviderId;)Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;
    ...
    const-string/jumbo v12, "Provider doesn\'t exist "
    ...
    :cond_1
    :try_start_1
    iget-object v2, v5, Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;->widgets:Ljava/util/ArrayList;
    ...
    invoke-virtual {v9, v11}, Landroid/widget/RemoteViews;->estimateMemoryUsage(Z)I
    ...
    const-string/jumbo v12, "updateAppWidgetProvider: "
    ...
    const-string/jumbo v12, " widget instances from \'"
    ...
    const-string/jumbo v12, "\', each of the usage: "
    ...
    iget v12, p0, Lcom/android/server/appwidget/AppWidgetServiceImpl;->mMaxWidgetBitmapMemory:I
    ...
    .line 1654
    .end local v3    # "memoryUsage":I
    .end local v4    # "pkgName":Ljava/lang/String;
    :cond_2
    const/4 v9, 0x0

    invoke-direct {p0, v8, p2, v9}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->updateAppWidgetInstanceLocked(Lcom/android/server/appwidget/AppWidgetServiceImpl$Widget;Landroid/widget/RemoteViews;Z)V
    ...
    .restart local v3    # "memoryUsage":I
    goto :goto_2
