...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/content/SyncStorageEngine;->DEBUG_ONEPLUS:Z
...
.method private parseListenForTickles(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 1732
    :goto_1
    sget-boolean v6, Lcom/android/server/content/SyncStorageEngine;->DEBUG_ONEPLUS:Z
    ...
    const-string/jumbo v8, "mMasterSyncAutomatically set "
    ...
    invoke-static {v6, v7, v8}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method private readAccountInfoLocked()V
    ...
    :cond_5
    sget-boolean v23, Lcom/android/server/content/SyncStorageEngine;->DEBUG_ONEPLUS:Z
    ...
    const-string/jumbo v25, "mMasterSyncAutomatically read value "
...
.method public getMasterSyncAutomatically(I)Z
    ...
    sget-boolean v1, Lcom/android/server/content/SyncStorageEngine;->DEBUG_ONEPLUS:Z
    ...
    const-string/jumbo v4, "mMasterSyncAutomatically get for "
    ...
    .line 927
    const-string/jumbo v4, "return default"
    ...
    .line 927
    iget-boolean v4, p0, Lcom/android/server/content/SyncStorageEngine;->mDefaultMasterSyncAutomatically:Z
...
.method public setMasterSyncAutomatically(ZI)V
    ...
    .line 899
    :try_start_0
    sget-boolean v0, Lcom/android/server/content/SyncStorageEngine;->DEBUG_ONEPLUS:Z
    ...
    const-string/jumbo v4, "mMasterSyncAutomatically set "
    ...
    invoke-static {v0, v3, v4}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method public stopSyncEvent(JJLjava/lang/String;JJ)V
    ...
    iget-object v13, v0, Lcom/android/server/content/SyncStorageEngine;->mAuthorities:Landroid/util/SparseArray;
    ...
    const-string/jumbo v15, "stopSyncEvent: historyId="
    ...
    iget-object v12, v0, Lcom/android/server/content/SyncStorageEngine;->mSyncHistory:Ljava/util/ArrayList;
    ...
    .line 1137
    .local v6, "item":Lcom/android/server/content/SyncStorageEngine$SyncHistoryItem;
    iget v12, v6, Lcom/android/server/content/SyncStorageEngine$SyncHistoryItem;->historyId:I
    ...
    const-string/jumbo v15, "stopSyncEvent: no history for id "
    ...
    .line 1140
    .restart local v6    # "item":Lcom/android/server/content/SyncStorageEngine$SyncHistoryItem;
    :cond_2
    const/4 v6, 0x0
    ...
    iput-wide v0, v6, Lcom/android/server/content/SyncStorageEngine$SyncHistoryItem;->elapsedTime:J

    .line 1149
    const/4 v12, 0x1

    iput v12, v6, Lcom/android/server/content/SyncStorageEngine$SyncHistoryItem;->event:I

    .line 1150
    move-object/from16 v0, p5

    iput-object v0, v6, Lcom/android/server/content/SyncStorageEngine$SyncHistoryItem;->mesg:Ljava/lang/String;

    .line 1151
    move-wide/from16 v0, p6

    iput-wide v0, v6, Lcom/android/server/content/SyncStorageEngine$SyncHistoryItem;->downstreamActivity:J

    .line 1152
    move-wide/from16 v0, p8

    iput-wide v0, v6, Lcom/android/server/content/SyncStorageEngine$SyncHistoryItem;->upstreamActivity:J

    .line 1154
    iget v12, v6, Lcom/android/server/content/SyncStorageEngine$SyncHistoryItem;->authorityId:I

    move-object/from16 v0, p0

    invoke-direct {v0, v12}, Lcom/android/server/content/SyncStorageEngine;->getOrCreateSyncStatusLocked(I)Landroid/content/SyncStatusInfo;

    move-result-object v7

    .line 1156
    .local v7, "status":Landroid/content/SyncStatusInfo;
    iget v12, v7, Landroid/content/SyncStatusInfo;->numSyncs:I

    add-int/lit8 v12, v12, 0x1

    iput v12, v7, Landroid/content/SyncStatusInfo;->numSyncs:I

    .line 1157
    iget-wide v14, v7, Landroid/content/SyncStatusInfo;->totalElapsedTime:J

    add-long v14, v14, p3

    iput-wide v14, v7, Landroid/content/SyncStatusInfo;->totalElapsedTime:J

    .line 1158
    iget v12, v6, Lcom/android/server/content/SyncStorageEngine$SyncHistoryItem;->source:I
    ...
    .line 1177
    .local v10, "writeStatisticsNow":Z
    ...
    .line 1192
    iget-wide v14, v7, Landroid/content/SyncStatusInfo;->lastSuccessTime:J
    ...
    iget-wide v14, v7, Landroid/content/SyncStatusInfo;->lastFailureTime:J
    ...
    .line 1195
    :cond_5
    iput-wide v8, v7, Landroid/content/SyncStatusInfo;->lastSuccessTime:J

    .line 1196
    iget v12, v6, Lcom/android/server/content/SyncStorageEngine$SyncHistoryItem;->source:I

    iput v12, v7, Landroid/content/SyncStatusInfo;->lastSuccessSource:I

    .line 1197
    const-wide/16 v14, 0x0

    iput-wide v14, v7, Landroid/content/SyncStatusInfo;->lastFailureTime:J

    .line 1198
    const/4 v12, -0x1

    iput v12, v7, Landroid/content/SyncStatusInfo;->lastFailureSource:I

    .line 1199
    const/4 v12, 0x0

    iput-object v12, v7, Landroid/content/SyncStatusInfo;->lastFailureMesg:Ljava/lang/String;

    .line 1200
    const-wide/16 v14, 0x0

    iput-wide v14, v7, Landroid/content/SyncStatusInfo;->initialFailureTime:J
    ...
    .line 1217
    .local v4, "event":Ljava/lang/StringBuilder;
    ...
    iget v15, v6, Lcom/android/server/content/SyncStorageEngine$SyncHistoryItem;->source:I
    ...
    invoke-static {v4, v0, v1}, Lcom/android/server/content/SyncManager;->formatDurationHMS(Ljava/lang/StringBuilder;J)Ljava/lang/StringBuilder;
    ...
    .line 1221
    iget v12, v6, Lcom/android/server/content/SyncStorageEngine$SyncHistoryItem;->reason:I

    const/4 v14, 0x0

    invoke-static {v14, v12}, Lcom/android/server/content/SyncOperation;->reasonToString(Landroid/content/pm/PackageManager;I)Ljava/lang/String;
    ...
    .line 1223
    iget-object v12, v6, Lcom/android/server/content/SyncStorageEngine$SyncHistoryItem;->extras:Landroid/os/Bundle;

    invoke-static {v12, v4}, Lcom/android/server/content/SyncOperation;->extrasToStringBuilder(Landroid/os/Bundle;Ljava/lang/StringBuilder;)V
    ...
    invoke-virtual {v7, v12}, Landroid/content/SyncStatusInfo;->addEvent(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v12}, Lcom/android/server/content/SyncStorageEngine;->reportChange(I)V
    ...
    .end local v4    # "event":Ljava/lang/StringBuilder;
    .end local v8    # "lastSyncTime":J
    .end local v10    # "writeStatisticsNow":Z
    .end local v11    # "writeStatusNow":Z
    :pswitch_0
    :try_start_2
    iget v12, v7, Landroid/content/SyncStatusInfo;->numSourceLocal:I

    add-int/lit8 v12, v12, 0x1

    iput v12, v7, Landroid/content/SyncStatusInfo;->numSourceLocal:I
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    .restart local v7    # "status":Landroid/content/SyncStatusInfo;
    :pswitch_1
    :try_start_3
    iget v12, v7, Landroid/content/SyncStatusInfo;->numSourcePoll:I

    add-int/lit8 v12, v12, 0x1

    iput v12, v7, Landroid/content/SyncStatusInfo;->numSourcePoll:I

    goto/16 :goto_1

    .line 1166
    :pswitch_2
    iget v12, v7, Landroid/content/SyncStatusInfo;->numSourceUser:I

    add-int/lit8 v12, v12, 0x1

    iput v12, v7, Landroid/content/SyncStatusInfo;->numSourceUser:I

    goto/16 :goto_1

    .line 1169
    :pswitch_3
    iget v12, v7, Landroid/content/SyncStatusInfo;->numSourceServer:I

    add-int/lit8 v12, v12, 0x1

    iput v12, v7, Landroid/content/SyncStatusInfo;->numSourceServer:I

    goto/16 :goto_1

    .line 1172
    :pswitch_4
    iget v12, v7, Landroid/content/SyncStatusInfo;->numSourcePeriodic:I

    add-int/lit8 v12, v12, 0x1

    iput v12, v7, Landroid/content/SyncStatusInfo;->numSourcePeriodic:I

    goto/16 :goto_1

    .line 1180
    .restart local v2    # "day":I
    .restart local v10    # "writeStatisticsNow":Z
    :cond_9
    move-object/from16 v0, p0
    ...
    iget-object v15, v0, Lcom/android/server/content/SyncStorageEngine;->mDayStats:[Lcom/android/server/content/SyncStorageEngine$DayStats;
    ...
    invoke-static {v12, v0, v14, v1, v15}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    :cond_b
    const-string/jumbo v12, "canceled"
    ...
    .line 1207
    :cond_c
    iput-wide v8, v7, Landroid/content/SyncStatusInfo;->lastFailureTime:J
    ...
    iput-object v0, v7, Landroid/content/SyncStatusInfo;->lastFailureMesg:Ljava/lang/String;

    .line 1210
    iget-wide v14, v7, Landroid/content/SyncStatusInfo;->initialFailureTime:J
    ...
    .line 1211
    iput-wide v8, v7, Landroid/content/SyncStatusInfo;->initialFailureTime:J

    .line 1213
    :cond_d
    iget v12, v3, Lcom/android/server/content/SyncStorageEngine$DayStats;->failureCount:I

    add-int/lit8 v12, v12, 0x1

    iput v12, v3, Lcom/android/server/content/SyncStorageEngine$DayStats;->failureCount:I
    ...
    .line 1229
    .restart local v4    # "event":Ljava/lang/StringBuilder;
    :cond_e
    const/4 v12, 0x1

    move-object/from16 v0, p0

    invoke-virtual {v0, v12}, Lcom/android/server/content/SyncStorageEngine;->hasMessages(I)Z
    ...
    invoke-virtual {v0, v12}, Lcom/android/server/content/SyncStorageEngine;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {v0, v12, v14, v15}, Lcom/android/server/content/SyncStorageEngine;->sendMessageDelayed(Landroid/os/Message;J)Z
