...
.method restoreOneFile(Ljava/io/InputStream;[B)Z
    ...
    .line 7401
    .local v32, "info":Lcom/android/server/backup/FileMetadata;
    if-eqz v32, :cond_2
    ...
    .end local v32    # "info":Lcom/android/server/backup/FileMetadata;
    :cond_2
    :goto_0
    if-eqz v32, :cond_1d
    ...
    .restart local v32    # "info":Lcom/android/server/backup/FileMetadata;
    :cond_3
    move-object/from16 v0, v32
    ...
    .line 7443
    .local v41, "policy":Lcom/android/server/backup/BackupManagerService$RestorePolicy;
    ...
    .line 7623
    .local v39, "pipe":Ljava/io/FileOutputStream;
    :cond_b
    :goto_9
    const-wide/16 v8, 0x0
    ...
    .end local v39    # "pipe":Ljava/io/FileOutputStream;
    .end local v40    # "pipeOkay":Z
    :cond_e
    if-nez v26, :cond_f
    ...
    .line 7445
    .end local v28    # "bytesToConsume":J
    ...
    .line 7455
    .local v33, "installerName":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 7468
    .end local v33    # "installerName":Ljava/lang/String;
    .local v38, "okay":Z
    :cond_12
    move-object/from16 v0, p0
    ...
    .line 7586
    .local v11, "restoreEngine":Lcom/android/server/backup/KeyValueAdbRestoreEngine;
    ...
    .line 7605
    .end local v11    # "restoreEngine":Lcom/android/server/backup/KeyValueAdbRestoreEngine;
    :catch_3
    move-exception v31
    ...
    .line 7598
    .local v12, "runner":Lcom/android/server/backup/BackupManagerService$PerformAdbRestoreTask$RestoreFileRunnable;
    new-instance v4, Ljava/lang/Thread;
    ...
    .line 7610
    .end local v12    # "runner":Lcom/android/server/backup/BackupManagerService$PerformAdbRestoreTask$RestoreFileRunnable;
    :catch_4
    move-exception v30
    ...
    .line 7625
    .restart local v39    # "pipe":Ljava/io/FileOutputStream;
    .restart local v40    # "pipeOkay":Z
    :cond_1a
    ...
    .end local v42    # "toCopy":J
    .end local v44    # "toRead":I
    .restart local v28    # "bytesToConsume":J
    :cond_1c
    ...
    .end local v28    # "bytesToConsume":J
    .end local v32    # "info":Lcom/android/server/backup/FileMetadata;
    .end local v38    # "okay":Z
    .end local v41    # "policy":Lcom/android/server/backup/BackupManagerService$RestorePolicy;
    .end local v44    # "toRead":I
    :cond_1d
    const/4 v4, 0x0
...
.method tearDownAgent(Landroid/content/pm/ApplicationInfo;Z)V
    ...
    .line 7716
    .local v4, "latch":Lcom/android/server/backup/BackupManagerService$AdbRestoreFinishedLatch;
    iget-object v0, p0, Lcom/android/server/backup/BackupManagerService$PerformAdbRestoreTask;->this$0:Lcom/android/server/backup/BackupManagerService;
    ...
    .end local v4    # "latch":Lcom/android/server/backup/BackupManagerService$AdbRestoreFinishedLatch;
    :cond_0
    iget-object v0, p0, Lcom/android/server/backup/BackupManagerService$PerformAdbRestoreTask;->this$0:Lcom/android/server/backup/BackupManagerService;
    ...
    .restart local v4    # "latch":Lcom/android/server/backup/BackupManagerService$AdbRestoreFinishedLatch;
    :cond_2
    :try_start_1
    iget-object v0, p0, Lcom/android/server/backup/BackupManagerService$PerformAdbRestoreTask;->mAgent:Landroid/app/IBackupAgent;
