...
.method static synthetic -get1(Lcom/android/server/media/MediaSessionRecord;)Landroid/media/AudioAttributes;
    .locals 1
    .param p0, "-this"    # Lcom/android/server/media/MediaSessionRecord;
...
.method static synthetic -set0(Lcom/android/server/media/MediaSessionRecord;Landroid/media/AudioAttributes;)Landroid/media/AudioAttributes;
    .locals 0
    .param p0, "-this"    # Lcom/android/server/media/MediaSessionRecord;
    .param p1, "-value"    # Landroid/media/AudioAttributes;
...
.method static synthetic -set10(Lcom/android/server/media/MediaSessionRecord;Landroid/media/session/PlaybackState;)Landroid/media/session/PlaybackState;
    .locals 0
    .param p0, "-this"    # Lcom/android/server/media/MediaSessionRecord;
    .param p1, "-value"    # Landroid/media/session/PlaybackState;
...
.method private pushMetadataUpdate()V
    ...
    iget-object v6, p0, Lcom/android/server/media/MediaSessionRecord;->mMetadata:Landroid/media/MediaMetadata;

    invoke-interface {v4, v6}, Landroid/media/session/ISessionControllerCallback;->onMetadataChanged(Landroid/media/MediaMetadata;)V
    :try_end_2
    .catch Landroid/os/DeadObjectException; {:try_start_2 .. :try_end_2} :catch_1
    .catch Landroid/os/RemoteException; {:try_start_2 .. :try_end_2} :catch_0
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    .local v0, "e":Landroid/os/DeadObjectException;
    :try_start_4
    const-string/jumbo v4, "Removing dead callback in pushMetadataUpdate"
...
.method private pushQueueUpdate()V
    ...
    iget-object v7, p0, Lcom/android/server/media/MediaSessionRecord;->mQueue:Landroid/content/pm/ParceledListSlice;

    invoke-interface {v5, v7}, Landroid/media/session/ISessionControllerCallback;->onQueueChanged(Landroid/content/pm/ParceledListSlice;)V
    :try_end_2
    ...
    :try_start_3
    const-string/jumbo v5, "RuntimeException in pushQueueUpdate"
    ...
    .line 553
    const-string/jumbo v5, "Removed dead callback in pushQueueUpdate"
