...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 18
    const-string/jumbo v0, "SecrecyService.ResetCountDownTimer"
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/secrecy/policy/PolicyManager;)V
    ...
    const-string/jumbo v1, "android.secrecy.policyfactor.invalid.expire."

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    invoke-virtual {p0}, Lcom/android/server/secrecy/policy/ResetCountDownTimer;->getClass()Ljava/lang/Class;
...
.method private initAlarm()V
    ...
    .line 42
    new-instance v1, Lcom/android/server/secrecy/policy/ResetCountDownTimer$AlarmReceiver;

    invoke-direct {v1, p0, p0}, Lcom/android/server/secrecy/policy/ResetCountDownTimer$AlarmReceiver;-><init>(Lcom/android/server/secrecy/policy/ResetCountDownTimer;Lcom/android/server/secrecy/policy/ResetCountDownTimer;)V

    iput-object v1, p0, Lcom/android/server/secrecy/policy/ResetCountDownTimer;->mAlarmReceiver:Lcom/android/server/secrecy/policy/ResetCountDownTimer$AlarmReceiver;
    ...
    .line 49
    sget-wide v2, Lcom/android/server/secrecy/policy/ResetCountDownTimer;->DEFAULT_COUNTDOWN_TIME_FOR_MAC:J

    sget-wide v4, Lcom/android/server/secrecy/policy/ResetCountDownTimer;->DEFAULT_COUNTDOWN_TIME_FOR_ID:J

    invoke-virtual {p0, v2, v3, v4, v5}, Lcom/android/server/secrecy/policy/ResetCountDownTimer;->updateCountDownTime(JJ)V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    .line 103
    const-string/jumbo v0, "ResetCountDownTimer dump"
...
.method public updateCountDownTime(JJ)V
    ...
    const-string/jumbo v3, "Kevin_DEBUG"
