...
.method static synthetic -get0(Lcom/android/server/wm/PinnedStackController;)I
    .locals 1
    .param p0, "-this"    # Lcom/android/server/wm/PinnedStackController;
...
.method static synthetic -get3(Lcom/android/server/wm/PinnedStackController;)Lcom/android/server/wm/WindowManagerService;
    .locals 1
    .param p0, "-this"    # Lcom/android/server/wm/PinnedStackController;
...
.method static synthetic -get4(Lcom/android/server/wm/PinnedStackController;)Lcom/android/internal/policy/PipSnapAlgorithm;
    .locals 1
    .param p0, "-this"    # Lcom/android/server/wm/PinnedStackController;
...
.method static synthetic -set2(Lcom/android/server/wm/PinnedStackController;Landroid/view/IPinnedStackListener;)Landroid/view/IPinnedStackListener;
    .locals 0
    .param p0, "-this"    # Lcom/android/server/wm/PinnedStackController;
    .param p1, "-value"    # Landroid/view/IPinnedStackListener;
...
.method private getInsetBounds(Landroid/graphics/Rect;)V
    ...
    .line 434
    invoke-interface {v0, v2, v3, v4, v5}, Landroid/view/WindowManagerPolicy;->getStableInsetsLw(IIILandroid/graphics/Rect;)V
...
.method private notifyActionsChanged(Ljava/util/List;)V
    ...
    invoke-interface {v1, v2}, Landroid/view/IPinnedStackListener;->onActionsChanged(Landroid/content/pm/ParceledListSlice;)V
    :try_end_0
    ...
    const-string/jumbo v2, "Error delivering actions changed event."
...
.method private notifyImeVisibilityChanged(ZI)V
    ...
    const-string/jumbo v2, "Error delivering bounds changed event."
...
.method private notifyMinimizeChanged(Z)V
    ...
    const-string/jumbo v2, "Error delivering minimize changed event."
...
.method private notifyMovementBoundsChanged(Z)V
    ...
    .line 409
    .local v2, "normalBounds":Landroid/graphics/Rect;
    ...
    .line 414
    .local v3, "animatingBounds":Landroid/graphics/Rect;
    ...
    .line 415
    .local v7, "pinnedStack":Lcom/android/server/wm/TaskStack;
    if-eqz v7, :cond_2
    ...
    .end local v2    # "normalBounds":Landroid/graphics/Rect;
    .end local v3    # "animatingBounds":Landroid/graphics/Rect;
    .end local v7    # "pinnedStack":Lcom/android/server/wm/TaskStack;
    :cond_1
    :goto_1
    monitor-exit v8
    ...
    .restart local v2    # "normalBounds":Landroid/graphics/Rect;
    .restart local v3    # "animatingBounds":Landroid/graphics/Rect;
    .restart local v7    # "pinnedStack":Lcom/android/server/wm/TaskStack;
    :cond_2
    :try_start_2
...
.method private reloadResources()V
    ...
    .line 180
    .local v2, "screenEdgeInsetsDpString":Ljava/lang/String;
    ...
    .local v1, "screenEdgeInsetsDp":Landroid/util/Size;
    goto :goto_0

    .line 187
    .end local v1    # "screenEdgeInsetsDp":Landroid/util/Size;
    :cond_1
    new-instance v3, Landroid/graphics/Point;
...
.method getDefaultBounds()Landroid/graphics/Rect;
    ...
    .line 251
    .local v3, "insetBounds":Landroid/graphics/Rect;
    ...
    .line 254
    .local v6, "defaultBounds":Landroid/graphics/Rect;
    iget-object v0, p0, Lcom/android/server/wm/PinnedStackController;->mSnapAlgorithm:Lcom/android/internal/policy/PipSnapAlgorithm;
    ...
    .line 249
    .end local v3    # "insetBounds":Landroid/graphics/Rect;
    .end local v6    # "defaultBounds":Landroid/graphics/Rect;
...
.method onTaskStackBoundsChanged(Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    .line 296
    .local v3, "preChangeMovementBounds":Landroid/graphics/Rect;
    ...
    .line 304
    .local v1, "postChangeMovementBounds":Landroid/graphics/Rect;
    iget-object v5, p0, Lcom/android/server/wm/PinnedStackController;->mSnapAlgorithm:Lcom/android/internal/policy/PipSnapAlgorithm;
    ...
    .end local v1    # "postChangeMovementBounds":Landroid/graphics/Rect;
    .end local v2    # "postChangeStackBounds":Landroid/graphics/Rect;
    .end local v3    # "preChangeMovementBounds":Landroid/graphics/Rect;
...
.method registerPinnedStackListener(Landroid/view/IPinnedStackListener;)V
    ...
    iget-object v2, p0, Lcom/android/server/wm/PinnedStackController;->mPinnedStackListenerDeathHandler:Lcom/android/server/wm/PinnedStackController$PinnedStackListenerDeathHandler;
