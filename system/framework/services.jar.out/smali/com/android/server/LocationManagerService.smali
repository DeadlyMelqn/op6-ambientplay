...
.method static synthetic -get0(Lcom/android/server/LocationManagerService;)Landroid/app/ActivityManager;
    .locals 1
    .param p0, "-this"    # Lcom/android/server/LocationManagerService;
...
.method private DumpUpdateRecordProvider(Ljava/lang/String;)V
    ...
    iget-object v7, v3, Lcom/android/server/LocationManagerService$Receiver;->mIdentity:Lcom/android/server/LocationManagerService$Identity;
...
.method private applyRequirementsLocked(Ljava/lang/String;)V
    ...
    .line 1781
    .local v16, "records":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/LocationManagerService$UpdateRecord;>;"
    ...
    .line 1784
    .local v13, "providerRequest":Lcom/android/internal/location/ProviderRequest;
    move-object/from16 v0, p0
    ...
    .line 1790
    .local v6, "backgroundThrottleInterval":J
    if-eqz v16, :cond_7
    ...
    invoke-static/range {v21 .. v21}, Lcom/android/server/LocationManagerService;->checkUidBlock(I)Z
    ...
    .local v11, "locationRequest":Landroid/location/LocationRequest;
    invoke-virtual {v11, v8, v9}, Landroid/location/LocationRequest;->setInterval(J)Landroid/location/LocationRequest;

    move-object v10, v11

    .line 1816
    .end local v11    # "locationRequest":Landroid/location/LocationRequest;
    ...
    .end local v10    # "locationRequest":Landroid/location/LocationRequest;
    .end local v14    # "record":Lcom/android/server/LocationManagerService$UpdateRecord;
    .end local v15    # "record$iterator":Ljava/util/Iterator;
    .end local v18    # "thresholdInterval":J
    :cond_7
    sget-boolean v21, Lcom/android/server/LocationManagerService;->D:Z
...
.method private isThrottlingExemptLocked(Lcom/android/server/LocationManagerService$Identity;)Z
    ...
    .line 1901
    .local v0, "provider":Lcom/android/server/location/LocationProviderProxy;
    iget-object v2, p1, Lcom/android/server/LocationManagerService$Identity;->mPackageName:Ljava/lang/String;
    ...
    .line 1906
    .end local v0    # "provider":Lcom/android/server/location/LocationProviderProxy;
    :cond_4
    const/4 v2, 0x0
...
.method private loadProvidersLocked()V
    ...
    .line 625
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/location/GnssLocationProvider;->getGnssMetricsProvider()Lcom/android/server/location/GnssLocationProvider$GnssMetricsProvider;
...
.method private onUidImportanceChanged(II)V
    ...
    .prologue
    .line 440
    invoke-static/range {p2 .. p2}, Lcom/android/server/LocationManagerService;->isImportanceForeground(I)Z
    ...
    .line 450
    .restart local v3    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Ljava/util/ArrayList<Lcom/android/server/LocationManagerService$UpdateRecord;>;>;"
    ...
    .restart local v9    # "record$iterator":Ljava/util/Iterator;
    :cond_3
    :try_start_1
    ...
    .end local v6    # "provider":Ljava/lang/String;
    :cond_5
    iget-object v10, p0, Lcom/android/server/LocationManagerService;->mGnssMeasurementsListeners:Landroid/util/ArrayMap;
    ...
    .line 465
    .local v1, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Landroid/location/IGnssMeasurementsListener;Lcom/android/server/LocationManagerService$Identity;>;"
    ...
    .line 469
    :cond_8
    iget-object v12, p0, Lcom/android/server/LocationManagerService;->mGnssMeasurementsProvider:Lcom/android/server/location/GnssMeasurementsProvider;
    ...
    .line 477
    .end local v1    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Landroid/location/IGnssMeasurementsListener;Lcom/android/server/LocationManagerService$Identity;>;"
    :cond_b
    iget-object v10, p0, Lcom/android/server/LocationManagerService;->mGnssNavigationMessageListeners:Landroid/util/ArrayMap;
    ...
    .line 478
    .local v2, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Landroid/location/IGnssNavigationMessageListener;Lcom/android/server/LocationManagerService$Identity;>;"
    ...
    .line 483
    :cond_e
    iget-object v12, p0, Lcom/android/server/LocationManagerService;->mGnssNavigationMessageProvider:Lcom/android/server/location/GnssNavigationMessageProvider;
    ...
    .end local v2    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Landroid/location/IGnssNavigationMessageListener;Lcom/android/server/LocationManagerService$Identity;>;"
    :cond_11
    monitor-exit v11
...
.method private requestLocationUpdatesLocked(Landroid/location/LocationRequest;Lcom/android/server/LocationManagerService$Receiver;IILjava/lang/String;)V
    ...
    .line 2149
    iget-boolean v5, v4, Lcom/android/server/LocationManagerService$UpdateRecord;->mIsForegroundUid:Z
    ...
    .line 2151
    const-string/jumbo v5, " [whitelisted]"
    ...
    .line 2149
    .end local v0    # "isProviderEnabled":Z
    .end local v2    # "oldRecord":Lcom/android/server/LocationManagerService$UpdateRecord;
    :cond_6
    ...
    .line 2163
    .restart local v0    # "isProviderEnabled":Z
    .restart local v2    # "oldRecord":Lcom/android/server/LocationManagerService$UpdateRecord;
    :cond_8
...
.method private updateProviderListenersLocked(Ljava/lang/String;Z)V
    ...
    invoke-static {v7}, Lcom/android/server/LocationManagerService;->checkUidBlock(I)Z
    ...
    const-string/jumbo v9, "updateProviderListeners uid block  uid = "
...
.method public addGnssMeasurementsListener(Landroid/location/IGnssMeasurementsListener;Ljava/lang/String;)Z
    ...
    .line 2410
    .local v0, "callerIdentity":Lcom/android/server/LocationManagerService$Identity;
    ...
    .line 2407
    .end local v0    # "callerIdentity":Lcom/android/server/LocationManagerService$Identity;
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string/jumbo v25, "LocationManagerService"
    ...
    const-string/jumbo v26, "--gnssmetrics"
    ...
    iget-object v0, v0, Lcom/android/server/LocationManagerService;->mGnssMetricsProvider:Lcom/android/server/location/GnssLocationProvider$GnssMetricsProvider;
    ...
    invoke-interface/range {v24 .. v24}, Lcom/android/server/location/GnssLocationProvider$GnssMetricsProvider;->getGnssMetricsAsProtoString()Ljava/lang/String;
    ...
    .local v20, "receiver$iterator":Ljava/util/Iterator;
    :goto_0
    ...
    .end local v20    # "receiver$iterator":Ljava/util/Iterator;
    :catchall_0
    move-exception v24
    ...
    .line 3280
    .restart local v20    # "receiver$iterator":Ljava/util/Iterator;
    :cond_3
    :try_start_2
    ...
    .local v22, "record$iterator":Ljava/util/Iterator;
    :goto_1
    ...
    .line 3284
    .local v21, "record":Lcom/android/server/LocationManagerService$UpdateRecord;
    new-instance v24, Ljava/lang/StringBuilder;
    ...
    .end local v21    # "record":Lcom/android/server/LocationManagerService$UpdateRecord;
    .end local v22    # "record$iterator":Ljava/util/Iterator;
    :cond_5
    const-string/jumbo v24, "  Overlay Provider Packages:"
    ...
    .line 3291
    check-cast v15, Lcom/android/server/location/LocationProviderProxy;

    .end local v15    # "provider":Lcom/android/server/location/LocationProviderInterface;
    invoke-virtual {v15}, Lcom/android/server/location/LocationProviderProxy;->getConnectedPackageName()Ljava/lang/String;
    ...
    .line 3299
    .local v23, "stats":Lcom/android/server/location/LocationRequestStatistics$PackageStatistics;
    new-instance v24, Ljava/lang/StringBuilder;
    ...
    .end local v23    # "stats":Lcom/android/server/location/LocationRequestStatistics$PackageStatistics;
    :cond_8
    ...
    .line 3340
    const-string/jumbo v24, "  Throttling Whitelisted Packages:"
    ...
    .line 3353
    .restart local v15    # "provider":Lcom/android/server/location/LocationProviderInterface;
    new-instance v24, Ljava/lang/StringBuilder;
    ...
    .line 3356
    .local v18, "proxy":Lcom/android/server/location/LocationProviderProxy;
    new-instance v24, Ljava/lang/StringBuilder;
    ...
    .line 3358
    .end local v18    # "proxy":Lcom/android/server/location/LocationProviderProxy;
    :cond_10
    const-string/jumbo v24, ":"
    ...
    .line 3362
    const-string/jumbo v24, "  GNSS batching in progress"
...
.method public getActiveLocationUidType()Landroid/util/ArrayMap;
    ...
    .line 3468
    .local v5, "mUpdateRecord":Lcom/android/server/LocationManagerService$UpdateRecord;
    if-eqz v5, :cond_1
    ...
    iget v7, v8, Lcom/android/server/LocationManagerService$Identity;->mUid:I

    .line 3470
    .local v7, "uid":I
    iget-object v6, v5, Lcom/android/server/LocationManagerService$UpdateRecord;->mProvider:Ljava/lang/String;

    .line 3471
    .local v6, "privider":Ljava/lang/String;
    ...
    .end local v5    # "mUpdateRecord":Lcom/android/server/LocationManagerService$UpdateRecord;
    .end local v6    # "privider":Ljava/lang/String;
    .end local v7    # "uid":I
    :catchall_0
    move-exception v8
...
.method public systemRunning()V
    ...
    .line 351
    new-instance v8, Lcom/android/server/LocationManagerService$5;

    invoke-direct {v8, p0}, Lcom/android/server/LocationManagerService$5;-><init>(Lcom/android/server/LocationManagerService;)V

    .line 362
    .local v8, "uidImportanceListener":Landroid/app/ActivityManager$OnUidImportanceListener;
    iget-object v0, p0, Lcom/android/server/LocationManagerService;->mActivityManager:Landroid/app/ActivityManager;
    ...
    .line 362
    invoke-virtual {v0, v8, v2}, Landroid/app/ActivityManager;->addOnUidImportanceListener(Landroid/app/ActivityManager$OnUidImportanceListener;I)V
    ...
    .line 376
    invoke-virtual {v0, v1, v9, v2, v10}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V
    ...
    .end local v8    # "uidImportanceListener":Landroid/app/ActivityManager$OnUidImportanceListener;
    :catchall_0
    move-exception v0
...
.method public updateReceiverBlockRequest(IZ)V
    ...
    .line 3515
    sget-object v3, Lcom/android/server/LocationManagerService;->mBlockLocationUids:Ljava/util/ArrayList;
    ...
    .line 3517
    sget-object v3, Lcom/android/server/LocationManagerService;->mBlockReceiverUids:Ljava/util/ArrayList;
    ...
    .line 3533
    .restart local v1    # "i$iterator":Ljava/util/Iterator;
    .restart local v2    # "needApplyAgain":Z
    :cond_3
    if-eqz v2, :cond_4
