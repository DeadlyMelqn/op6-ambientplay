...
.method onPhaseTwoResolved(Ljava/util/List;J)V
    ...
    .line 169
    .local v16, "instantAppIntentInfo":Landroid/content/pm/AuxiliaryResolveInfo;
    if-eqz v16, :cond_0

    .line 170
    move-object/from16 v0, v16

    iget-object v2, v0, Landroid/content/pm/AuxiliaryResolveInfo;->resolveInfo:Landroid/content/pm/InstantAppResolveInfo;
    ...
    iget-object v10, v0, Landroid/content/pm/AuxiliaryResolveInfo;->splitName:Ljava/lang/String;
    ...
    iget-object v4, v0, Landroid/content/pm/AuxiliaryResolveInfo;->failureIntent:Landroid/content/Intent;

    .line 188
    .end local v9    # "packageName":Ljava/lang/String;
    .end local v10    # "splitName":Ljava/lang/String;
    .end local v16    # "instantAppIntentInfo":Landroid/content/pm/AuxiliaryResolveInfo;
    :goto_0
    ...
    iget-object v11, v0, Lcom/android/server/pm/InstantAppResolver$1;->val$requestObj:Landroid/content/pm/InstantAppRequest;

    iget-object v11, v11, Landroid/content/pm/InstantAppRequest;->responseObj:Landroid/content/pm/AuxiliaryResolveInfo;

    iget-object v11, v11, Landroid/content/pm/AuxiliaryResolveInfo;->installFailureActivity:Landroid/content/ComponentName;

    .line 199
    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/server/pm/InstantAppResolver$1;->val$token:Ljava/lang/String;

    .line 200
    const/4 v14, 0x0

    .line 187
    invoke-static/range {v2 .. v14}, Lcom/android/server/pm/InstantAppResolver;->buildEphemeralInstallerIntent(Ljava/lang/String;Landroid/content/Intent;Landroid/content/Intent;Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Landroid/content/ComponentName;ILjava/lang/String;Z)Landroid/content/Intent;

    move-result-object v15

    .line 201
    .local v15, "installerIntent":Landroid/content/Intent;
    ...
    .end local v15    # "installerIntent":Landroid/content/Intent;
    .restart local v16    # "instantAppIntentInfo":Landroid/content/pm/AuxiliaryResolveInfo;
    :cond_0
    const/4 v9, 0x0
    ...
    .line 182
    .end local v4    # "failureIntent":Landroid/content/Intent;
    .end local v9    # "packageName":Ljava/lang/String;
    .end local v10    # "splitName":Ljava/lang/String;
    .end local v12    # "versionCode":I
    .end local v16    # "instantAppIntentInfo":Landroid/content/pm/AuxiliaryResolveInfo;
    ...
    .restart local v4    # "failureIntent":Landroid/content/Intent;
    goto :goto_0
    ...
    .end local v9    # "packageName":Ljava/lang/String;
    .end local v10    # "splitName":Ljava/lang/String;
    .restart local v15    # "installerIntent":Landroid/content/Intent;
    :cond_2
    const/4 v2, 0x1
