...
.method synthetic constructor <init>(Lcom/android/server/pm/ShortcutService;Lcom/android/server/pm/ShortcutService$LocalService;)V
    .locals 0
    .param p1, "this$0"    # Lcom/android/server/pm/ShortcutService;
    .param p2, "-this1"    # Lcom/android/server/pm/ShortcutService$LocalService;
...
.method private getShortcutsInnerLocked(ILjava/lang/String;Ljava/lang/String;Ljava/util/List;JLandroid/content/ComponentName;IILjava/util/ArrayList;I)V
    ...
    .line 2424
    .local v13, "p":Lcom/android/server/pm/ShortcutPackage;
    if-nez v13, :cond_1
    ...
    .line 2420
    .end local v13    # "p":Lcom/android/server/pm/ShortcutPackage;
    :cond_0
    ...
    .restart local v13    # "p":Lcom/android/server/pm/ShortcutPackage;
    :cond_1
...
.method static synthetic lambda$-com_android_server_pm_ShortcutService$LocalService_86874(JLandroid/util/ArraySet;Landroid/content/ComponentName;ILandroid/content/pm/ShortcutInfo;)Z
    .locals 4
    ...
    .prologue
    .local p2, "ids":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    const/4 v3, 0x1
...
.method static synthetic lambda$-com_android_server_pm_ShortcutService$LocalService_89820(Ljava/lang/String;Landroid/content/pm/ShortcutInfo;)Z
    .locals 1
...
.method public getShortcuts(ILjava/lang/String;JLjava/lang/String;Ljava/util/List;Landroid/content/ComponentName;II)Ljava/util/List;
    ...
    .line 2385
    .local v14, "ret":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/content/pm/ShortcutInfo;>;"
    ...
    .line 2385
    .end local v15    # "cloneFlag":I
    .end local v16    # "cloneKeyFieldOnly":Z
    .restart local p6    # "shortcutIds":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :cond_1
    const/16 v16, 0x0

    .restart local v16    # "cloneKeyFieldOnly":Z
    goto :goto_0
    ...
    .line 2405
    .local v12, "shortcutIdsF":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :try_start_1
    move-object/from16 v0, p0
    ...
    .line 2392
    .end local v12    # "shortcutIdsF":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :catchall_0
    move-exception v3
...
.method synthetic lambda$-com_android_server_pm_ShortcutService$LocalService_85758(ILjava/lang/String;Ljava/util/List;JLandroid/content/ComponentName;IILjava/util/ArrayList;ILcom/android/server/pm/ShortcutPackage;)V
    .locals 14
    .param p1, "launcherUserId"    # I
    .param p2, "callingPackage"    # Ljava/lang/String;
    ...
    .prologue
    .line 2407
    .local p3, "shortcutIdsF":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .local p9, "ret":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/content/pm/ShortcutInfo;>;"
