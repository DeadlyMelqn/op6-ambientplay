...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/usb/V1_1/IUsbCallback;
    ...
    .line 12
    :cond_0
    const-string/jumbo v5, "android.hardware.usb@1.1::IUsbCallback"
    ...
    instance-of v5, v3, Landroid/hardware/usb/V1_1/IUsbCallback;

    if-eqz v5, :cond_1

    .line 15
    check-cast v3, Landroid/hardware/usb/V1_1/IUsbCallback;
    ...
    :cond_1
    new-instance v4, Landroid/hardware/usb/V1_1/IUsbCallback$Proxy;

    invoke-direct {v4, p0}, Landroid/hardware/usb/V1_1/IUsbCallback$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 21
    .local v4, "proxy":Landroid/hardware/usb/V1_1/IUsbCallback;
    :try_start_0
    invoke-interface {v4}, Landroid/hardware/usb/V1_1/IUsbCallback;->interfaceChain()Ljava/util/ArrayList;
