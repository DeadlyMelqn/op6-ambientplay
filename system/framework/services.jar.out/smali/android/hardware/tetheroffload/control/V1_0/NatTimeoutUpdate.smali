...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .line 62
    .local v10, "_hidl_vec":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/hardware/tetheroffload/control/V1_0/NatTimeoutUpdate;>;"
    ...
    .line 72
    new-instance v11, Landroid/hardware/tetheroffload/control/V1_0/NatTimeoutUpdate;

    invoke-direct {v11}, Landroid/hardware/tetheroffload/control/V1_0/NatTimeoutUpdate;-><init>()V

    .line 73
    .local v11, "_hidl_vec_element":Landroid/hardware/tetheroffload/control/V1_0/NatTimeoutUpdate;
    mul-int/lit8 v1, v9, 0x38

    int-to-long v2, v1

    invoke-virtual {v11, p0, v13, v2, v3}, Landroid/hardware/tetheroffload/control/V1_0/NatTimeoutUpdate;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    .line 78
    .end local v11    # "_hidl_vec_element":Landroid/hardware/tetheroffload/control/V1_0/NatTimeoutUpdate;
    :cond_0
    return-object v10
.end method
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v6, v7}, Landroid/hardware/tetheroffload/control/V1_0/NatTimeoutUpdate;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v2, Landroid/hardware/tetheroffload/control/V1_0/NatTimeoutUpdate;
    ...
    .line 21
    .local v0, "other":Landroid/hardware/tetheroffload/control/V1_0/NatTimeoutUpdate;
    ...
    iget-object v2, v0, Landroid/hardware/tetheroffload/control/V1_0/NatTimeoutUpdate;->src:Landroid/hardware/tetheroffload/control/V1_0/IPv4AddrPortPair;
    ...
    iget-object v2, v0, Landroid/hardware/tetheroffload/control/V1_0/NatTimeoutUpdate;->dst:Landroid/hardware/tetheroffload/control/V1_0/IPv4AddrPortPair;
    ...
    iget v2, v0, Landroid/hardware/tetheroffload/control/V1_0/NatTimeoutUpdate;->proto:I
