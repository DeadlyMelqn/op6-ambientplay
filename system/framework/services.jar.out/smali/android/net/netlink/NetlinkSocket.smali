...
.method public static sendOneShotKernelMessage(I[B)V
    ...
    .line 57
    .local v13, "errPrefix":Ljava/lang/String;
    const/16 v18, 0x0

    const/16 v16, 0x0

    .local v16, "nlSocket":Landroid/net/netlink/NetlinkSocket;
    :try_start_0
    ...
    .line 58
    .end local v16    # "nlSocket":Landroid/net/netlink/NetlinkSocket;
    ...
    .line 64
    .local v17, "response":Landroid/net/netlink/NetlinkMessage;
    if-eqz v17, :cond_1
    ...
    .end local v15    # "errno":I
    .end local v17    # "response":Landroid/net/netlink/NetlinkMessage;
    :catch_0
    move-exception v3
    ...
    .restart local v17    # "response":Landroid/net/netlink/NetlinkMessage;
    :cond_1
    if-nez v17, :cond_2
    ...
    .end local v15    # "errno":I
    .end local v17    # "response":Landroid/net/netlink/NetlinkMessage;
    .restart local v16    # "nlSocket":Landroid/net/netlink/NetlinkSocket;
    :catchall_2
    move-exception v3
