...
.method private final zza(Landroid/content/Context;Lcom/google/android/gms/ads/mediation/MediationAdRequest;Landroid/os/Bundle;Landroid/os/Bundle;)Lcom/google/android/gms/ads/AdRequest;
    ...
    invoke-interface/range {p2 .. p2}, Lcom/google/android/gms/ads/mediation/MediationAdRequest;->getBirthday()Ljava/util/Date;
    ...
    :cond_0
    invoke-interface/range {p2 .. p2}, Lcom/google/android/gms/ads/mediation/MediationAdRequest;->getGender()I
    ...
    :cond_1
    invoke-interface/range {p2 .. p2}, Lcom/google/android/gms/ads/mediation/MediationAdRequest;->getKeywords()Ljava/util/Set;
    ...
    :cond_2
    invoke-interface/range {p2 .. p2}, Lcom/google/android/gms/ads/mediation/MediationAdRequest;->getLocation()Landroid/location/Location;
    ...
    :cond_3
    invoke-interface/range {p2 .. p2}, Lcom/google/android/gms/ads/mediation/MediationAdRequest;->isTesting()Z
    ...
    :cond_4
    invoke-interface/range {p2 .. p2}, Lcom/google/android/gms/ads/mediation/MediationAdRequest;->taggedForChildDirectedTreatment()I
    ...
    :cond_6
    invoke-interface/range {p2 .. p2}, Lcom/google/android/gms/ads/mediation/MediationAdRequest;->isDesignedForFamilies()Z
    ...
    invoke-virtual {v0, p1, p0}, Lcom/google/android/gms/ads/AdRequest$Builder;->addNetworkExtrasBundle(Ljava/lang/Class;Landroid/os/Bundle;)Lcom/google/android/gms/ads/AdRequest$Builder;
...
.method public getBannerView()Landroid/view/View;
    ...
    iget-object p0, p0, Lcom/google/ads/mediation/AbstractAdViewAdapter;->zzgw:Lcom/google/android/gms/ads/AdView;
...
.method public getInterstitialAdapterInfo()Landroid/os/Bundle;
    ...
    new-instance p0, Lcom/google/android/gms/ads/mediation/MediationAdapter$zza;

    invoke-direct/range {p0 .. p0}, Lcom/google/android/gms/ads/mediation/MediationAdapter$zza;-><init>()V

    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Lcom/google/android/gms/ads/mediation/MediationAdapter$zza;->zzaj(I)Lcom/google/android/gms/ads/mediation/MediationAdapter$zza;

    move-result-object p0

    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/ads/mediation/MediationAdapter$zza;->zzvx()Landroid/os/Bundle;
...
.method public getVideoController()Lcom/google/android/gms/internal/ads/zzlo;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/ads/AdView;->getVideoController()Lcom/google/android/gms/ads/VideoController;
...
.method public loadAd(Lcom/google/android/gms/ads/mediation/MediationAdRequest;Landroid/os/Bundle;Landroid/os/Bundle;)V
    ...
    :cond_1
    :goto_0
    const-string p0, "AdMobAdapter.loadAd called before initialize."

    invoke-static/range {p0 .. p0}, Lcom/google/android/gms/internal/ads/zzane;->e(Ljava/lang/String;)V
...
.method public onDestroy()V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/ads/AdView;->destroy()V
...
.method public onImmersiveModeUpdated(Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/ads/InterstitialAd;->setImmersiveMode(Z)V
...
.method public onPause()V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/ads/AdView;->pause()V
...
.method public onResume()V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/ads/AdView;->resume()V
...
.method public requestBannerAd(Landroid/content/Context;Lcom/google/android/gms/ads/mediation/MediationBannerListener;Landroid/os/Bundle;Lcom/google/android/gms/ads/AdSize;Lcom/google/android/gms/ads/mediation/MediationAdRequest;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p2, p0}, Lcom/google/android/gms/ads/AdView;->loadAd(Lcom/google/android/gms/ads/AdRequest;)V
...
.method public requestInterstitialAd(Landroid/content/Context;Lcom/google/android/gms/ads/mediation/MediationInterstitialListener;Landroid/os/Bundle;Lcom/google/android/gms/ads/mediation/MediationAdRequest;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p2, p0}, Lcom/google/android/gms/ads/InterstitialAd;->loadAd(Lcom/google/android/gms/ads/AdRequest;)V
...
.method public requestNativeAd(Landroid/content/Context;Lcom/google/android/gms/ads/mediation/MediationNativeListener;Landroid/os/Bundle;Lcom/google/android/gms/ads/mediation/NativeMediationAdRequest;Landroid/os/Bundle;)V
    ...
    invoke-interface/range {p4 .. p4}, Lcom/google/android/gms/ads/mediation/NativeMediationAdRequest;->getNativeAdOptions()Lcom/google/android/gms/ads/formats/NativeAdOptions;
    ...
    :cond_0
    invoke-interface/range {p4 .. p4}, Lcom/google/android/gms/ads/mediation/NativeMediationAdRequest;->isUnifiedNativeAdRequested()Z
    ...
    :cond_1
    invoke-interface/range {p4 .. p4}, Lcom/google/android/gms/ads/mediation/NativeMediationAdRequest;->isAppInstallAdRequested()Z
    ...
    :cond_2
    invoke-interface/range {p4 .. p4}, Lcom/google/android/gms/ads/mediation/NativeMediationAdRequest;->isContentAdRequested()Z
    ...
    :cond_3
    invoke-interface/range {p4 .. p4}, Lcom/google/android/gms/ads/mediation/NativeMediationAdRequest;->zzna()Z

    move-result v1

    if-eqz v1, :cond_5

    invoke-interface/range {p4 .. p4}, Lcom/google/android/gms/ads/mediation/NativeMediationAdRequest;->zznb()Ljava/util/Map;
    ...
    :cond_5
    invoke-virtual/range {p2 .. p2}, Lcom/google/android/gms/ads/AdLoader$Builder;->build()Lcom/google/android/gms/ads/AdLoader;
...
.method public showInterstitial()V
    ...
    iget-object p0, p0, Lcom/google/ads/mediation/AbstractAdViewAdapter;->zzgx:Lcom/google/android/gms/ads/InterstitialAd;
