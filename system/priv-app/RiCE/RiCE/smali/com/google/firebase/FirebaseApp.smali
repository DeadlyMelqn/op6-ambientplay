...
.method protected constructor <init>(Landroid/content/Context;Ljava/lang/String;Lcom/google/firebase/FirebaseOptions;)V
    ...
    invoke-direct/range {p2 .. p2}, Lcom/google/firebase/internal/zza;-><init>()V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/google/firebase/FirebaseApp;->zzb()Z
    ...
    invoke-virtual/range {p2 .. p2}, Lcom/google/firebase/components/zzc;->zza()Ljava/util/List;
...
.method public static getPersistenceKey(Ljava/lang/String;Lcom/google/firebase/FirebaseOptions;)Ljava/lang/String;
    ...
    invoke-static/range {p0 .. p0}, Lcom/google/android/gms/common/util/Base64Utils;->encodeUrlSafeNoPadding([B)Ljava/lang/String;
    ...
    .line 682
    invoke-virtual/range {p1 .. p1}, Lcom/google/firebase/FirebaseOptions;->getApplicationId()Ljava/lang/String;
...
.method public static initializeApp(Landroid/content/Context;)Lcom/google/firebase/FirebaseApp;
    ...
    .line 277
    :cond_0
    invoke-static/range {p0 .. p0}, Lcom/google/firebase/FirebaseOptions;->fromResource(Landroid/content/Context;)Lcom/google/firebase/FirebaseOptions;
...
.method public static initializeApp(Landroid/content/Context;Lcom/google/firebase/FirebaseOptions;Ljava/lang/String;)Lcom/google/firebase/FirebaseApp;
    ...
    .line 1777
    invoke-static/range {v0 .. v0}, Lcom/google/android/gms/common/api/internal/BackgroundDetector;->initialize(Landroid/app/Application;)V
    ...
    invoke-direct/range {v1 .. v1}, Lcom/google/firebase/FirebaseApp$1;-><init>()V
    ...
    .line 328
    invoke-direct/range {v1 .. v1}, Lcom/google/firebase/FirebaseApp;->zze()V
...
.method static synthetic zza(Lcom/google/firebase/FirebaseApp;)V
    ...
    .line 84
    invoke-direct/range {p0 .. p0}, Lcom/google/firebase/FirebaseApp;->zze()V
...
.method private static zza(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/Iterable;Z)V
    ...
    .line 738
    invoke-static/range {v2 .. v2}, Ljava/lang/reflect/Modifier;->isPublic(I)Z
...
.method private zza(Z)V
    ...
    .line 559
    iget-object p0, p0, Lcom/google/firebase/FirebaseApp;->zzs:Ljava/util/List;
...
.method private zzb()Z
    ...
    .line 509
    iget-object p0, p0, Lcom/google/firebase/FirebaseApp;->zzm:Landroid/content/SharedPreferences;

    const-string v0, "firebase_automatic_data_collection_enabled"
    ...
    .line 514
    iget-object p0, p0, Lcom/google/firebase/FirebaseApp;->zzi:Landroid/content/Context;
...
.method private zzc()V
    ...
    .line 530
    iget-object p0, p0, Lcom/google/firebase/FirebaseApp;->zzp:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private static zzd()Ljava/util/List;
    ...
    .line 689
    invoke-virtual/range {v3 .. v3}, Lcom/google/firebase/FirebaseApp;->getName()Ljava/lang/String;
...
.method private zze()V
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/content/ContextCompat;->isDeviceProtectedStorage(Landroid/content/Context;)Z
    ...
    invoke-static/range {v1 .. v1}, Lcom/google/firebase/FirebaseApp$zzb;->zza(Landroid/content/Context;)V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/firebase/FirebaseApp;->isDefaultApp()Z
...
.method public addBackgroundStateChangeListener(Lcom/google/firebase/FirebaseApp$BackgroundStateChangeListener;)V
    ...
    .line 606
    invoke-direct/range {p0 .. p0}, Lcom/google/firebase/FirebaseApp;->zzc()V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/common/api/internal/BackgroundDetector;->isInBackground()Z
...
.method public addIdTokenListener(Lcom/google/firebase/FirebaseApp$IdTokenListener;)V
    ...
    iget-object p0, p0, Lcom/google/firebase/FirebaseApp;->zzr:Ljava/util/List;

    invoke-interface/range {p0 .. p0}, Ljava/util/List;->size()I

    move-result p0

    invoke-interface {p1, p0}, Lcom/google/firebase/FirebaseApp$IdTokenListenersCountChangedListener;->onListenerCountChanged(I)V
...
.method public addLifecycleEventListener(Lcom/google/firebase/zza;)V
    ...
    .line 645
    iget-object p0, p0, Lcom/google/firebase/FirebaseApp;->zzt:Ljava/util/List;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 185
    :cond_0
    iget-object p0, p0, Lcom/google/firebase/FirebaseApp;->zzj:Ljava/lang/String;
...
.method public get(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    .line 421
    iget-object p0, p0, Lcom/google/firebase/FirebaseApp;->zzl:Lcom/google/firebase/components/zzd;

    invoke-virtual {p0, p1}, Lcom/google/firebase/components/zzd;->get(Ljava/lang/Class;)Ljava/lang/Object;
...
.method public getOptions()Lcom/google/firebase/FirebaseOptions;
    ...
    .line 177
    iget-object p0, p0, Lcom/google/firebase/FirebaseApp;->zzk:Lcom/google/firebase/FirebaseOptions;
...
.method public getPersistenceKey()Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/firebase/FirebaseApp;->getName()Ljava/lang/String;

    move-result-object v1

    invoke-virtual/range {v1 .. v1}, Ljava/lang/String;->getBytes()[B

    move-result-object v1

    invoke-static/range {v1 .. v1}, Lcom/google/android/gms/common/util/Base64Utils;->encodeUrlSafeNoPadding([B)Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/firebase/FirebaseOptions;->getApplicationId()Ljava/lang/String;
...
.method public getToken(Z)Lcom/google/android/gms/tasks/Task;
    ...
    const-string p1, "firebase-auth is not linked, please fall back to unauthenticated mode."

    invoke-direct {p0, p1}, Lcom/google/firebase/FirebaseApiNotAvailableException;-><init>(Ljava/lang/String;)V

    invoke-static/range {p0 .. p0}, Lcom/google/android/gms/tasks/Tasks;->forException(Ljava/lang/Exception;)Lcom/google/android/gms/tasks/Task;
    ...
    .line 374
    :cond_0
    iget-object p0, p0, Lcom/google/firebase/FirebaseApp;->zzu:Lcom/google/firebase/internal/InternalTokenProvider;

    invoke-interface {p0, p1}, Lcom/google/firebase/internal/InternalTokenProvider;->getAccessToken(Z)Lcom/google/android/gms/tasks/Task;
...
.method public getUid()Ljava/lang/String;
    ...
    invoke-interface/range {p0 .. p0}, Lcom/google/firebase/internal/InternalTokenProvider;->getUid()Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/FirebaseApiNotAvailableException;-><init>(Ljava/lang/String;)V
...
.method public isAutomaticDataCollectionEnabled()Z
    ...
    .line 458
    iget-object p0, p0, Lcom/google/firebase/FirebaseApp;->zzq:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public notifyIdTokenListeners(Lcom/google/firebase/internal/InternalTokenResult;)V
    ...
    check-cast v2, Lcom/google/firebase/FirebaseApp$IdTokenListener;

    .line 551
    invoke-interface {v2, p1}, Lcom/google/firebase/FirebaseApp$IdTokenListener;->onIdTokenChanged(Lcom/google/firebase/internal/InternalTokenResult;)V
    ...
    const-string p1, "Notified %d auth state listeners."
...
.method public setAutomaticDataCollectionEnabled(Z)V
    ...
    .line 475
    iget-object p0, p0, Lcom/google/firebase/FirebaseApp;->zzn:Lcom/google/firebase/events/Publisher;

    new-instance v0, Lcom/google/firebase/events/Event;

    const-class v1, Lcom/google/firebase/AutomaticDataCollectionChange;

    new-instance v2, Lcom/google/firebase/AutomaticDataCollectionChange;

    invoke-direct {v2, p1}, Lcom/google/firebase/AutomaticDataCollectionChange;-><init>(Z)V

    invoke-direct {v0, v1, v2}, Lcom/google/firebase/events/Event;-><init>(Ljava/lang/Class;Ljava/lang/Object;)V

    invoke-interface {p0, v0}, Lcom/google/firebase/events/Publisher;->publish(Lcom/google/firebase/events/Event;)V
