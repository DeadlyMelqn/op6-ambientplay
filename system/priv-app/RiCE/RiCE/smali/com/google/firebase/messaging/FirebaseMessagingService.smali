...
.method protected final zzb(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/firebase/iid/zzap;->zzad()Landroid/content/Intent;
...
.method public final zzc(Landroid/content/Intent;)Z
    ...
    :try_start_0
    invoke-virtual/range {v0 .. v0}, Landroid/app/PendingIntent;->send()V
    :try_end_0
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzk(Landroid/os/Bundle;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static/range {p0 .. p1}, Lcom/google/firebase/messaging/zzb;->zzd(Landroid/content/Context;Landroid/content/Intent;)V
...
.method public final zzd(Landroid/content/Intent;)V
    ...
    invoke-static/range {p0 .. p1}, Lcom/google/firebase/messaging/zzb;->zze(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static/range {v1 .. v1}, Lcom/google/android/gms/tasks/Tasks;->forResult(Ljava/lang/Object;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-static/range {p0 .. p0}, Lcom/google/firebase/iid/zzv;->zzc(Landroid/content/Context;)Lcom/google/firebase/iid/zzv;
    ...
    invoke-interface/range {v6 .. v6}, Ljava/util/Queue;->size()I
    ...
    invoke-interface/range {v6 .. v6}, Ljava/util/Queue;->remove()Ljava/lang/Object;
    ...
    invoke-static/range {p0 .. p1}, Lcom/google/firebase/messaging/zzb;->zzc(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static/range {p0 .. p0}, Lcom/google/firebase/messaging/zza;->zzd(Landroid/content/Context;)Lcom/google/firebase/messaging/zza;
    ...
    invoke-static/range {p0 .. p1}, Lcom/google/firebase/messaging/zzb;->zzf(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {v1, p0, p1, v0}, Lcom/google/android/gms/tasks/Tasks;->await(Lcom/google/android/gms/tasks/Task;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    :try_end_0
