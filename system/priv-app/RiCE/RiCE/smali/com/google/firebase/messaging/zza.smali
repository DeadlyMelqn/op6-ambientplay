...
.method private final zza(Ljava/lang/CharSequence;Ljava/lang/String;ILjava/lang/Integer;Landroid/net/Uri;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;)Landroid/app/Notification;
    ...
    invoke-direct/range {p1 .. p1}, Landroid/app/Notification$BigTextStyle;-><init>()V
    ...
    invoke-static/range {p1 .. p1}, Lcom/google/firebase/messaging/zza;->zzl(Ljava/lang/String;)Ljava/lang/reflect/Method;
    ...
    :cond_8
    :try_start_0
    iget-object p0, p0, Lcom/google/firebase/messaging/zza;->zzdj:Ljava/lang/reflect/Method;
    ...
    :cond_9
    :goto_0
    invoke-virtual/range {p3 .. p3}, Landroid/app/Notification$Builder;->build()Landroid/app/Notification;
...
.method private final zzal()Landroid/os/Bundle;
    ...
    iget-object p0, p0, Lcom/google/firebase/messaging/zza;->zzdi:Landroid/os/Bundle;
...
.method private final zzb(I)Z
    ...
    :try_start_0
    iget-object p0, p0, Lcom/google/firebase/messaging/zza;->zzz:Landroid/content/Context;
...
.method private final zzd(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {p1 .. p2}, Lcom/google/firebase/messaging/zza;->zza(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static/range {p1 .. p2}, Lcom/google/firebase/messaging/zza;->zzb(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_3
    invoke-static/range {p1 .. p2}, Lcom/google/firebase/messaging/zza;->zzc(Landroid/os/Bundle;Ljava/lang/String;)[Ljava/lang/Object;
...
.method private final zzm(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    :cond_1
    invoke-direct/range {p0 .. p0}, Lcom/google/firebase/messaging/zza;->zzal()Landroid/os/Bundle;
...
.method private final zzn(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget v8, Lcom/google/firebase/messaging/R$string;->fcm_fallback_notification_channel_label:I
...
.method final zzh(Landroid/os/Bundle;)Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/app/KeyguardManager;->inKeyguardRestrictedInputMode()Z
    ...
    invoke-static/range {v3 .. v4}, Landroid/os/SystemClock;->sleep(J)V
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/app/ActivityManager;->getRunningAppProcesses()Ljava/util/List;
    ...
    invoke-virtual/range {v10 .. v10}, Landroid/content/Context;->getPackageName()Ljava/lang/String;
    ...
    invoke-virtual/range {v10 .. v10}, Ljava/lang/String;->length()I
    ...
    invoke-static/range {v0 .. v0}, Landroid/media/RingtoneManager;->getDefaultUri(I)Landroid/net/Uri;
    ...
    invoke-virtual/range {v9 .. v9}, Landroid/content/Context;->getPackageName()Ljava/lang/String;
    ...
    invoke-static/range {v10 .. v10}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzj(Landroid/os/Bundle;)V

    invoke-virtual {v9, v10}, Landroid/content/Intent;->putExtras(Landroid/os/Bundle;)Landroid/content/Intent;

    invoke-virtual/range {v10 .. v10}, Landroid/os/Bundle;->keySet()Ljava/util/Set;

    move-result-object v10

    invoke-interface/range {v10 .. v10}, Ljava/util/Set;->iterator()Ljava/util/Iterator;

    move-result-object v10

    :cond_13
    :goto_4
    invoke-interface/range {v10 .. v10}, Ljava/util/Iterator;->hasNext()Z
    ...
    invoke-virtual/range {v11 .. v11}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I
    ...
    :goto_5
    invoke-static/range {p1 .. p1}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzk(Landroid/os/Bundle;)Z
    ...
    invoke-virtual/range {v10 .. v10}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/content/Context;->getApplicationInfo()Landroid/content/pm/ApplicationInfo;
    ...
    invoke-direct/range {v4 .. v4}, Landroid/support/v4/app/NotificationCompat$BigTextStyle;-><init>()V
    ...
    :cond_1d
    invoke-virtual/range {v3 .. v3}, Landroid/support/v4/app/NotificationCompat$Builder;->build()Landroid/app/Notification;
