...
.method public static zza(Lcom/google/android/gms/internal/ads/zzgk;)Landroid/os/Bundle;
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/google/android/gms/internal/ads/zzakd;->zzqu()Z
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/google/android/gms/internal/ads/zzakd;->zzqw()Z
    ...
    :cond_2
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/internal/ads/zzgk;->zzha()Z

    move-result v1

    if-eqz v1, :cond_3

    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/internal/ads/zzgk;->wakeup()V

    :cond_3
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/internal/ads/zzgk;->zzgy()Lcom/google/android/gms/internal/ads/zzge;

    move-result-object p0

    if-eqz p0, :cond_5

    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/internal/ads/zzge;->getSignature()Ljava/lang/String;

    move-result-object v1

    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/internal/ads/zzge;->zzgo()Ljava/lang/String;

    move-result-object v2

    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/internal/ads/zzge;->zzgp()Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/internal/ads/zzajm;->zzqh()Lcom/google/android/gms/internal/ads/zzakd;

    move-result-object p0

    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/internal/ads/zzakd;->zzqv()Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/internal/ads/zzakd;->zzqx()Ljava/lang/String;
    ...
    invoke-virtual/range {v4 .. v4}, Lcom/google/android/gms/internal/ads/zzajm;->zzqh()Lcom/google/android/gms/internal/ads/zzakd;

    move-result-object v4

    invoke-virtual/range {v4 .. v4}, Lcom/google/android/gms/internal/ads/zzakd;->zzqw()Z
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/internal/ads/zzakd;->zzqu()Z
    ...
    :cond_8
    invoke-virtual/range {v3 .. v3}, Landroid/os/Bundle;->isEmpty()Z
...
.method public static zza(Landroid/view/WindowManager;)Landroid/util/DisplayMetrics;
    ...
    invoke-direct/range {v0 .. v0}, Landroid/util/DisplayMetrics;-><init>()V
...
.method public static zza(Landroid/content/Context;Landroid/view/View;Lcom/google/android/gms/internal/ads/zzjn;)Ljava/lang/String;
    ...
    invoke-static/range {p0 .. p0}, Lcom/google/android/gms/internal/ads/zzakk;->zzap(Landroid/content/Context;)Ljava/lang/String;
...
.method public static zza(Landroid/content/Context;Ljava/lang/Throwable;)V
    ...
    invoke-static/range {p0 .. p1}, Lcom/google/android/gms/common/util/CrashUtils;->addDynamiteErrorToDropBox(Landroid/content/Context;Ljava/lang/Throwable;)Z
...
.method private final zza(Lorg/json/JSONArray;Ljava/lang/Object;)V
    ...
    :cond_4
    invoke-virtual/range {p1 .. p2}, Lorg/json/JSONArray;->put(Ljava/lang/Object;)Lorg/json/JSONArray;
...
.method private final zza(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :cond_4
    invoke-virtual/range {p1 .. p3}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
...
.method public static zza(Landroid/app/Activity;Landroid/content/res/Configuration;)Z
    ...
    invoke-static/range {v1 .. v1}, Lcom/google/android/gms/internal/ads/zzakk;->zza(Landroid/view/WindowManager;)Landroid/util/DisplayMetrics;
...
.method protected static zzam(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/webkit/WebView;->getSettings()Landroid/webkit/WebSettings;
...
.method public static zzaq(Landroid/content/Context;)Z
    ...
    :cond_0
    invoke-virtual/range {v1 .. v1}, Landroid/app/ActivityManager;->getRunningAppProcesses()Ljava/util/List;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/app/KeyguardManager;->inKeyguardRestrictedInputMode()Z
    ...
    :cond_3
    invoke-virtual/range {p0 .. p0}, Landroid/os/PowerManager;->isScreenOn()Z
...
.method public static zzar(Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {p0 .. p0}, Lcom/google/android/gms/internal/ads/zzakk;->zzv(Landroid/view/View;)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {p0 .. p0}, Lcom/google/android/gms/internal/ads/zzakk;->zzu(Landroid/view/View;)Landroid/graphics/Bitmap;
...
.method public static zzau(Landroid/content/Context;)Z
    ...
    :cond_0
    invoke-static/range {p0 .. p0}, Lcom/google/android/gms/internal/ads/zzakk;->zzat(Landroid/content/Context;)Landroid/app/KeyguardManager;

    move-result-object p0

    if-eqz p0, :cond_1

    invoke-virtual/range {p0 .. p0}, Landroid/app/KeyguardManager;->isKeyguardLocked()Z
...
.method public static zzb(Ljava/net/HttpURLConnection;)Landroid/webkit/WebResourceResponse;
    ...
    invoke-virtual/range {p0 .. p0}, Ljava/net/HttpURLConnection;->getContentType()Ljava/lang/String;
...
.method public static zzd(Ljava/lang/Runnable;)V
    ...
    :cond_0
    invoke-static/range {p0 .. p0}, Lcom/google/android/gms/internal/ads/zzaki;->zzb(Ljava/lang/Runnable;)Lcom/google/android/gms/internal/ads/zzanz;
...
.method public static zzrk()Landroid/os/Bundle;
    ...
    invoke-direct/range {v1 .. v1}, Landroid/os/Debug$MemoryInfo;-><init>()V

    invoke-static/range {v1 .. v1}, Landroid/os/Debug;->getMemoryInfo(Landroid/os/Debug$MemoryInfo;)V
    ...
    invoke-virtual/range {v1 .. v1}, Ljava/lang/Runtime;->freeMemory()J
    ...
    invoke-virtual/range {v1 .. v1}, Ljava/lang/Runtime;->maxMemory()J
    ...
    invoke-virtual/range {v1 .. v1}, Ljava/lang/Runtime;->totalMemory()J
    ...
    invoke-virtual/range {v2 .. v2}, Lcom/google/android/gms/internal/ads/zzajm;->zzqg()I
...
.method public static zzs(Landroid/view/View;)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {v0 .. v0}, Landroid/graphics/Bitmap;->createBitmap(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
...
.method private static zzv(Landroid/view/View;)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {v2 .. v2}, Landroid/graphics/Bitmap;->createBitmap(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
...
.method public final zza(Landroid/os/Bundle;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    :try_start_0
    invoke-direct/range {p0 .. p1}, Lcom/google/android/gms/internal/ads/zzakk;->zzf(Landroid/os/Bundle;)Lorg/json/JSONObject;
...
.method public final zza(Landroid/content/Context;Ljava/lang/String;Landroid/webkit/WebSettings;)V
    ...
    invoke-virtual/range {p0 .. p2}, Lcom/google/android/gms/internal/ads/zzakk;->zzm(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    invoke-virtual {p3, p0}, Landroid/webkit/WebSettings;->setUserAgentString(Ljava/lang/String;)V
...
.method public final zza(Landroid/content/Context;Ljava/util/List;)V
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/android/gms/internal/ads/zzbfw;->zzbn(Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_2
    invoke-static/range {p1 .. p1}, Lcom/google/android/gms/internal/ads/zzoh;->zzh(Landroid/content/Context;)Z
    ...
    invoke-direct/range {v1 .. v1}, Lcom/google/android/gms/internal/ads/zzoh;-><init>()V
...
.method public final zza(Landroid/view/View;Landroid/content/Context;)Z
    ...
    :goto_0
    invoke-static/range {p2 .. p2}, Lcom/google/android/gms/internal/ads/zzakk;->zzat(Landroid/content/Context;)Landroid/app/KeyguardManager;
...
.method public final zza(Landroid/view/View;Landroid/os/PowerManager;Landroid/app/KeyguardManager;)Z
    ...
    iget-boolean p0, p0, Lcom/google/android/gms/internal/ads/zzakk;->zzcrn:Z
    ...
    :cond_0
    invoke-virtual/range {p3 .. p3}, Landroid/app/KeyguardManager;->inKeyguardRestrictedInputMode()Z
    ...
    sget-object p0, Lcom/google/android/gms/internal/ads/zznk;->zzazu:Lcom/google/android/gms/internal/ads/zzna;

    invoke-static {}, Lcom/google/android/gms/internal/ads/zzkb;->zzik()Lcom/google/android/gms/internal/ads/zzni;

    move-result-object p3

    invoke-virtual {p3, p0}, Lcom/google/android/gms/internal/ads/zzni;->zzd(Lcom/google/android/gms/internal/ads/zzna;)Ljava/lang/Object;
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/os/PowerManager;->isScreenOn()Z
    ...
    sget-object p0, Lcom/google/android/gms/internal/ads/zznk;->zzazs:Lcom/google/android/gms/internal/ads/zzna;

    invoke-static {}, Lcom/google/android/gms/internal/ads/zzkb;->zzik()Lcom/google/android/gms/internal/ads/zzni;

    move-result-object p2

    invoke-virtual {p2, p0}, Lcom/google/android/gms/internal/ads/zzni;->zzd(Lcom/google/android/gms/internal/ads/zzna;)Ljava/lang/Object;
...
.method public final zzcx(Ljava/lang/String;)Z
    ...
    invoke-virtual/range {v2 .. v2}, Ljava/util/regex/Pattern;->pattern()Ljava/lang/String;
...
.method public final zzg(Landroid/app/Activity;)[I
    ...
    invoke-static/range {p1 .. p1}, Lcom/google/android/gms/internal/ads/zzakk;->zzf(Landroid/app/Activity;)[I
    ...
    invoke-static {p1, p0}, Lcom/google/android/gms/internal/ads/zzamu;->zzb(Landroid/content/Context;I)I
...
.method public final zzh(Landroid/app/Activity;)[I
    ...
    invoke-virtual {p0, v3}, Landroid/view/Window;->findViewById(I)Landroid/view/View;
...
.method public final zzm(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/google/android/gms/internal/ads/zzakk;->zzcpq:Ljava/lang/String;
    ...
    :cond_3
    invoke-static/range {p1 .. p1}, Lcom/google/android/gms/internal/ads/zzakk;->zzam(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/google/android/gms/common/wrappers/PackageManagerWrapper;->isCallerInstantApp()Z
...
.method public final zzn(Ljava/util/Map;)Lorg/json/JSONObject;
    ...
    invoke-virtual/range {p0 .. p0}, Ljava/lang/ClassCastException;->getMessage()Ljava/lang/String;
