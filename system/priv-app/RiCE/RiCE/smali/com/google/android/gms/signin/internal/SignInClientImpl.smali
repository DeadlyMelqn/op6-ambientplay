...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;ZLcom/google/android/gms/common/internal/ClientSettings;Landroid/os/Bundle;Lcom/google/android/gms/common/api/GoogleApiClient$ConnectionCallbacks;Lcom/google/android/gms/common/api/GoogleApiClient$OnConnectionFailedListener;)V
    ...
    invoke-virtual/range {p4 .. p4}, Lcom/google/android/gms/common/internal/ClientSettings;->getClientSessionId()Ljava/lang/Integer;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;ZLcom/google/android/gms/common/internal/ClientSettings;Lcom/google/android/gms/signin/SignInOptions;Lcom/google/android/gms/common/api/GoogleApiClient$ConnectionCallbacks;Lcom/google/android/gms/common/api/GoogleApiClient$OnConnectionFailedListener;)V
    ...
    invoke-static/range {p4 .. p4}, Lcom/google/android/gms/signin/internal/SignInClientImpl;->createBundleFromClientSettings(Lcom/google/android/gms/common/internal/ClientSettings;)Landroid/os/Bundle;
...
.method public static createBundleFromClientSettings(Lcom/google/android/gms/common/internal/ClientSettings;)Landroid/os/Bundle;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/common/internal/ClientSettings;->getSignInOptions()Lcom/google/android/gms/signin/SignInOptions;

    move-result-object v0

    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/common/internal/ClientSettings;->getClientSessionId()Ljava/lang/Integer;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/common/internal/ClientSettings;->getAccount()Landroid/accounts/Account;
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/signin/SignInOptions;->isOfflineAccessRequested()Z
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/signin/SignInOptions;->isIdTokenRequested()Z
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/signin/SignInOptions;->getServerClientId()Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/signin/SignInOptions;->isForceCodeForRefreshToken()Z
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/signin/SignInOptions;->getHostedDomain()Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/signin/SignInOptions;->waitForAccessTokenRefresh()Z

    move-result v1

    invoke-virtual {v2, p0, v1}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/signin/SignInOptions;->getAuthApiSignInModuleVersion()Ljava/lang/Long;
    ...
    :cond_1
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/signin/SignInOptions;->getRealClientLibraryVersion()Ljava/lang/Long;
...
.method public clearAccountFromSessionStore()V
    ...
    iget-object p0, p0, Lcom/google/android/gms/signin/internal/SignInClientImpl;->zzsc:Ljava/lang/Integer;

    invoke-virtual/range {p0 .. p0}, Ljava/lang/Integer;->intValue()I

    move-result p0

    invoke-interface {v0, p0}, Lcom/google/android/gms/signin/internal/ISignInService;->clearAccountFromSessionStore(I)V
    :try_end_0
...
.method protected bridge synthetic createServiceInterface(Landroid/os/IBinder;)Landroid/os/IInterface;
    ...
    invoke-virtual/range {p0 .. p1}, Lcom/google/android/gms/signin/internal/SignInClientImpl;->createServiceInterface(Landroid/os/IBinder;)Lcom/google/android/gms/signin/internal/ISignInService;
...
.method protected createServiceInterface(Landroid/os/IBinder;)Lcom/google/android/gms/signin/internal/ISignInService;
    ...
    invoke-static/range {p1 .. p1}, Lcom/google/android/gms/signin/internal/ISignInService$Stub;->asInterface(Landroid/os/IBinder;)Lcom/google/android/gms/signin/internal/ISignInService;
...
.method protected getGetServiceRequestExtraArgs()Landroid/os/Bundle;
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/common/internal/ClientSettings;->getRealClientPackageName()Ljava/lang/String;
    ...
    invoke-virtual/range {v2 .. v2}, Lcom/google/android/gms/common/internal/ClientSettings;->getRealClientPackageName()Ljava/lang/String;
    ...
    :cond_0
    iget-object p0, p0, Lcom/google/android/gms/signin/internal/SignInClientImpl;->zzada:Landroid/os/Bundle;
...
.method public requiresSignIn()Z
    ...
    iget-boolean p0, p0, Lcom/google/android/gms/signin/internal/SignInClientImpl;->zzads:Z
...
.method public saveDefaultAccount(Lcom/google/android/gms/common/internal/IAccountAccessor;Z)V
    ...
    invoke-interface {v0, p1, p0, p2}, Lcom/google/android/gms/signin/internal/ISignInService;->saveDefaultAccountToSharedPref(Lcom/google/android/gms/common/internal/IAccountAccessor;IZ)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public signIn(Lcom/google/android/gms/signin/internal/ISignInCallbacks;)V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/common/internal/ClientSettings;->getAccountOrDefault()Landroid/accounts/Account;
    ...
    invoke-static/range {v1 .. v1}, Lcom/google/android/gms/auth/api/signin/internal/Storage;->getInstance(Landroid/content/Context;)Lcom/google/android/gms/auth/api/signin/internal/Storage;

    move-result-object v1

    invoke-virtual/range {v1 .. v1}, Lcom/google/android/gms/auth/api/signin/internal/Storage;->getSavedDefaultGoogleSignInAccount()Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;
    ...
    check-cast p0, Lcom/google/android/gms/signin/internal/ISignInService;

    new-instance v0, Lcom/google/android/gms/signin/internal/SignInRequest;

    invoke-direct {v0, v2}, Lcom/google/android/gms/signin/internal/SignInRequest;-><init>(Lcom/google/android/gms/common/internal/ResolveAccountRequest;)V

    invoke-interface {p0, v0, p1}, Lcom/google/android/gms/signin/internal/ISignInService;->signIn(Lcom/google/android/gms/signin/internal/SignInRequest;Lcom/google/android/gms/signin/internal/ISignInCallbacks;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v0, v1}, Lcom/google/android/gms/signin/internal/SignInResponse;-><init>(I)V

    invoke-interface {p1, v0}, Lcom/google/android/gms/signin/internal/ISignInCallbacks;->onSignInComplete(Lcom/google/android/gms/signin/internal/SignInResponse;)V
    :try_end_1
