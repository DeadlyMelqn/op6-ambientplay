...
.method private static ensurePlayServicesAvailable(Landroid/content/Context;I)V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/common/GooglePlayServicesNotAvailableException;->getMessage()Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/common/GooglePlayServicesRepairableException;->getConnectionStatusCode()I

    move-result v0

    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/common/GooglePlayServicesRepairableException;->getMessage()Ljava/lang/String;

    move-result-object v1

    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/common/GooglePlayServicesRepairableException;->getIntent()Landroid/content/Intent;
...
.method public static getToken(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static/range {p1 .. p1}, Lcom/google/android/gms/auth/zzg;->zze(Landroid/accounts/Account;)V

    invoke-static/range {p0 .. p3}, Lcom/google/android/gms/auth/zzg;->zze(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
...
.method private static zzd(Landroid/content/Context;Landroid/content/ComponentName;Lcom/google/android/gms/auth/zzm;)Ljava/lang/Object;
    ...
    invoke-direct/range {v0 .. v0}, Lcom/google/android/gms/common/BlockingServiceConnection;-><init>()V

    invoke-static/range {p0 .. p0}, Lcom/google/android/gms/common/internal/GmsClientSupervisor;->getInstance(Landroid/content/Context;)Lcom/google/android/gms/common/internal/GmsClientSupervisor;
    ...
    :try_start_0
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/common/BlockingServiceConnection;->getService()Landroid/os/IBinder;
...
.method static synthetic zze(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static/range {p0 .. p0}, Lcom/google/android/gms/auth/zzg;->zzd(Ljava/lang/Object;)Ljava/lang/Object;
