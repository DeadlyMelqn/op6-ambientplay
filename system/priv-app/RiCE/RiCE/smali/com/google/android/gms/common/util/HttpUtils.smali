...
.method public static isIPv6Address(Ljava/lang/String;)Z
    ...
    invoke-static/range {p0 .. p0}, Lcom/google/android/gms/common/util/HttpUtils;->isIPv6StdAddress(Ljava/lang/String;)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-static/range {p0 .. p0}, Lcom/google/android/gms/common/util/HttpUtils;->isIPv6HexCompressedAddress(Ljava/lang/String;)Z
...
.method public static parse(Ljava/net/URI;Ljava/lang/String;)Ljava/util/Map;
    ...
    :goto_0
    invoke-virtual/range {v1 .. v1}, Ljava/util/Scanner;->hasNext()Z

    move-result p0

    if-eqz p0, :cond_2

    invoke-virtual/range {v1 .. v1}, Ljava/util/Scanner;->next()Ljava/lang/String;
