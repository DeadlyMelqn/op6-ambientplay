...
.method public static getUnzippedStream([B)Ljava/io/InputStream;
    ...
    invoke-static/range {p0 .. p0}, Lcom/google/android/gms/common/util/IOUtils;->isGzipByteBuffer([B)Z
...
.method private final zza(Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Ljava/lang/Object;)V
    ...
    invoke-virtual/range {p1 .. p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->convert(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p2

    invoke-virtual/range {p1 .. p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->getTypeOut()I
...
.method private static zza(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Ljava/lang/Object;)V
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->getTypeIn()I
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->getConcreteType()Ljava/lang/Class;
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->toString()Ljava/lang/String;
    ...
    invoke-static/range {p2 .. p2}, Lcom/google/android/gms/common/util/JsonUtils;->escapeString(Ljava/lang/String;)Ljava/lang/String;
...
.method protected getFieldValue(Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;)Ljava/lang/Object;
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->isTypeOutArray()Z

    move-result p1

    if-eqz p1, :cond_1

    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->getConcreteTypeArrays()Ljava/util/HashMap;
    ...
    :cond_1
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->getConcreteTypes()Ljava/util/HashMap;
...
.method protected getOriginalValue(Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static/range {p1 .. p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zza(Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;)Lcom/google/android/gms/common/server/response/FastJsonResponse$FieldConverter;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-virtual/range {p1 .. p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->convertBack(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public getResponseBody()[B
    ...
    :cond_0
    invoke-virtual/range {v3 .. v3}, Ljava/io/ByteArrayOutputStream;->flush()V
    ...
    :goto_1
    :try_start_3
    iget-object p0, p0, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzwl:[B
    :try_end_3
...
.method public getResponseCode()I
    ...
    iget p0, p0, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzwk:I
...
.method public parseNetworkResponse(I[B)V
    ...
    invoke-static/range {p2 .. p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->getUnzippedStream([B)Ljava/io/InputStream;
    ...
    invoke-direct/range {p2 .. p2}, Lcom/google/android/gms/common/server/response/FastParser;-><init>()V
...
.method public final setBigDecimal(Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Ljava/math/BigDecimal;)V
    ...
    invoke-direct/range {p0 .. p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zza(Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Ljava/lang/Object;)V
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->getFieldMappings()Ljava/util/Map;
    ...
    :cond_2
    invoke-virtual/range {v4 .. v4}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->getTypeOut()I

    move-result v3

    packed-switch v3, :pswitch_data_0

    invoke-virtual/range {v4 .. v4}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->isTypeInArray()Z
    ...
    invoke-static/range {v5 .. v5}, Lcom/google/android/gms/common/util/Base64Utils;->encodeUrlSafe([B)Ljava/lang/String;
    ...
    invoke-static/range {v5 .. v5}, Lcom/google/android/gms/common/util/Base64Utils;->encode([B)Ljava/lang/String;
