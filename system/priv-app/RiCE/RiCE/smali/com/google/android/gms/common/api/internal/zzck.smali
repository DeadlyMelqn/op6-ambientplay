...
.method public final release()V
    ...
    invoke-virtual/range {v4 .. v4}, Lcom/google/android/gms/common/api/PendingResult;->zzo()Ljava/lang/Integer;

    move-result-object v6

    if-nez v6, :cond_0

    invoke-virtual/range {v4 .. v4}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zzw()Z
    ...
    invoke-virtual/range {v7 .. v7}, Lcom/google/android/gms/common/api/internal/BaseImplementation$ApiMethodImpl;->getClientKey()Lcom/google/android/gms/common/api/Api$AnyClientKey;
    ...
    invoke-interface/range {v6 .. v6}, Lcom/google/android/gms/common/api/Api$Client;->getServiceBrokerBinder()Landroid/os/IBinder;

    move-result-object v6

    invoke-virtual/range {v4 .. v4}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->isReady()Z
    ...
    invoke-interface/range {v6 .. v6}, Landroid/os/IBinder;->isBinderAlive()Z
    ...
    :catch_0
    invoke-virtual/range {v4 .. v4}, Lcom/google/android/gms/common/api/PendingResult;->cancel()V
...
.method final zzb(Lcom/google/android/gms/common/api/internal/BasePendingResult;)V
    ...
    iget-object p0, p0, Lcom/google/android/gms/common/api/internal/zzck;->zzmp:Lcom/google/android/gms/common/api/internal/zzcn;

    invoke-virtual {p1, p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zza(Lcom/google/android/gms/common/api/internal/zzcn;)V
...
.method public final zzce()V
    ...
    iget-object p0, p0, Lcom/google/android/gms/common/api/internal/zzck;->zzmo:Ljava/util/Set;

    sget-object v0, Lcom/google/android/gms/common/api/internal/zzck;->zzmn:[Lcom/google/android/gms/common/api/internal/BasePendingResult;
    ...
    sget-object v3, Lcom/google/android/gms/common/api/internal/zzck;->zzmm:Lcom/google/android/gms/common/api/Status;

    invoke-virtual {v2, v3}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zzb(Lcom/google/android/gms/common/api/Status;)V
