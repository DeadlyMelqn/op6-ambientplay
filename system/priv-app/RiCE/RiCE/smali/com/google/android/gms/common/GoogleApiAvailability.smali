...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Lcom/google/android/gms/common/GoogleApiAvailability;-><init>()V
...
.method constructor <init>()V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;-><init>()V
...
.method static zza(Landroid/content/Context;ILcom/google/android/gms/common/internal/DialogRedirect;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    :cond_2
    invoke-static/range {p0 .. p1}, Lcom/google/android/gms/common/internal/ConnectionErrorMessages;->getErrorMessage(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static/range {p0 .. p1}, Lcom/google/android/gms/common/internal/ConnectionErrorMessages;->getErrorDialogButtonMessage(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_4
    invoke-static/range {p0 .. p1}, Lcom/google/android/gms/common/internal/ConnectionErrorMessages;->getErrorTitle(Landroid/content/Context;I)Ljava/lang/String;
...
.method private final zza(Landroid/content/Context;Landroid/app/NotificationManager;)Ljava/lang/String;
    ...
    invoke-direct/range {p0 .. p0}, Lcom/google/android/gms/common/GoogleApiAvailability;->zzb()Ljava/lang/String;
    ...
    invoke-static/range {p1 .. p1}, Lcom/google/android/gms/common/internal/ConnectionErrorMessages;->getDefaultNotificationChannelName(Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual/range {v0 .. v0}, Landroid/app/NotificationChannel;->getName()Ljava/lang/CharSequence;
...
.method private final zza(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-virtual/range {p0 .. p1}, Lcom/google/android/gms/common/GoogleApiAvailability;->zza(Landroid/content/Context;)V
    ...
    invoke-static/range {v4 .. v4}, Lcom/google/android/gms/common/internal/Preconditions;->checkState(Z)V
    ...
    invoke-direct/range {v4 .. v4}, Landroid/app/Notification$BigTextStyle;-><init>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v4/app/NotificationCompat$BigTextStyle;-><init>()V
    ...
    invoke-virtual {p4, p0}, Landroid/support/v4/app/NotificationCompat$Builder;->setChannelId(Ljava/lang/String;)Landroid/support/v4/app/NotificationCompat$Builder;

    :cond_6
    invoke-virtual/range {p4 .. p4}, Landroid/support/v4/app/NotificationCompat$Builder;->build()Landroid/app/Notification;
    ...
    sget-object p2, Lcom/google/android/gms/common/GooglePlayServicesUtilLight;->zzbt:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_7
    invoke-virtual {v3, p3, p1, p0}, Landroid/app/NotificationManager;->notify(Ljava/lang/String;ILandroid/app/Notification;)V
...
.method private final zzb()Ljava/lang/String;
    ...
    :try_start_0
    iget-object p0, p0, Lcom/google/android/gms/common/GoogleApiAvailability;->zzat:Ljava/lang/String;
...
.method public varargs checkApiAvailability(Lcom/google/android/gms/common/api/GoogleApi;[Lcom/google/android/gms/common/api/GoogleApi;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-virtual/range {p0 .. p2}, Lcom/google/android/gms/common/GoogleApiAvailability;->checkApiAvailabilityAndPackages(Lcom/google/android/gms/common/api/GoogleApi;[Lcom/google/android/gms/common/api/GoogleApi;)Lcom/google/android/gms/tasks/Task;
...
.method public varargs checkApiAvailabilityAndPackages(Lcom/google/android/gms/common/api/GoogleApi;[Lcom/google/android/gms/common/api/GoogleApi;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-virtual {p1, p0}, Lcom/google/android/gms/common/api/internal/GoogleApiManager;->zza(Ljava/lang/Iterable;)Lcom/google/android/gms/tasks/Task;
...
.method public getApkVersion(Landroid/content/Context;)I
    ...
    invoke-super/range {p0 .. p1}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->getApkVersion(Landroid/content/Context;)I
...
.method public getClientVersion(Landroid/content/Context;)I
    ...
    invoke-super/range {p0 .. p1}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->getClientVersion(Landroid/content/Context;)I
...
.method public getErrorDialog(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, p2, p0, p4}, Lcom/google/android/gms/common/GoogleApiAvailability;->zza(Landroid/content/Context;ILcom/google/android/gms/common/internal/DialogRedirect;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public getErrorResolutionIntent(I)Landroid/content/Intent;
    ...
    invoke-super/range {p0 .. p1}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->getErrorResolutionIntent(I)Landroid/content/Intent;
...
.method public getErrorResolutionIntent(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-super/range {p0 .. p3}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->getErrorResolutionIntent(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
...
.method public getErrorResolutionPendingIntent(Landroid/content/Context;II)Landroid/app/PendingIntent;
    ...
    invoke-super/range {p0 .. p3}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->getErrorResolutionPendingIntent(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public getErrorResolutionPendingIntent(Landroid/content/Context;IILjava/lang/String;)Landroid/app/PendingIntent;
    ...
    invoke-super/range {p0 .. p4}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->getErrorResolutionPendingIntent(Landroid/content/Context;IILjava/lang/String;)Landroid/app/PendingIntent;
...
.method public getErrorResolutionPendingIntent(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;)Landroid/app/PendingIntent;
    ...
    invoke-virtual/range {p2 .. p2}, Lcom/google/android/gms/common/ConnectionResult;->hasResolution()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual/range {p2 .. p2}, Lcom/google/android/gms/common/ConnectionResult;->getResolution()Landroid/app/PendingIntent;
    ...
    :cond_0
    invoke-virtual/range {p2 .. p2}, Lcom/google/android/gms/common/ConnectionResult;->getErrorCode()I
...
.method public final getErrorString(I)Ljava/lang/String;
    ...
    invoke-super/range {p0 .. p1}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->getErrorString(I)Ljava/lang/String;
...
.method public isGooglePlayServicesAvailable(Landroid/content/Context;)I
    ...
    invoke-super/range {p0 .. p1}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->isGooglePlayServicesAvailable(Landroid/content/Context;)I
...
.method public isGooglePlayServicesAvailable(Landroid/content/Context;I)I
    ...
    invoke-super/range {p0 .. p2}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->isGooglePlayServicesAvailable(Landroid/content/Context;I)I
...
.method public isPlayServicesPossiblyUpdating(Landroid/content/Context;I)Z
    ...
    invoke-super/range {p0 .. p2}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->isPlayServicesPossiblyUpdating(Landroid/content/Context;I)Z
...
.method public isPlayStorePossiblyUpdating(Landroid/content/Context;I)Z
    ...
    invoke-super/range {p0 .. p2}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->isPlayStorePossiblyUpdating(Landroid/content/Context;I)Z
...
.method public final isUserResolvableError(I)Z
    ...
    invoke-super/range {p0 .. p1}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->isUserResolvableError(I)Z
...
.method public makeGooglePlayServicesAvailable(Landroid/app/Activity;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-virtual/range {p0 .. p1}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->isGooglePlayServicesAvailable(Landroid/content/Context;)I
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/android/gms/tasks/Tasks;->forResult(Ljava/lang/Object;)Lcom/google/android/gms/tasks/Task;
    ...
    :cond_0
    invoke-static/range {p1 .. p1}, Lcom/google/android/gms/common/api/internal/zzbt;->zzd(Landroid/app/Activity;)Lcom/google/android/gms/common/api/internal/zzbt;
    ...
    invoke-virtual {p1, v1, p0}, Lcom/google/android/gms/common/api/internal/zzk;->zzb(Lcom/google/android/gms/common/ConnectionResult;I)V

    invoke-virtual/range {p1 .. p1}, Lcom/google/android/gms/common/api/internal/zzbt;->getTask()Lcom/google/android/gms/tasks/Task;
...
.method public registerCallbackOnUpdate(Landroid/content/Context;Lcom/google/android/gms/common/api/internal/GooglePlayServicesUpdatedReceiver$Callback;)Lcom/google/android/gms/common/api/internal/GooglePlayServicesUpdatedReceiver;
    ...
    invoke-virtual/range {p2 .. p2}, Lcom/google/android/gms/common/api/internal/GooglePlayServicesUpdatedReceiver$Callback;->zzv()V

    invoke-virtual/range {v1 .. v1}, Lcom/google/android/gms/common/api/internal/GooglePlayServicesUpdatedReceiver;->unregister()V
...
.method public showErrorDialogFragment(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    invoke-virtual/range {p0 .. p4}, Lcom/google/android/gms/common/GoogleApiAvailability;->getErrorDialog(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public showErrorDialogFragment(Landroid/app/Activity;Lcom/google/android/gms/common/api/internal/LifecycleFragment;IILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    invoke-static {p1, p3, p0, p5}, Lcom/google/android/gms/common/GoogleApiAvailability;->zza(Landroid/content/Context;ILcom/google/android/gms/common/internal/DialogRedirect;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, p0, p2, p5}, Lcom/google/android/gms/common/GoogleApiAvailability;->zza(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public showErrorNotification(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;)V
    ...
    invoke-virtual/range {p0 .. p2}, Lcom/google/android/gms/common/GoogleApiAvailability;->getErrorResolutionPendingIntent(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;)Landroid/app/PendingIntent;
...
.method public showUpdatingDialog(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, p0}, Lcom/google/android/gms/common/internal/ConnectionErrorMessages;->getErrorMessage(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/app/AlertDialog$Builder;->create()Landroid/app/AlertDialog;

    move-result-object p0

    const-string v0, "GooglePlayServicesUpdatingDialog"

    invoke-static {p1, p0, v0, p2}, Lcom/google/android/gms/common/GoogleApiAvailability;->zza(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
