...
.method public static zzb(Ljava/lang/String;Z)[Ljava/lang/String;
    ...
    invoke-static/range {v6 .. v6}, Ljava/lang/Character;->charCount(I)I

    move-result v7

    invoke-static/range {v6 .. v6}, Ljava/lang/Character;->isLetter(I)Z
    ...
    invoke-static/range {v6 .. v6}, Ljava/lang/Character$UnicodeBlock;->of(I)Ljava/lang/Character$UnicodeBlock;
    ...
    :cond_9
    invoke-static/range {v6 .. v6}, Ljava/lang/Character;->isLetterOrDigit(I)Z

    move-result v8

    if-nez v8, :cond_c

    invoke-static/range {v6 .. v6}, Ljava/lang/Character;->getType(I)I
    ...
    invoke-static/range {v6 .. v6}, Ljava/lang/Character;->toChars(I)[C
