...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct/range {p0 .. p1}, Lcom/google/android/gms/internal/ads/zzagb;->zzn(Landroid/content/Context;)V

    invoke-direct/range {p0 .. p1}, Lcom/google/android/gms/internal/ads/zzagb;->zzo(Landroid/content/Context;)V

    invoke-direct/range {p0 .. p1}, Lcom/google/android/gms/internal/ads/zzagb;->zzp(Landroid/content/Context;)V
    ...
    invoke-virtual/range {v1 .. v1}, Ljava/util/Locale;->getCountry()Ljava/lang/String;
    ...
    invoke-static/range {p1 .. p1}, Lcom/google/android/gms/common/util/DeviceProperties;->isSidewinder(Landroid/content/Context;)Z

    move-result v2

    iput-boolean v2, p0, Lcom/google/android/gms/internal/ads/zzagb;->zzcjq:Z

    invoke-virtual/range {v1 .. v1}, Ljava/util/Locale;->getLanguage()Ljava/lang/String;
...
.method private final zzn(Landroid/content/Context;)V
    ...
    :try_start_0
    invoke-virtual/range {p1 .. p1}, Landroid/media/AudioManager;->getMode()I

    move-result v0

    iput v0, p0, Lcom/google/android/gms/internal/ads/zzagb;->zzcjk:I

    invoke-virtual/range {p1 .. p1}, Landroid/media/AudioManager;->isMusicActive()Z

    move-result v0

    iput-boolean v0, p0, Lcom/google/android/gms/internal/ads/zzagb;->zzcjr:Z

    invoke-virtual/range {p1 .. p1}, Landroid/media/AudioManager;->isSpeakerphoneOn()Z
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/media/AudioManager;->getRingerMode()I
...
.method private final zzo(Landroid/content/Context;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/telephony/TelephonyManager;->getNetworkOperator()Ljava/lang/String;

    move-result-object v2

    iput-object v2, p0, Lcom/google/android/gms/internal/ads/zzagb;->zzcjn:Ljava/lang/String;

    invoke-virtual/range {v0 .. v0}, Landroid/telephony/TelephonyManager;->getNetworkType()I

    move-result v2

    iput v2, p0, Lcom/google/android/gms/internal/ads/zzagb;->zzcjy:I

    invoke-virtual/range {v0 .. v0}, Landroid/telephony/TelephonyManager;->getPhoneType()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/net/ConnectivityManager;->getActiveNetworkInfo()Landroid/net/NetworkInfo;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/net/ConnectivityManager;->isActiveNetworkMetered()Z
