...
.method public static zzd(Lcom/google/android/gms/common/api/GoogleApiClient;Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;Z)Lcom/google/android/gms/common/api/OptionalPendingResult;
    ...
    invoke-static/range {p1 .. p1}, Lcom/google/android/gms/auth/api/signin/internal/zzq;->zze(Landroid/content/Context;)Lcom/google/android/gms/auth/api/signin/internal/zzq;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/auth/api/signin/internal/zzq;->zzp()Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->getAccount()Landroid/accounts/Account;

    move-result-object v3

    invoke-virtual/range {p2 .. p2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->getAccount()Landroid/accounts/Account;
    ...
    invoke-virtual/range {p2 .. p2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->isServerAuthCodeRequested()Z

    move-result v3

    if-nez v3, :cond_3

    invoke-virtual/range {p2 .. p2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->isIdTokenRequested()Z

    move-result v3

    if-eqz v3, :cond_2

    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->isIdTokenRequested()Z

    move-result v3

    if-eqz v3, :cond_3

    invoke-virtual/range {p2 .. p2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->getServerClientId()Ljava/lang/String;

    move-result-object v3

    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->getServerClientId()Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->getScopes()Ljava/util/ArrayList;
    ...
    invoke-virtual/range {p2 .. p2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->getScopes()Ljava/util/ArrayList;
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/auth/api/signin/internal/zzq;->zzo()Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;

    move-result-object v0

    if-eqz v0, :cond_3

    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;->isExpired()Z
...
.method public static zzd(Lcom/google/android/gms/common/api/GoogleApiClient;Landroid/content/Context;Z)Lcom/google/android/gms/common/api/PendingResult;
    ...
    invoke-static/range {p1 .. p1}, Lcom/google/android/gms/auth/api/signin/internal/zzi;->zzd(Landroid/content/Context;)V
...
.method private static zzd(Landroid/content/Context;)V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/common/api/GoogleApiClient;->maybeSignOut()V
...
.method public static zze(Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)Landroid/content/Intent;
    ...
    invoke-static/range {p0 .. p1}, Lcom/google/android/gms/auth/api/signin/internal/zzi;->zzd(Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)Landroid/content/Intent;
...
.method public static zze(Lcom/google/android/gms/common/api/GoogleApiClient;Landroid/content/Context;Z)Lcom/google/android/gms/common/api/PendingResult;
    ...
    invoke-static/range {p1 .. p1}, Lcom/google/android/gms/auth/api/signin/internal/Storage;->getInstance(Landroid/content/Context;)Lcom/google/android/gms/auth/api/signin/internal/Storage;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/auth/api/signin/internal/Storage;->getSavedRefreshToken()Ljava/lang/String;
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/android/gms/auth/api/signin/internal/zze;->zzg(Ljava/lang/String;)Lcom/google/android/gms/common/api/PendingResult;
