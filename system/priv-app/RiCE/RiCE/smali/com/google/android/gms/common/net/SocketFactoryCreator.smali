...
.method public static getInstance()Lcom/google/android/gms/common/net/SocketFactoryCreator;
    ...
    invoke-direct/range {v0 .. v0}, Lcom/google/android/gms/common/net/SocketFactoryCreator;-><init>()V
...
.method protected getRemoteCreator(Landroid/os/IBinder;)Lcom/google/android/gms/common/net/ISocketFactoryCreator;
    ...
    invoke-static/range {p1 .. p1}, Lcom/google/android/gms/common/net/ISocketFactoryCreator$Stub;->asInterface(Landroid/os/IBinder;)Lcom/google/android/gms/common/net/ISocketFactoryCreator;
...
.method protected bridge synthetic getRemoteCreator(Landroid/os/IBinder;)Ljava/lang/Object;
    ...
    invoke-virtual/range {p0 .. p1}, Lcom/google/android/gms/common/net/SocketFactoryCreator;->getRemoteCreator(Landroid/os/IBinder;)Lcom/google/android/gms/common/net/ISocketFactoryCreator;
...
.method public makeSocketFactory(Landroid/content/Context;[Ljavax/net/ssl/KeyManager;[Ljavax/net/ssl/TrustManager;Z)Ljavax/net/ssl/SSLSocketFactory;
    ...
    :try_start_0
    invoke-virtual/range {p0 .. p1}, Lcom/google/android/gms/dynamic/RemoteCreator;->getRemoteCreatorInstance(Landroid/content/Context;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/google/android/gms/common/net/ISocketFactoryCreator;
    ...
    invoke-interface {p0, p1, p2, p3, p4}, Lcom/google/android/gms/common/net/ISocketFactoryCreator;->newSocketFactory(Lcom/google/android/gms/dynamic/IObjectWrapper;Lcom/google/android/gms/dynamic/IObjectWrapper;Lcom/google/android/gms/dynamic/IObjectWrapper;Z)Lcom/google/android/gms/dynamic/IObjectWrapper;
