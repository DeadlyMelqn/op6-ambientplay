...
.method private static zza(Ljava/security/spec/EllipticCurve;)Ljava/math/BigInteger;
    ...
    invoke-virtual/range {p0 .. p0}, Ljava/security/spec/ECFieldFp;->getP()Ljava/math/BigInteger;
...
.method public static zza(Ljava/security/spec/ECParameterSpec;)Ljava/security/KeyPair;
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/security/KeyPairGenerator;->generateKeyPair()Ljava/security/KeyPair;
...
.method public static zza(Lcom/google/android/gms/internal/ads/zzayv;)Ljava/security/spec/ECParameterSpec;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/internal/ads/zzayv;->ordinal()I
...
.method static zza(Ljava/security/spec/ECPoint;Ljava/security/spec/EllipticCurve;)V
    ...
    invoke-static/range {p1 .. p1}, Lcom/google/android/gms/internal/ads/zzayt;->zza(Ljava/security/spec/EllipticCurve;)Ljava/math/BigInteger;

    move-result-object v0

    invoke-virtual/range {p0 .. p0}, Ljava/security/spec/ECPoint;->getAffineX()Ljava/math/BigInteger;

    move-result-object v1

    invoke-virtual/range {p0 .. p0}, Ljava/security/spec/ECPoint;->getAffineY()Ljava/math/BigInteger;
    ...
    invoke-virtual/range {v1 .. v1}, Ljava/math/BigInteger;->signum()I
    ...
    invoke-virtual/range {p1 .. p1}, Ljava/security/spec/EllipticCurve;->getA()Ljava/math/BigInteger;
    ...
    invoke-virtual/range {p1 .. p1}, Ljava/security/spec/EllipticCurve;->getB()Ljava/math/BigInteger;
...
.method public static zza(Ljava/security/interfaces/ECPrivateKey;Ljava/security/spec/ECPoint;)[B
    ...
    invoke-virtual/range {v0 .. v0}, Ljavax/crypto/KeyAgreement;->generateSecret()[B
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/math/BigInteger;->signum()I
    ...
    invoke-static/range {p0 .. p0}, Lcom/google/android/gms/internal/ads/zzayt;->zza(Ljava/security/spec/EllipticCurve;)Ljava/math/BigInteger;
    ...
    invoke-virtual/range {v2 .. v2}, Ljava/math/BigInteger;->signum()I
    ...
    invoke-virtual/range {v3 .. v3}, Ljava/math/BigInteger;->bitLength()I
