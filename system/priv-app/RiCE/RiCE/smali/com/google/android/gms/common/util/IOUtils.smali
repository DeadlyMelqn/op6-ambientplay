...
.method public static closeQuietly(Ljava/net/ServerSocket;)V
    ...
    :try_start_0
    invoke-virtual/range {p0 .. p0}, Ljava/net/ServerSocket;->close()V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static copyStream(Ljava/io/InputStream;Ljava/io/OutputStream;ZI)J
    ...
    invoke-static/range {p0 .. p0}, Lcom/google/android/gms/common/util/IOUtils;->closeQuietly(Ljava/io/Closeable;)V

    invoke-static/range {p1 .. p1}, Lcom/google/android/gms/common/util/IOUtils;->closeQuietly(Ljava/io/Closeable;)V
...
.method public static lockAndTruncateFile(Ljava/io/File;)V
    ...
    :try_start_1
    invoke-virtual/range {v1 .. v1}, Ljava/io/RandomAccessFile;->getChannel()Ljava/nio/channels/FileChannel;

    move-result-object p0

    invoke-virtual/range {p0 .. p0}, Ljava/nio/channels/FileChannel;->lock()Ljava/nio/channels/FileLock;
    ...
    invoke-virtual/range {v2 .. v2}, Ljava/nio/channels/FileLock;->isValid()Z
    ...
    :try_start_3
    invoke-virtual/range {v2 .. v2}, Ljava/nio/channels/FileLock;->release()V
    :try_end_3
    ...
    invoke-direct/range {p0 .. p0}, Ljava/io/FileNotFoundException;-><init>()V
...
.method public static toByteArray(Ljava/io/File;)[B
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/common/util/IOUtils$zzb;->zzdd()[B
...
.method private static zza(Ljava/io/InputStream;J)[B
    ...
    invoke-static/range {p0 .. p0}, Lcom/google/android/gms/common/util/IOUtils;->toByteArray(Ljava/io/InputStream;)[B
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/common/util/IOUtils$zza;->size()I
...
.method static synthetic zzb(Ljava/io/InputStream;J)[B
    ...
    invoke-static/range {p0 .. p2}, Lcom/google/android/gms/common/util/IOUtils;->zza(Ljava/io/InputStream;J)[B
