...
.method private static zza(Landroid/util/Range;)[Ljava/lang/Integer;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/util/Range;->getLower()Ljava/lang/Comparable;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/util/Range;->getUpper()Ljava/lang/Comparable;
...
.method public static zzdd(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/media/MediaCodecList;->getCodecInfos()[Landroid/media/MediaCodecInfo;
    ...
    invoke-static/range {v5 .. v5}, Landroid/media/MediaCodecList;->getCodecInfoAt(I)Landroid/media/MediaCodecInfo;
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/media/MediaCodecInfo;->isEncoder()Z

    move-result v6

    if-nez v6, :cond_5

    invoke-virtual/range {v5 .. v5}, Landroid/media/MediaCodecInfo;->getSupportedTypes()[Ljava/lang/String;
    ...
    invoke-direct/range {v6 .. v6}, Ljava/util/HashMap;-><init>()V

    const-string v7, "codecName"

    invoke-virtual/range {v5 .. v5}, Landroid/media/MediaCodecInfo;->getName()Ljava/lang/String;
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/media/MediaCodecInfo$CodecCapabilities;->getVideoCapabilities()Landroid/media/MediaCodecInfo$VideoCapabilities;

    move-result-object v7

    const-string v8, "bitRatesBps"

    invoke-virtual/range {v7 .. v7}, Landroid/media/MediaCodecInfo$VideoCapabilities;->getBitrateRange()Landroid/util/Range;

    move-result-object v9

    invoke-static/range {v9 .. v9}, Lcom/google/android/gms/internal/ads/zzams;->zza(Landroid/util/Range;)[Ljava/lang/Integer;
    ...
    invoke-virtual/range {v7 .. v7}, Landroid/media/MediaCodecInfo$VideoCapabilities;->getWidthAlignment()I
    ...
    invoke-virtual/range {v7 .. v7}, Landroid/media/MediaCodecInfo$VideoCapabilities;->getHeightAlignment()I
    ...
    invoke-virtual/range {v7 .. v7}, Landroid/media/MediaCodecInfo$VideoCapabilities;->getSupportedFrameRates()Landroid/util/Range;
    ...
    invoke-virtual/range {v7 .. v7}, Landroid/media/MediaCodecInfo$VideoCapabilities;->getSupportedWidths()Landroid/util/Range;
    ...
    invoke-virtual/range {v7 .. v7}, Landroid/media/MediaCodecInfo$VideoCapabilities;->getSupportedHeights()Landroid/util/Range;

    move-result-object v7

    invoke-static/range {v7 .. v7}, Lcom/google/android/gms/internal/ads/zzams;->zza(Landroid/util/Range;)[Ljava/lang/Integer;
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/media/MediaCodecInfo$CodecCapabilities;->getMaxSupportedInstances()I
