...
.method private final zza(Ljava/io/InputStream;I)[B
    ...
    :cond_0
    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/internal/ads/zzau;->toByteArray()[B
    ...
    :cond_1
    :goto_1
    iget-object p0, p0, Lcom/google/android/gms/internal/ads/zzaj;->zzbq:Lcom/google/android/gms/internal/ads/zzak;

    invoke-virtual {p0, v2}, Lcom/google/android/gms/internal/ads/zzak;->zza([B)V

    invoke-virtual/range {v0 .. v0}, Lcom/google/android/gms/internal/ads/zzau;->close()V
    ...
    invoke-direct/range {v2 .. v2}, Lcom/google/android/gms/internal/ads/zzac;-><init>()V
    ...
    invoke-virtual {p0, v1}, Lcom/google/android/gms/internal/ads/zzak;->zza([B)V
...
.method public zzc(Lcom/google/android/gms/internal/ads/zzr;)Lcom/google/android/gms/internal/ads/zzp;
    ...
    invoke-direct/range {v10 .. v10}, Ljava/util/HashMap;-><init>()V
    ...
    invoke-static/range {v12 .. v13}, Lcom/google/android/gms/internal/ads/zzap;->zzb(J)Ljava/lang/String;
    ...
    :try_start_1
    invoke-virtual/range {v10 .. v10}, Lcom/google/android/gms/internal/ads/zzaq;->getStatusCode()I

    move-result v12

    invoke-virtual/range {v10 .. v10}, Lcom/google/android/gms/internal/ads/zzaq;->zzq()Ljava/util/List;
    ...
    invoke-interface/range {v11 .. v11}, Ljava/util/List;->isEmpty()Z

    move-result v12

    if-nez v12, :cond_4

    invoke-interface/range {v11 .. v11}, Ljava/util/List;->iterator()Ljava/util/Iterator;
    ...
    invoke-virtual/range {v13 .. v13}, Lcom/google/android/gms/internal/ads/zzl;->getName()Ljava/lang/String;
    ...
    invoke-interface/range {v13 .. v13}, Ljava/util/List;->isEmpty()Z
    ...
    invoke-interface/range {v13 .. v13}, Ljava/util/List;->iterator()Ljava/util/Iterator;
    ...
    invoke-virtual/range {v14 .. v14}, Lcom/google/android/gms/internal/ads/zzl;->getName()Ljava/lang/String;
    ...
    invoke-interface/range {v13 .. v13}, Ljava/util/Map;->isEmpty()Z
    ...
    invoke-interface/range {v13 .. v13}, Ljava/util/Set;->iterator()Ljava/util/Iterator;
    ...
    invoke-interface/range {v14 .. v14}, Ljava/util/Map$Entry;->getKey()Ljava/lang/Object;
    ...
    invoke-interface/range {v14 .. v14}, Ljava/util/Map$Entry;->getValue()Ljava/lang/Object;
    ...
    :cond_9
    :try_start_3
    invoke-virtual/range {v10 .. v10}, Lcom/google/android/gms/internal/ads/zzaq;->getContent()Ljava/io/InputStream;
    ...
    :try_start_4
    invoke-virtual/range {v10 .. v10}, Lcom/google/android/gms/internal/ads/zzaq;->getContentLength()I
    ...
    invoke-interface/range {v14 .. v14}, Lcom/google/android/gms/internal/ads/zzab;->zzd()I
    ...
    invoke-direct/range {v0 .. v0}, Ljava/io/IOException;-><init>()V
    ...
    invoke-direct/range {v5 .. v5}, Lcom/google/android/gms/internal/ads/zzo;-><init>()V
    ...
    invoke-direct {v1, v0}, Lcom/google/android/gms/internal/ads/zzq;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-direct/range {v5 .. v5}, Lcom/google/android/gms/internal/ads/zzad;-><init>()V
