...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Lcom/google/android/gms/stats/zza;-><init>()V
...
.method public constructor <init>(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static/range {p1 .. p1}, Lcom/google/android/gms/common/util/WorkSourceUtil;->hasWorkSourcePermission(Landroid/content/Context;)Z

    move-result p2

    if-eqz p2, :cond_4

    invoke-static/range {p5 .. p5}, Lcom/google/android/gms/common/util/Strings;->isEmptyOrWhitespace(Ljava/lang/String;)Z
    ...
    invoke-interface/range {p2 .. p2}, Lcom/google/android/gms/stats/WakeLock$Configuration;->isWorkChainsEnabled()Z
    ...
    :cond_4
    sget-object p0, Lcom/google/android/gms/stats/WakeLock;->zzaeg:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-interface/range {p0 .. p0}, Lcom/google/android/gms/common/providers/PooledExecutorsProvider$PooledExecutorFactory;->newSingleThreadScheduledExecutor()Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object p0

    sput-object p0, Lcom/google/android/gms/stats/WakeLock;->zzaeg:Ljava/util/concurrent/ScheduledExecutorService;
...
.method private final zza(Landroid/os/WorkSource;)V
    ...
    :try_start_0
    iget-object p0, p0, Lcom/google/android/gms/stats/WakeLock;->zzadv:Landroid/os/PowerManager$WakeLock;
    ...
    invoke-virtual/range {p0 .. p0}, Ljava/lang/RuntimeException;->toString()Ljava/lang/String;
...
.method static synthetic zza(Lcom/google/android/gms/stats/WakeLock;Ljava/lang/String;I)V
    ...
    invoke-direct/range {p0 .. p2}, Lcom/google/android/gms/stats/WakeLock;->zzc(Ljava/lang/String;I)V
...
.method private final zza(Ljava/lang/String;J)V
    ...
    invoke-direct/range {p0 .. p1}, Lcom/google/android/gms/stats/WakeLock;->zzn(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/os/PowerManager$WakeLock;->isHeld()Z
    ...
    invoke-direct/range {p0 .. p0}, Lcom/google/android/gms/stats/WakeLock;->zzdo()Ljava/util/List;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/os/PowerManager$WakeLock;->acquire()V
    ...
    iget-object p0, p0, Lcom/google/android/gms/stats/WakeLock;->zzadz:Ljava/lang/String;
...
.method private final zzdo()Ljava/util/List;
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/android/gms/common/util/WorkSourceUtil;->getNames(Landroid/os/WorkSource;)Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/google/android/gms/stats/WakeLock;->zzadx:Ljava/lang/String;
...
.method private final zzn(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    iget-object p0, p0, Lcom/google/android/gms/stats/WakeLock;->zzaea:Ljava/lang/String;
...
.method private final zzn(I)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/os/PowerManager$WakeLock;->isHeld()Z
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/os/PowerManager$WakeLock;->release()V
    :try_end_0
...
.method public acquire(Ljava/lang/String;J)V
    ...
    invoke-direct/range {p0 .. p3}, Lcom/google/android/gms/stats/WakeLock;->zza(Ljava/lang/String;J)V
...
.method public acquireLock(JLjava/lang/String;)Lcom/google/android/gms/stats/WakeLock$HeldLock;
    ...
    sget-object p3, Lcom/google/android/gms/stats/WakeLock;->zzaeg:Ljava/util/concurrent/ScheduledExecutorService;

    new-instance v1, Lcom/google/android/gms/stats/zzc;

    invoke-direct {v1, p0}, Lcom/google/android/gms/stats/zzc;-><init>(Ljava/lang/ref/WeakReference;)V

    sget-object p0, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-interface {p3, v1, p1, p2, p0}, Ljava/util/concurrent/ScheduledExecutorService;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;

    move-result-object p0

    invoke-static {v0, p0}, Lcom/google/android/gms/stats/WakeLock$HeldLock;->zza(Lcom/google/android/gms/stats/WakeLock$HeldLock;Ljava/util/concurrent/Future;)Ljava/util/concurrent/Future;
...
.method public addWorkSource(Landroid/os/WorkSource;)V
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/android/gms/common/util/WorkSourceUtil;->hasWorkSourcePermission(Landroid/content/Context;)Z
...
.method public isHeld()Z
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/os/PowerManager$WakeLock;->isHeld()Z
...
.method public release(Ljava/lang/String;I)V
    ...
    invoke-direct/range {p0 .. p2}, Lcom/google/android/gms/stats/WakeLock;->zzb(Ljava/lang/String;I)V
...
.method public removeWorkSource(Landroid/os/WorkSource;)V
    ...
    invoke-virtual/range {p0 .. p0}, Ljava/lang/ArrayIndexOutOfBoundsException;->toString()Ljava/lang/String;
...
.method public setWorkSource(Landroid/os/WorkSource;)V
    ...
    invoke-direct/range {p0 .. p1}, Lcom/google/android/gms/stats/WakeLock;->zza(Landroid/os/WorkSource;)V
