...
.method public static addErrorToDropBoxInternal(Landroid/content/Context;Ljava/lang/Throwable;I)Z
    ...
    invoke-static/range {p1 .. p1}, Lcom/google/android/gms/common/util/CrashUtils;->zza(Ljava/lang/Throwable;)Ljava/lang/Throwable;
...
.method private static declared-synchronized zza(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static/range {p2 .. p2}, Lcom/google/android/gms/common/util/Strings;->nullToEmpty(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Ljava/lang/ProcessBuilder;->start()Ljava/lang/Process;
    ...
    :try_start_5
    invoke-virtual/range {p0 .. p0}, Ljava/lang/Process;->getOutputStream()Ljava/io/OutputStream;
    ...
    :cond_a
    :try_start_9
    invoke-virtual/range {p2 .. p2}, Ljava/io/InputStreamReader;->close()V
    :try_end_9
    ...
    :try_start_b
    invoke-virtual/range {p1 .. p1}, Ljava/io/InputStreamReader;->close()V
    :try_end_b
...
.method private static declared-synchronized zza(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    ...
    :goto_1
    invoke-virtual/range {v1 .. v1}, Ljava/util/LinkedList;->isEmpty()Z

    move-result v5

    if-nez v5, :cond_5

    invoke-virtual/range {v1 .. v1}, Ljava/util/LinkedList;->pop()Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Ljava/lang/Throwable;

    invoke-virtual/range {v5 .. v5}, Ljava/lang/Throwable;->getStackTrace()[Ljava/lang/StackTraceElement;
    ...
    invoke-virtual/range {v9 .. v9}, Ljava/lang/StackTraceElement;->getFileName()Ljava/lang/String;
    ...
    invoke-static/range {v10 .. v10}, Lcom/google/android/gms/common/util/CrashUtils;->isSystemClassPrefixInternal(Ljava/lang/String;)Z
...
.method private static declared-synchronized zza(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Throwable;)Z
    ...
    invoke-static/range {p1 .. p1}, Lcom/google/android/gms/common/util/Strings;->isEmptyOrWhitespace(Ljava/lang/String;)Z
    ...
    :cond_4
    invoke-static/range {p0 .. p3}, Lcom/google/android/gms/common/util/CrashUtils;->zza(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
