...
.method final zzb(Landroid/net/http/SslError;)V
    ...
    :cond_0
    invoke-virtual/range {p1 .. p1}, Landroid/net/http/SslError;->getPrimaryError()I

    move-result p0

    if-ltz p0, :cond_1

    sget-object v0, Lcom/google/android/gms/internal/ads/zzatc;->zzdbp:[Ljava/lang/String;
    ...
    :goto_0
    const-string v0, "ssl_err"

    invoke-virtual/range {p1 .. p1}, Landroid/net/http/SslError;->getUrl()Ljava/lang/String;

    move-result-object p1

    invoke-static {v0, p0, p1}, Lcom/google/android/gms/internal/ads/zzatc;->zzd(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method final zze(ILjava/lang/String;)V
    ...
    :goto_0
    const-string p1, "http_err"

    invoke-static {p1, p0, p2}, Lcom/google/android/gms/internal/ads/zzatc;->zzd(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
