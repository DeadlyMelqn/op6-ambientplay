...
.method public static createBigDecimal(Landroid/os/Parcel;I)Ljava/math/BigDecimal;
    ...
    invoke-static/range {p0 .. p1}, Lcom/google/android/gms/common/internal/safeparcel/SafeParcelReader;->readSize(Landroid/os/Parcel;I)I
...
.method public static createBooleanArray(Landroid/os/Parcel;I)[Z
    ...
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/os/Parcel;->createBooleanArray()[Z
...
.method public static createCharArray(Landroid/os/Parcel;I)[C
    ...
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/os/Parcel;->createCharArray()[C
...
.method public static createDoubleArray(Landroid/os/Parcel;I)[D
    ...
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/os/Parcel;->createDoubleArray()[D
...
.method public static createFloatArray(Landroid/os/Parcel;I)[F
    ...
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/os/Parcel;->createFloatArray()[F
...
.method public static createIBinderArray(Landroid/os/Parcel;I)[Landroid/os/IBinder;
    ...
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/os/Parcel;->createBinderArray()[Landroid/os/IBinder;
...
.method public static createIBinderList(Landroid/os/Parcel;I)Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/os/Parcel;->createBinderArrayList()Ljava/util/ArrayList;
...
.method public static createLongArray(Landroid/os/Parcel;I)[J
    ...
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/os/Parcel;->createLongArray()[J
...
.method public static createParcelSparseArray(Landroid/os/Parcel;I)Landroid/util/SparseArray;
    ...
    invoke-direct/range {v3 .. v3}, Landroid/util/SparseArray;-><init>()V
...
.method public static createSparseBooleanArray(Landroid/os/Parcel;I)Landroid/util/SparseBooleanArray;
    ...
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/os/Parcel;->readSparseBooleanArray()Landroid/util/SparseBooleanArray;
...
.method public static createSparseLongArray(Landroid/os/Parcel;I)Landroid/util/SparseLongArray;
    ...
    invoke-direct/range {v1 .. v1}, Landroid/util/SparseLongArray;-><init>()V
...
.method public static createStringArray(Landroid/os/Parcel;I)[Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/os/Parcel;->createStringArray()[Ljava/lang/String;
