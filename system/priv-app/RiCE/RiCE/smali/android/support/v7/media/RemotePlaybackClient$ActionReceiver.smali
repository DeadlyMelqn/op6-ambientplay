...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 888
    invoke-static/range {p1 .. p1}, Landroid/support/v7/media/MediaSessionStatus;->fromBundle(Landroid/os/Bundle;)Landroid/support/v7/media/MediaSessionStatus;
    ...
    const-string p1, "Discarding spurious status callback with missing item id."
    ...
    .line 898
    invoke-static/range {p1 .. p1}, Landroid/support/v7/media/MediaItemStatus;->fromBundle(Landroid/os/Bundle;)Landroid/support/v7/media/MediaItemStatus;
    ...
    const-string p1, "Discarding spurious status callback with missing item status."
    ...
    .line 913
    iget-object p0, p0, Landroid/support/v7/media/RemotePlaybackClient$ActionReceiver;->this$0:Landroid/support/v7/media/RemotePlaybackClient;
    ...
    const-string p1, "Discarding spurious media status callback with missing session status."
    ...
    invoke-virtual {p0, p1, v2, v3}, Landroid/support/v7/media/RemotePlaybackClient$StatusCallback;->onSessionStatusChanged(Landroid/os/Bundle;Ljava/lang/String;Landroid/support/v7/media/MediaSessionStatus;)V
    ...
    .line 938
    invoke-interface {p0, v2, p1}, Landroid/support/v7/media/RemotePlaybackClient$OnMessageReceivedListener;->onMessageReceived(Ljava/lang/String;Landroid/os/Bundle;)V
