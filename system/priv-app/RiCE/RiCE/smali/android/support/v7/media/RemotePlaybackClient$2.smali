...
.method constructor <init>(Landroid/support/v7/media/RemotePlaybackClient;Ljava/lang/String;Landroid/content/Intent;Landroid/support/v7/media/RemotePlaybackClient$SessionActionCallback;)V
    ...
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/media/MediaRouter$ControlRequestCallback;-><init>()V
...
.method public onError(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    iget-object p0, p0, Landroid/support/v7/media/RemotePlaybackClient$2;->val$callback:Landroid/support/v7/media/RemotePlaybackClient$SessionActionCallback;

    invoke-virtual {v0, v1, p0, p1, p2}, Landroid/support/v7/media/RemotePlaybackClient;->handleError(Landroid/content/Intent;Landroid/support/v7/media/RemotePlaybackClient$ActionCallback;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public onResult(Landroid/os/Bundle;)V
    ...
    .line 718
    invoke-static/range {v1 .. v1}, Landroid/support/v7/media/MediaSessionStatus;->fromBundle(Landroid/os/Bundle;)Landroid/support/v7/media/MediaSessionStatus;
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/content/Intent;->getAction()Ljava/lang/String;
    ...
    .line 724
    invoke-static/range {p1 .. p1}, Landroid/support/v7/media/RemotePlaybackClient;->bundleToString(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    .line 733
    iget-object p0, p0, Landroid/support/v7/media/RemotePlaybackClient$2;->this$0:Landroid/support/v7/media/RemotePlaybackClient;

    invoke-virtual {p0, v2}, Landroid/support/v7/media/RemotePlaybackClient;->setSessionId(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p0, p1}, Landroid/support/v7/media/RemotePlaybackClient;->handleInvalidResult(Landroid/content/Intent;Landroid/support/v7/media/RemotePlaybackClient$ActionCallback;Landroid/os/Bundle;)V
