...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/graphics/Palette$1;-><init>()V
...
.method constructor <init>(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-direct/range {p1 .. p1}, Landroid/support/v4/util/ArrayMap;-><init>()V

    iput-object p1, p0, Landroid/support/v7/graphics/Palette;->mSelectedSwatches:Ljava/util/Map;

    .line 162
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/graphics/Palette;->findDominantSwatch()Landroid/support/v7/graphics/Palette$Swatch;
...
.method private static copyHslValues(Landroid/support/v7/graphics/Palette$Swatch;)[F
    ...
    .line 435
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/graphics/Palette$Swatch;->getHsl()[F
...
.method private findDominantSwatch()Landroid/support/v7/graphics/Palette$Swatch;
    ...
    .line 425
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/graphics/Palette$Swatch;->getPopulation()I
...
.method public static from(Ljava/util/List;)Landroid/support/v7/graphics/Palette;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/graphics/Palette$Builder;->generate()Landroid/support/v7/graphics/Palette;
...
.method public static generate(Landroid/graphics/Bitmap;)Landroid/support/v7/graphics/Palette;
    ...
    .line 118
    invoke-static/range {p0 .. p0}, Landroid/support/v7/graphics/Palette;->from(Landroid/graphics/Bitmap;)Landroid/support/v7/graphics/Palette$Builder;
...
.method private generateScore(Landroid/support/v7/graphics/Palette$Swatch;Landroid/support/v7/graphics/Target;)F
    ...
    .line 396
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/graphics/Palette$Swatch;->getHsl()[F
    ...
    iget-object p0, p0, Landroid/support/v7/graphics/Palette;->mDominantSwatch:Landroid/support/v7/graphics/Palette$Swatch;

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/graphics/Palette$Swatch;->getPopulation()I
    ...
    .line 404
    :goto_0
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/graphics/Target;->getSaturationWeight()F
    ...
    .line 406
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/graphics/Target;->getTargetSaturation()F
    ...
    .line 408
    :goto_1
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/graphics/Target;->getLightnessWeight()F
    ...
    .line 410
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/graphics/Target;->getTargetLightness()F
    ...
    .line 412
    :goto_2
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/graphics/Target;->getPopulationWeight()F
    ...
    .line 414
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/graphics/Palette$Swatch;->getPopulation()I
...
.method private generateScoredTarget(Landroid/support/v7/graphics/Target;)Landroid/support/v7/graphics/Palette$Swatch;
    ...
    .line 362
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/graphics/Palette;->getMaxScoredSwatchForTarget(Landroid/support/v7/graphics/Target;)Landroid/support/v7/graphics/Palette$Swatch;
    ...
    .line 363
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/graphics/Target;->isExclusive()Z
    ...
    .line 365
    iget-object p0, p0, Landroid/support/v7/graphics/Palette;->mUsedColors:Landroid/util/SparseBooleanArray;

    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/graphics/Palette$Swatch;->getRgb()I
...
.method private shouldBeScoredForTarget(Landroid/support/v7/graphics/Palette$Swatch;Landroid/support/v7/graphics/Target;)Z
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/graphics/Target;->getMinimumSaturation()F
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/graphics/Target;->getMaximumSaturation()F
    ...
    .line 391
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/graphics/Target;->getMinimumLightness()F
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/graphics/Target;->getMaximumLightness()F
    ...
    .line 392
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/graphics/Palette$Swatch;->getRgb()I
...
.method generate()V
    ...
    .line 354
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/graphics/Target;->normalizeWeights()V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/util/SparseBooleanArray;->clear()V
...
.method public getColorForTarget(Landroid/support/v7/graphics/Target;I)I
    ...
    .line 323
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/graphics/Palette;->getSwatchForTarget(Landroid/support/v7/graphics/Target;)Landroid/support/v7/graphics/Palette$Swatch;
    ...
    .line 324
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/graphics/Palette$Swatch;->getRgb()I
...
.method public getSwatchForTarget(Landroid/support/v7/graphics/Target;)Landroid/support/v7/graphics/Palette$Swatch;
    ...
    .line 313
    iget-object p0, p0, Landroid/support/v7/graphics/Palette;->mSelectedSwatches:Ljava/util/Map;
...
.method public getSwatches()Ljava/util/List;
    ...
    .line 170
    iget-object p0, p0, Landroid/support/v7/graphics/Palette;->mSwatches:Ljava/util/List;
...
.method public getTargets()Ljava/util/List;
    ...
    .line 178
    iget-object p0, p0, Landroid/support/v7/graphics/Palette;->mTargets:Ljava/util/List;
