...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/media/MediaRouter$RouteInfo;)V
    ...
    invoke-direct/range {p2 .. p2}, Landroid/content/IntentFilter;-><init>()V
    ...
    .line 93
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/media/RemotePlaybackClient;->detectFeatures()V
...
.method static bundleToString(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    .line 862
    invoke-virtual/range {p0 .. p0}, Landroid/os/Bundle;->size()I
...
.method private detectFeatures()V
    ...
    .line 794
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/media/RemotePlaybackClient;->doesRouteSupportMessaging()Z
...
.method private doesRouteSupportMessaging()Z
    ...
    .line 802
    iget-object p0, p0, Landroid/support/v7/media/RemotePlaybackClient;->mRoute:Landroid/support/v7/media/MediaRouter$RouteInfo;

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getControlFilters()Ljava/util/List;
...
.method private performItemAction(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v7/media/RemotePlaybackClient$ItemActionCallback;)V
    ...
    .line 664
    :cond_2
    invoke-static/range {p1 .. p1}, Landroid/support/v7/media/RemotePlaybackClient;->logRequest(Landroid/content/Intent;)V
...
.method private playOrEnqueue(Landroid/net/Uri;Ljava/lang/String;Landroid/os/Bundle;JLandroid/os/Bundle;Landroid/support/v7/media/RemotePlaybackClient$ItemActionCallback;Ljava/lang/String;)V
    ...
    .line 332
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/media/RemotePlaybackClient;->throwIfRemotePlaybackNotSupported()V
    ...
    .line 334
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/media/RemotePlaybackClient;->throwIfQueuingNotSupported()V
    ...
    .line 347
    :cond_2
    iget-object p2, p0, Landroid/support/v7/media/RemotePlaybackClient;->mSessionId:Ljava/lang/String;
    ...
    invoke-direct/range {p0 .. p5}, Landroid/support/v7/media/RemotePlaybackClient;->performItemAction(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v7/media/RemotePlaybackClient$ItemActionCallback;)V
...
.method private routeSupportsAction(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v0, p1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->supportsControlAction(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private throwIfMessageNotSupported()V
    ...
    .line 830
    iget-boolean p0, p0, Landroid/support/v7/media/RemotePlaybackClient;->mRouteSupportsMessaging:Z
...
.method private throwIfQueuingNotSupported()V
    ...
    .line 817
    iget-boolean p0, p0, Landroid/support/v7/media/RemotePlaybackClient;->mRouteSupportsQueuing:Z
...
.method private throwIfRemotePlaybackNotSupported()V
    ...
    .line 811
    iget-boolean p0, p0, Landroid/support/v7/media/RemotePlaybackClient;->mRouteSupportsRemotePlayback:Z
...
.method private throwIfSessionManagementNotSupported()V
    ...
    .line 823
    iget-boolean p0, p0, Landroid/support/v7/media/RemotePlaybackClient;->mRouteSupportsSessionManagement:Z
...
.method adoptSession(Ljava/lang/String;)V
    ...
    .line 751
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/media/RemotePlaybackClient;->setSessionId(Ljava/lang/String;)V
...
.method public endSession(Landroid/os/Bundle;Landroid/support/v7/media/RemotePlaybackClient$SessionActionCallback;)V
    ...
    .line 644
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/media/RemotePlaybackClient;->throwIfSessionManagementNotSupported()V

    .line 645
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/media/RemotePlaybackClient;->throwIfNoCurrentSession()V
...
.method handleError(Landroid/content/Intent;Landroid/support/v7/media/RemotePlaybackClient$ActionCallback;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 775
    invoke-static/range {p4 .. p4}, Landroid/support/v7/media/RemotePlaybackClient;->bundleToString(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    .line 777
    :cond_1
    invoke-virtual {p2, p3, p0, p4}, Landroid/support/v7/media/RemotePlaybackClient$ActionCallback;->onError(Ljava/lang/String;ILandroid/os/Bundle;)V
...
.method handleInvalidResult(Landroid/content/Intent;Landroid/support/v7/media/RemotePlaybackClient$ActionCallback;Landroid/os/Bundle;)V
    ...
    const-string p0, "RemotePlaybackClient"
    ...
    .line 758
    invoke-static/range {p3 .. p3}, Landroid/support/v7/media/RemotePlaybackClient;->bundleToString(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    .line 759
    invoke-virtual {p2, p0, p1, p3}, Landroid/support/v7/media/RemotePlaybackClient$ActionCallback;->onError(Ljava/lang/String;ILandroid/os/Bundle;)V
...
.method public release()V
    ...
    iget-object p0, p0, Landroid/support/v7/media/RemotePlaybackClient;->mActionReceiver:Landroid/support/v7/media/RemotePlaybackClient$ActionReceiver;
...
.method public sendMessage(Landroid/os/Bundle;Landroid/support/v7/media/RemotePlaybackClient$SessionActionCallback;)V
    ...
    .line 585
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/media/RemotePlaybackClient;->throwIfMessageNotSupported()V
...
.method public setSessionId(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/media/RemotePlaybackClient$StatusCallback;->onSessionChanged(Ljava/lang/String;)V
