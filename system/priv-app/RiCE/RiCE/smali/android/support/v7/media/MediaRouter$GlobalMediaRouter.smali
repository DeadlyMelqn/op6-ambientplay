...
.method constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/media/RemoteControlClientCompat$PlaybackInfo;-><init>()V
    ...
    .line 1976
    invoke-static/range {p1 .. p1}, Landroid/support/v4/hardware/display/DisplayManagerCompat;->getInstance(Landroid/content/Context;)Landroid/support/v4/hardware/display/DisplayManagerCompat;
    ...
    .line 1977
    invoke-static/range {v0 .. v0}, Landroid/support/v4/app/ActivityManagerCompat;->isLowRamDevice(Landroid/app/ActivityManager;)Z
...
.method static synthetic access$000(Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;Landroid/support/v7/media/MediaRouter$ProviderInfo;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1930
    invoke-direct/range {p0 .. p2}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->getUniqueId(Landroid/support/v7/media/MediaRouter$ProviderInfo;Ljava/lang/String;)Ljava/lang/String;
...
.method static synthetic access$700(Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;Z)V
    ...
    .line 1930
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->updateSelectedRouteIfNeeded(Z)V
...
.method private assignRouteUniqueId(Landroid/support/v7/media/MediaRouter$ProviderInfo;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 2423
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouter$ProviderInfo;->getComponentName()Landroid/content/ComponentName;
    ...
    .line 2426
    iget-object p0, p0, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->mUniqueIdMap:Ljava/util/Map;
...
.method private findProviderInfo(Landroid/support/v7/media/MediaRouteProvider;)I
    ...
    invoke-static/range {v2 .. v2}, Landroid/support/v7/media/MediaRouter$ProviderInfo;->access$500(Landroid/support/v7/media/MediaRouter$ProviderInfo;)Landroid/support/v7/media/MediaRouteProvider;
...
.method private findRemoteControlClientRecord(Ljava/lang/Object;)I
    ...
    .line 2708
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter$RemoteControlClientRecord;->getRemoteControlClient()Ljava/lang/Object;
...
.method private findRouteByUniqueId(Ljava/lang/String;)I
    ...
    invoke-static/range {v2 .. v2}, Landroid/support/v7/media/MediaRouter$RouteInfo;->access$300(Landroid/support/v7/media/MediaRouter$RouteInfo;)Ljava/lang/String;
...
.method private isSystemDefaultRoute(Landroid/support/v7/media/MediaRouter$RouteInfo;)Z
    ...
    .line 2554
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getProviderInstance()Landroid/support/v7/media/MediaRouteProvider;
    ...
    .line 2555
    invoke-static/range {p1 .. p1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->access$100(Landroid/support/v7/media/MediaRouter$RouteInfo;)Ljava/lang/String;
...
.method private isSystemLiveAudioOnlyRoute(Landroid/support/v7/media/MediaRouter$RouteInfo;)Z
    ...
    .line 2549
    invoke-virtual {p1, p0}, Landroid/support/v7/media/MediaRouter$RouteInfo;->supportsControlCategory(Ljava/lang/String;)Z
...
.method private setMediaSessionRecord(Landroid/support/v7/media/MediaRouter$GlobalMediaRouter$MediaSessionRecord;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter$MediaSessionRecord;->clearVolumeHandling()V
    ...
    .line 2691
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->updatePlaybackInfoFromSelectedRoute()V
...
.method private setSelectedRouteInternal(Landroid/support/v7/media/MediaRouter$RouteInfo;I)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->isDefault()Z
    ...
    .line 2567
    invoke-virtual/range {v3 .. v3}, Ljava/lang/StackTraceElement;->getClassName()Ljava/lang/String;
    ...
    .line 2569
    invoke-virtual/range {v3 .. v3}, Ljava/lang/StackTraceElement;->getMethodName()Ljava/lang/String;
    ...
    .line 2571
    invoke-virtual/range {v3 .. v3}, Ljava/lang/StackTraceElement;->getLineNumber()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouteProvider$RouteController;->onRelease()V
    ...
    .line 2599
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/media/MediaRouteProvider$RouteController;->onRelease()V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouteProvider$RouteController;->onSelect()V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouter$RouteGroup;->getRoutes()Ljava/util/List;
    ...
    .line 2621
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getProviderInstance()Landroid/support/v7/media/MediaRouteProvider;

    move-result-object v0

    .line 2622
    invoke-static/range {p2 .. p2}, Landroid/support/v7/media/MediaRouter$RouteInfo;->access$100(Landroid/support/v7/media/MediaRouter$RouteInfo;)Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->mSelectedRoute:Landroid/support/v7/media/MediaRouter$RouteInfo;

    invoke-static/range {v2 .. v2}, Landroid/support/v7/media/MediaRouter$RouteInfo;->access$100(Landroid/support/v7/media/MediaRouter$RouteInfo;)Ljava/lang/String;
    ...
    .line 2623
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouteProvider$RouteController;->onSelect()V
...
.method private updatePlaybackInfoFromSelectedRoute()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getVolume()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getVolumeMax()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getVolumeHandling()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getPlaybackStream()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getPlaybackType()I
    ...
    .line 2726
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter$RemoteControlClientRecord;->updatePlaybackInfo()V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->getDefaultRoute()Landroid/support/v7/media/MediaRouter$RouteInfo;
    ...
    .line 2730
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->getBluetoothRoute()Landroid/support/v7/media/MediaRouter$RouteInfo;
    ...
    iget p0, p0, Landroid/support/v7/media/RemoteControlClientCompat$PlaybackInfo;->volume:I

    invoke-virtual {v0, v1, v2, p0}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter$MediaSessionRecord;->configureVolume(III)V
    ...
    :cond_3
    :goto_1
    iget-object p0, p0, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->mMediaSession:Landroid/support/v7/media/MediaRouter$GlobalMediaRouter$MediaSessionRecord;

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter$MediaSessionRecord;->clearVolumeHandling()V
...
.method private updateProviderContents(Landroid/support/v7/media/MediaRouter$ProviderInfo;Landroid/support/v7/media/MediaRouteProviderDescriptor;)V
    ...
    .line 2290
    invoke-virtual/range {v12 .. v12}, Landroid/support/v7/media/MediaRouteDescriptor;->getId()Ljava/lang/String;
    ...
    .line 2295
    invoke-virtual/range {v12 .. v12}, Landroid/support/v7/media/MediaRouteDescriptor;->getGroupMemberIds()Ljava/util/List;
...
.method private updateRouteDescriptorAndNotify(Landroid/support/v7/media/MediaRouter$RouteInfo;Landroid/support/v7/media/MediaRouteDescriptor;)I
    ...
    .line 2391
    invoke-virtual/range {p1 .. p2}, Landroid/support/v7/media/MediaRouter$RouteInfo;->maybeUpdateDescriptor(Landroid/support/v7/media/MediaRouteDescriptor;)I
    ...
    invoke-virtual {p0, v0, p1}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter$CallbackHandler;->post(ILjava/lang/Object;)V
...
.method private updateSelectedRouteIfNeeded(Z)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouter$RouteInfo;->isSelectable()Z
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/media/MediaRouter$RouteInfo;->isSelectable()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->isSelectable()Z
    ...
    .line 2511
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/media/MediaRouteProvider$RouteController;->onUnselect()V

    .line 2512
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/media/MediaRouteProvider$RouteController;->onRelease()V
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v7/media/MediaRouter$RouteInfo;->access$100(Landroid/support/v7/media/MediaRouter$RouteInfo;)Ljava/lang/String;
    ...
    .line 2519
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getProviderInstance()Landroid/support/v7/media/MediaRouteProvider;
    ...
    invoke-static/range {v3 .. v3}, Landroid/support/v7/media/MediaRouter$RouteInfo;->access$100(Landroid/support/v7/media/MediaRouter$RouteInfo;)Ljava/lang/String;
    ...
    .line 2522
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/media/MediaRouteProvider$RouteController;->onSelect()V
    ...
    .line 2492
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->chooseFallbackRoute()Landroid/support/v7/media/MediaRouter$RouteInfo;
...
.method public addProvider(Landroid/support/v7/media/MediaRouteProvider;)V
    ...
    .line 2213
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->findProviderInfo(Landroid/support/v7/media/MediaRouteProvider;)I
    ...
    .line 2223
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouteProvider;->getDescriptor()Landroid/support/v7/media/MediaRouteProviderDescriptor;
    ...
    .line 2227
    iget-object p0, p0, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->mDiscoveryRequest:Landroid/support/v7/media/MediaRouteDiscoveryRequest;

    invoke-virtual {p1, p0}, Landroid/support/v7/media/MediaRouteProvider;->setDiscoveryRequest(Landroid/support/v7/media/MediaRouteDiscoveryRequest;)V
...
.method public addRemoteControlClient(Ljava/lang/Object;)V
    ...
    .line 2647
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->findRemoteControlClientRecord(Ljava/lang/Object;)I
    ...
    .line 2650
    iget-object p0, p0, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->mRemoteControlClients:Ljava/util/ArrayList;
...
.method chooseFallbackRoute()Landroid/support/v7/media/MediaRouter$RouteInfo;
    ...
    .line 2544
    :cond_1
    iget-object p0, p0, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->mDefaultRoute:Landroid/support/v7/media/MediaRouter$RouteInfo;
...
.method getBluetoothRoute()Landroid/support/v7/media/MediaRouter$RouteInfo;
    ...
    .line 2090
    iget-object p0, p0, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->mBluetoothRoute:Landroid/support/v7/media/MediaRouter$RouteInfo;
...
.method public getDisplay(I)Landroid/view/Display;
    ...
    .line 2029
    iget-object p0, p0, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->mDisplayManager:Landroid/support/v4/hardware/display/DisplayManagerCompat;

    invoke-virtual {p0, p1}, Landroid/support/v4/hardware/display/DisplayManagerCompat;->getDisplay(I)Landroid/view/Display;
...
.method public getMediaSessionToken()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter$MediaSessionRecord;->getToken()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    .line 2699
    iget-object p0, p0, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->mCompatSession:Landroid/support/v4/media/session/MediaSessionCompat;

    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/media/session/MediaSessionCompat;->getSessionToken()Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method getProviders()Ljava/util/List;
    ...
    .line 2075
    iget-object p0, p0, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->mProviders:Ljava/util/ArrayList;
...
.method public getRoute(Ljava/lang/String;)Landroid/support/v7/media/MediaRouter$RouteInfo;
    ...
    .line 2062
    iget-object p0, p0, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->mRoutes:Ljava/util/ArrayList;
    ...
    .line 2063
    invoke-static/range {v0 .. v0}, Landroid/support/v7/media/MediaRouter$RouteInfo;->access$300(Landroid/support/v7/media/MediaRouter$RouteInfo;)Ljava/lang/String;
...
.method public isRouteAvailable(Landroid/support/v7/media/MediaRouteSelector;I)Z
    ...
    .line 2121
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouteSelector;->isEmpty()Z
    ...
    .line 2135
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/media/MediaRouter$RouteInfo;->isDefaultOrBluetooth()Z
...
.method public onSystemRouteSelectedByDescriptorId(Ljava/lang/String;)V
    ...
    check-cast p0, Landroid/support/v7/media/MediaRouter$ProviderInfo;

    .line 2639
    invoke-virtual {p0, p1}, Landroid/support/v7/media/MediaRouter$ProviderInfo;->findRouteByDescriptorId(Ljava/lang/String;)I
    ...
    .line 2641
    invoke-static/range {p0 .. p0}, Landroid/support/v7/media/MediaRouter$ProviderInfo;->access$600(Landroid/support/v7/media/MediaRouter$ProviderInfo;)Ljava/util/List;
    ...
    check-cast p0, Landroid/support/v7/media/MediaRouter$RouteInfo;

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouter$RouteInfo;->select()V
...
.method public removeRemoteControlClient(Ljava/lang/Object;)V
    ...
    check-cast p0, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter$RemoteControlClientRecord;

    .line 2658
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter$RemoteControlClientRecord;->disconnect()V
...
.method public requestSetVolume(Landroid/support/v7/media/MediaRouter$RouteInfo;I)V
    ...
    .line 2046
    iget-object p0, p0, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->mSelectedRouteController:Landroid/support/v7/media/MediaRouteProvider$RouteController;

    invoke-virtual {p0, p2}, Landroid/support/v7/media/MediaRouteProvider$RouteController;->onSetVolume(I)V
    ...
    .line 2048
    iget-object p0, p0, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->mRouteControllerMap:Ljava/util/Map;
    ...
    check-cast p0, Landroid/support/v7/media/MediaRouteProvider$RouteController;
...
.method public requestUpdateVolume(Landroid/support/v7/media/MediaRouter$RouteInfo;I)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/media/MediaRouteProvider$RouteController;->onUpdateVolume(I)V
...
.method selectRoute(Landroid/support/v7/media/MediaRouter$RouteInfo;I)V
    ...
    .line 2113
    :cond_0
    invoke-static/range {p1 .. p1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->access$400(Landroid/support/v7/media/MediaRouter$RouteInfo;)Z
    ...
    .line 2117
    :cond_1
    invoke-direct/range {p0 .. p2}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->setSelectedRouteInternal(Landroid/support/v7/media/MediaRouter$RouteInfo;I)V
...
.method public sendControlRequest(Landroid/support/v7/media/MediaRouter$RouteInfo;Landroid/content/Intent;Landroid/support/v7/media/MediaRouter$ControlRequestCallback;)V
    ...
    invoke-virtual {p0, p2, p3}, Landroid/support/v7/media/MediaRouteProvider$RouteController;->onControlRequest(Landroid/content/Intent;Landroid/support/v7/media/MediaRouter$ControlRequestCallback;)Z
    ...
    .line 2040
    invoke-virtual {p3, p0, p0}, Landroid/support/v7/media/MediaRouter$ControlRequestCallback;->onError(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public setMediaSessionCompat(Landroid/support/v4/media/session/MediaSessionCompat;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/media/session/MediaSessionCompat;->getRemoteControlClient()Ljava/lang/Object;
    ...
    .line 2678
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/media/session/MediaSessionCompat;->isActive()Z
    ...
    .line 2679
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/media/session/MediaSessionCompat;->getRemoteControlClient()Ljava/lang/Object;
...
.method public start()V
    ...
    .line 1994
    iget-object p0, p0, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->mRegisteredProviderWatcher:Landroid/support/v7/media/RegisteredMediaRouteProviderWatcher;

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/RegisteredMediaRouteProviderWatcher;->start()V
...
.method public updateDiscoveryRequest()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/media/MediaRouteSelector$Builder;-><init>()V
    ...
    .line 2176
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouteSelector$Builder;->build()Landroid/support/v7/media/MediaRouteSelector;
    ...
    .line 2180
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/media/MediaRouteDiscoveryRequest;->getSelector()Landroid/support/v7/media/MediaRouteSelector;
    ...
    .line 2181
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/media/MediaRouteDiscoveryRequest;->isActiveScan()Z
    ...
    .line 2184
    :cond_7
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouteSelector;->isEmpty()Z
    ...
    invoke-static/range {v1 .. v1}, Landroid/support/v7/media/MediaRouter$ProviderInfo;->access$500(Landroid/support/v7/media/MediaRouter$ProviderInfo;)Landroid/support/v7/media/MediaRouteProvider;
