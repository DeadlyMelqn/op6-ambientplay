...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    .line 206
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteControllerDialog;->getContext()Landroid/content/Context;
    ...
    invoke-static/range {p2 .. p2}, Landroid/support/v7/media/MediaRouter;->getInstance(Landroid/content/Context;)Landroid/support/v7/media/MediaRouter;
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/media/MediaRouter;->getSelectedRoute()Landroid/support/v7/media/MediaRouter$RouteInfo;
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/media/MediaRouter;->getMediaSessionToken()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    invoke-direct/range {p1 .. p1}, Landroid/view/animation/AccelerateDecelerateInterpolator;-><init>()V
...
.method static synthetic access$000(Landroid/support/v7/app/MediaRouteControllerDialog;)Z
    ...
    .line 99
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteControllerDialog;->isPauseActionSupported()Z
...
.method static synthetic access$100(Landroid/support/v7/app/MediaRouteControllerDialog;)Z
    ...
    .line 99
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteControllerDialog;->isStopActionSupported()Z
...
.method static synthetic access$200(Landroid/support/v7/app/MediaRouteControllerDialog;)Z
    ...
    .line 99
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteControllerDialog;->isPlayActionSupported()Z
...
.method static synthetic access$300(Landroid/support/v7/app/MediaRouteControllerDialog;Landroid/graphics/Bitmap;)Z
    ...
    .line 99
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/app/MediaRouteControllerDialog;->isBitmapRecycled(Landroid/graphics/Bitmap;)Z
...
.method private animateGroupListItems(Ljava/util/Map;Ljava/util/Map;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/OverlayListView;->requestLayout()V
...
.method private animateLayoutHeight(Landroid/view/View;I)V
    ...
    .line 709
    invoke-static/range {p1 .. p1}, Landroid/support/v7/app/MediaRouteControllerDialog;->getLayoutHeight(Landroid/view/View;)I
    ...
    .line 720
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteControllerDialog;->mInterpolator:Landroid/view/animation/Interpolator;
...
.method private fadeInAddedRoutes()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/app/OverlayListView;->getFirstVisiblePosition()I
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/app/OverlayListView;->getChildCount()I
    ...
    .line 942
    :cond_0
    invoke-virtual/range {v4 .. v4}, Landroid/view/View;->clearAnimation()V
...
.method private getGroup()Landroid/support/v7/media/MediaRouter$RouteGroup;
    ...
    check-cast p0, Landroid/support/v7/media/MediaRouter$RouteGroup;
...
.method private getMainControllerHeight(Z)I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/LinearLayout;->getVisibility()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/LinearLayout;->getPaddingTop()I
    ...
    .line 562
    invoke-virtual/range {v2 .. v2}, Landroid/widget/LinearLayout;->getPaddingBottom()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/RelativeLayout;->getMeasuredHeight()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/LinearLayout;->getMeasuredHeight()I
    ...
    .line 570
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteControllerDialog;->mDividerView:Landroid/view/View;
...
.method private isIconChanged()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/media/MediaDescriptionCompat;->getIconBitmap()Landroid/graphics/Bitmap;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v4/media/MediaDescriptionCompat;->getIconUri()Landroid/net/Uri;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/app/MediaRouteControllerDialog$FetchArtTask;->getIconBitmap()Landroid/graphics/Bitmap;
    ...
    :cond_3
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteControllerDialog;->mFetchArtTask:Landroid/support/v7/app/MediaRouteControllerDialog$FetchArtTask;

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteControllerDialog$FetchArtTask;->getIconUri()Landroid/net/Uri;
    ...
    .line 1125
    invoke-static {p0, v1}, Landroid/support/v7/app/MediaRouteControllerDialog;->uriEquals(Landroid/net/Uri;Landroid/net/Uri;)Z
...
.method private isPauseActionSupported()Z
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/media/session/PlaybackStateCompat;->getActions()J
...
.method private rebuildVolumeGroupList(Z)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouter$RouteGroup;->getRoutes()Ljava/util/List;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteControllerDialog$VolumeGroupAdapter;->notifyDataSetChanged()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/MediaRouteControllerDialog$VolumeGroupAdapter;->notifyDataSetChanged()V
...
.method private setMediaSession(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    .line 314
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteControllerDialog;->updateArtIconIfNeeded()V
...
.method private updateMediaControlVisibility(Z)V
    ...
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteControllerDialog;->mVolumeControlLayout:Landroid/widget/LinearLayout;
...
.method private updatePlaybackControlLayout()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/media/MediaDescriptionCompat;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v4/media/MediaDescriptionCompat;->getSubtitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getPresentationDisplayId()I
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/support/v4/media/session/PlaybackStateCompat;->getState()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/media/session/PlaybackStateCompat;->getState()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/ImageButton;->getContext()Landroid/content/Context;
    ...
    .line 1036
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteControllerDialog;->mPlaybackControlButton:Landroid/widget/ImageButton;
...
.method private updateVolumeControlLayout()V
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getVolumeMax()I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getVolume()I
...
.method private static uriEquals(Landroid/net/Uri;Landroid/net/Uri;)Z
    ...
    .line 1072
    invoke-virtual/range {p0 .. p1}, Landroid/net/Uri;->equals(Ljava/lang/Object;)Z
...
.method animateGroupListItemsInternal(Ljava/util/Map;Ljava/util/Map;)V
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/app/OverlayListView;->getFirstVisiblePosition()I
    ...
    invoke-virtual/range {v7 .. v7}, Landroid/support/v7/app/OverlayListView;->getChildCount()I
    ...
    .line 845
    :cond_3
    invoke-virtual/range {v7 .. v7}, Landroid/view/View;->clearAnimation()V
...
.method clearGroupListAnimation(Z)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/OverlayListView;->getFirstVisiblePosition()I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/app/OverlayListView;->getChildCount()I
    ...
    .line 968
    invoke-virtual/range {v3 .. v3}, Landroid/view/View;->clearAnimation()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/OverlayListView;->stopAnimationAll()V
...
.method finishAnimation(Z)V
    ...
    .line 909
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/app/MediaRouteControllerDialog;->updateLayoutHeight(Z)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/app/OverlayListView;->setEnabled(Z)V
...
.method getDesiredArtHeight(II)I
    ...
    .line 1086
    iget p0, p0, Landroid/support/v7/app/MediaRouteControllerDialog;->mDialogContentWidth:I
...
.method public getMediaControlView()Landroid/view/View;
    ...
    .line 257
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteControllerDialog;->mCustomControlView:Landroid/view/View;
...
.method public getMediaSession()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/media/session/MediaControllerCompat;->getSessionToken()Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method isVolumeControlAvailable(Landroid/support/v7/media/MediaRouter$RouteInfo;)Z
    ...
    .line 1057
    iget-boolean p0, p0, Landroid/support/v7/app/MediaRouteControllerDialog;->mVolumeControlEnabled:Z
...
.method public onAttachedToWindow()V
    ...
    .line 478
    invoke-super/range {p0 .. p0}, Landroid/support/v7/app/AlertDialog;->onAttachedToWindow()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouter;->getMediaSessionToken()Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 329
    invoke-super/range {p0 .. p1}, Landroid/support/v7/app/AlertDialog;->onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static/range {v2 .. v2}, Landroid/support/v7/app/MediaRouterThemeHelper;->getButtonTextColor(Landroid/content/Context;)I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/app/OverlayListView;->getContext()Landroid/content/Context;
    ...
    .line 434
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteControllerDialog;->loadInterpolator()V
    ...
    .line 442
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/app/MediaRouteControllerDialog;->onCreateMediaControlView(Landroid/os/Bundle;)Landroid/view/View;
...
.method public onDetachedFromWindow()V
    ...
    .line 491
    invoke-super/range {p0 .. p0}, Landroid/support/v7/app/AlertDialog;->onDetachedFromWindow()V
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 501
    :cond_0
    invoke-super/range {p0 .. p2}, Landroid/support/v7/app/AlertDialog;->onKeyDown(ILandroid/view/KeyEvent;)Z
...
.method public onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    .line 510
    :cond_0
    invoke-super/range {p0 .. p2}, Landroid/support/v7/app/AlertDialog;->onKeyUp(ILandroid/view/KeyEvent;)Z
...
.method startGroupListFadeInAnimationInternal()V
    ...
    .line 897
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteControllerDialog;->fadeInAddedRoutes()V
...
.method update(Z)V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->isSelected()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->isDefaultOrBluetooth()Z
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getName()Ljava/lang/String;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/media/MediaRouter$RouteInfo;->canDisconnect()Z
    ...
    .line 539
    :goto_1
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteControllerDialog;->clearLoadedBitmap()V

    .line 541
    :cond_5
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteControllerDialog;->updateVolumeControlLayout()V

    .line 542
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteControllerDialog;->updatePlaybackControlLayout()V
...
.method updateArtIconIfNeeded()V
    ...
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteControllerDialog;->isIconChanged()Z
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/app/MediaRouteControllerDialog$FetchArtTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method updateLayout()V
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v7/app/MediaRouteDialogHelper;->getDialogWidth(Landroid/content/Context;)I
...
.method updateLayoutHeightInternal(Z)V
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v7/app/MediaRouteControllerDialog;->getLayoutHeight(Landroid/view/View;)I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/view/Window;->getAttributes()Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/drawable/BitmapDrawable;->getBitmap()Landroid/graphics/Bitmap;
    ...
    invoke-virtual/range {v6 .. v6}, Landroid/support/v7/media/MediaRouter$RouteGroup;->getRoutes()Ljava/util/List;
    ...
    invoke-direct/range {v6 .. v6}, Landroid/graphics/Rect;-><init>()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/LinearLayout;->getMeasuredHeight()I
    ...
    .line 645
    invoke-virtual/range {v7 .. v7}, Landroid/widget/FrameLayout;->getMeasuredHeight()I
    ...
    .line 647
    invoke-virtual/range {v6 .. v6}, Landroid/graphics/Rect;->height()I
    ...
    invoke-static/range {v1 .. v1}, Landroid/support/v7/app/MediaRouteControllerDialog;->getLayoutHeight(Landroid/view/View;)I

    move-result v1

    iget-object v2, p0, Landroid/support/v7/app/MediaRouteControllerDialog;->mMediaMainControlLayout:Landroid/widget/LinearLayout;

    invoke-virtual/range {v2 .. v2}, Landroid/widget/LinearLayout;->getMeasuredHeight()I
    ...
    .line 656
    invoke-virtual/range {v2 .. v2}, Landroid/widget/FrameLayout;->getMeasuredHeight()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/RelativeLayout;->getVisibility()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/widget/LinearLayout;->clearAnimation()V

    .line 682
    iget-object v2, p0, Landroid/support/v7/app/MediaRouteControllerDialog;->mVolumeGroupList:Landroid/support/v7/app/OverlayListView;

    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/app/OverlayListView;->clearAnimation()V

    .line 683
    iget-object v2, p0, Landroid/support/v7/app/MediaRouteControllerDialog;->mDefaultControlLayout:Landroid/widget/FrameLayout;

    invoke-virtual/range {v2 .. v2}, Landroid/widget/FrameLayout;->clearAnimation()V
...
.method updateVolumeGroupItemHeight(Landroid/view/View;)V
    ...
    .line 704
    iget p0, p0, Landroid/support/v7/app/MediaRouteControllerDialog;->mVolumeGroupListItemIconSize:I
