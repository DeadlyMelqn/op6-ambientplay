...
.method public constructor <init>(Landroid/support/v7/media/MediaRouteProviderDescriptor;)V
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/v7/media/MediaRouteProviderDescriptor;->access$000(Landroid/support/v7/media/MediaRouteProviderDescriptor;)Landroid/os/Bundle;
    ...
    .line 141
    invoke-static/range {p1 .. p1}, Landroid/support/v7/media/MediaRouteProviderDescriptor;->access$100(Landroid/support/v7/media/MediaRouteProviderDescriptor;)V

    .line 142
    invoke-static/range {p1 .. p1}, Landroid/support/v7/media/MediaRouteProviderDescriptor;->access$200(Landroid/support/v7/media/MediaRouteProviderDescriptor;)Ljava/util/List;
...
.method public build()Landroid/support/v7/media/MediaRouteProviderDescriptor;
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/media/MediaRouteDescriptor;->asBundle()Landroid/os/Bundle;
    ...
    iget-object p0, p0, Landroid/support/v7/media/MediaRouteProviderDescriptor$Builder;->mRoutes:Ljava/util/ArrayList;

    const/4 v2, 0x0

    invoke-direct {v0, v1, p0, v2}, Landroid/support/v7/media/MediaRouteProviderDescriptor;-><init>(Landroid/os/Bundle;Ljava/util/List;Landroid/support/v7/media/MediaRouteProviderDescriptor$1;)V
