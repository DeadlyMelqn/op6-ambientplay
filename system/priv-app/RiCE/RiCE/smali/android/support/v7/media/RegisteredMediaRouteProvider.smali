...
.method public constructor <init>(Landroid/content/Context;Landroid/content/ComponentName;)V
    ...
    invoke-direct/range {p1 .. p1}, Landroid/support/v7/media/RegisteredMediaRouteProvider$PrivateHandler;-><init>()V
...
.method private bind()V
    ...
    .line 226
    :try_start_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/RegisteredMediaRouteProvider;->getContext()Landroid/content/Context;
...
.method private createRouteController(Ljava/lang/String;Ljava/lang/String;)Landroid/support/v7/media/MediaRouteProvider$RouteController;
    ...
    .line 251
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/RegisteredMediaRouteProvider;->getDescriptor()Landroid/support/v7/media/MediaRouteProviderDescriptor;
    ...
    .line 253
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouteProviderDescriptor;->getRoutes()Ljava/util/List;
    ...
    .line 257
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/media/MediaRouteDescriptor;->getId()Ljava/lang/String;
    ...
    .line 263
    :cond_0
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/media/RegisteredMediaRouteProvider;->updateBinding()V
...
.method private detachControllersFromConnection()V
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/media/RegisteredMediaRouteProvider$Controller;->detachConnection()V
...
.method private disconnect()V
    ...
    .line 315
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/media/RegisteredMediaRouteProvider;->detachControllersFromConnection()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/media/RegisteredMediaRouteProvider$Connection;->dispose()V
...
.method private shouldBind()Z
    ...
    .line 204
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/RegisteredMediaRouteProvider;->getDiscoveryRequest()Landroid/support/v7/media/MediaRouteDiscoveryRequest;
    ...
    .line 210
    :cond_0
    iget-object p0, p0, Landroid/support/v7/media/RegisteredMediaRouteProvider;->mControllers:Ljava/util/ArrayList;
...
.method private unbind()V
    ...
    .line 245
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/media/RegisteredMediaRouteProvider;->disconnect()V
...
.method private updateBinding()V
    ...
    .line 194
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/media/RegisteredMediaRouteProvider;->shouldBind()Z
    ...
    .line 195
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/media/RegisteredMediaRouteProvider;->bind()V

    goto :goto_0

    .line 197
    :cond_0
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/media/RegisteredMediaRouteProvider;->unbind()V
...
.method public hasComponentName(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/content/ComponentName;->getPackageName()Ljava/lang/String;
    ...
    iget-object p0, p0, Landroid/support/v7/media/RegisteredMediaRouteProvider;->mComponentName:Landroid/content/ComponentName;
...
.method onConnectionReady(Landroid/support/v7/media/RegisteredMediaRouteProvider$Connection;)V
    ...
    .line 274
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/media/RegisteredMediaRouteProvider;->attachControllersToConnection()V
    ...
    .line 278
    iget-object p0, p0, Landroid/support/v7/media/RegisteredMediaRouteProvider;->mActiveConnection:Landroid/support/v7/media/RegisteredMediaRouteProvider$Connection;

    invoke-virtual {p0, p1}, Landroid/support/v7/media/RegisteredMediaRouteProvider$Connection;->setDiscoveryRequest(Landroid/support/v7/media/MediaRouteDiscoveryRequest;)V
...
.method onControllerReleased(Landroid/support/v7/media/RegisteredMediaRouteProvider$Controller;)V
    ...
    .line 323
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/RegisteredMediaRouteProvider$Controller;->detachConnection()V
...
.method public onCreateRouteController(Ljava/lang/String;Ljava/lang/String;)Landroid/support/v7/media/MediaRouteProvider$RouteController;
    ...
    .line 110
    invoke-direct/range {p0 .. p2}, Landroid/support/v7/media/RegisteredMediaRouteProvider;->createRouteController(Ljava/lang/String;Ljava/lang/String;)Landroid/support/v7/media/MediaRouteProvider$RouteController;
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    .line 131
    :goto_0
    invoke-static/range {p1 .. p1}, Landroid/support/v7/media/MediaRouteProviderProtocol;->isValidRemoteMessenger(Landroid/os/Messenger;)Z
    ...
    .line 133
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/media/RegisteredMediaRouteProvider$Connection;->register()Z
