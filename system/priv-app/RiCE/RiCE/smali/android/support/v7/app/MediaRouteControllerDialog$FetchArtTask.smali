...
.method constructor <init>(Landroid/support/v7/app/MediaRouteControllerDialog;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/media/MediaDescriptionCompat;->getIconUri()Landroid/net/Uri;
...
.method private openInputStreamByScheme(Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    .line 1471
    sget p1, Landroid/support/v7/app/MediaRouteControllerDialog;->CONNECTION_TIMEOUT_MILLIS:I
    ...
    :cond_1
    :goto_0
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteControllerDialog$FetchArtTask;->this$0:Landroid/support/v7/app/MediaRouteControllerDialog;
...
.method protected varargs doInBackground([Ljava/lang/Void;)Landroid/graphics/Bitmap;
    ...
    invoke-direct/range {v3 .. v3}, Landroid/graphics/BitmapFactory$Options;-><init>()V
    ...
    .line 1426
    :try_start_7
    invoke-virtual/range {v4 .. v4}, Ljava/io/InputStream;->close()V
    :try_end_7
    ...
    .line 1416
    invoke-static/range {v5 .. v5}, Ljava/lang/Integer;->highestOneBit(I)I
    ...
    .line 1417
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteControllerDialog$FetchArtTask;->isCancelled()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/graphics/Palette$Builder;->generate()Landroid/support/v7/graphics/Palette;

    move-result-object v1

    .line 1439
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/graphics/Palette;->getSwatches()Ljava/util/List;
...
.method protected bridge synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/app/MediaRouteControllerDialog$FetchArtTask;->doInBackground([Ljava/lang/Void;)Landroid/graphics/Bitmap;
...
.method public getIconBitmap()Landroid/graphics/Bitmap;
    ...
    .line 1369
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteControllerDialog$FetchArtTask;->mIconBitmap:Landroid/graphics/Bitmap;
...
.method public getIconUri()Landroid/net/Uri;
    ...
    .line 1373
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteControllerDialog$FetchArtTask;->mIconUri:Landroid/net/Uri;
...
.method protected bridge synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/app/MediaRouteControllerDialog$FetchArtTask;->onPostExecute(Landroid/graphics/Bitmap;)V
