...
.method public constructor <init>(Landroid/support/v7/app/MediaRouteChooserDialog;Landroid/content/Context;Ljava/util/List;)V
    ...
    .line 258
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteChooserDialog$RouteAdapter;->getContext()Landroid/content/Context;
...
.method private getDefaultIconDrawable(Landroid/support/v7/media/MediaRouter$RouteInfo;)Landroid/graphics/drawable/Drawable;
    ...
    .line 341
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getDeviceType()I
    ...
    .line 351
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteChooserDialog$RouteAdapter;->mSpeakerGroupIcon:Landroid/graphics/drawable/Drawable;

    return-object p0

    .line 345
    :pswitch_0
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteChooserDialog$RouteAdapter;->mSpeakerIcon:Landroid/graphics/drawable/Drawable;

    return-object p0

    .line 343
    :pswitch_1
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteChooserDialog$RouteAdapter;->mTvIcon:Landroid/graphics/drawable/Drawable;

    return-object p0

    .line 353
    :cond_0
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteChooserDialog$RouteAdapter;->mDefaultIcon:Landroid/graphics/drawable/Drawable;
...
.method private getIconDrawable(Landroid/support/v7/media/MediaRouter$RouteInfo;)Landroid/graphics/drawable/Drawable;
    ...
    .line 323
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getIconUri()Landroid/net/Uri;
    ...
    .line 336
    :cond_0
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/app/MediaRouteChooserDialog$RouteAdapter;->getDefaultIconDrawable(Landroid/support/v7/media/MediaRouter$RouteInfo;)Landroid/graphics/drawable/Drawable;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 287
    :cond_0
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/app/MediaRouteChooserDialog$RouteAdapter;->getItem(I)Ljava/lang/Object;
    ...
    .line 290
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getName()Ljava/lang/String;
    ...
    .line 293
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getConnectionState()I
...
.method public isEnabled(I)Z
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouter$RouteInfo;->isEnabled()Z
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .line 318
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteChooserDialog$RouteAdapter;->this$0:Landroid/support/v7/app/MediaRouteChooserDialog;

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteChooserDialog;->dismiss()V
