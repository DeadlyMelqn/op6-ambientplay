...
.method private ensureRouteSelector()V
    ...
    .line 105
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteDiscoveryFragment;->getArguments()Landroid/os/Bundle;
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v7/media/MediaRouteSelector;->fromBundle(Landroid/os/Bundle;)Landroid/support/v7/media/MediaRouteSelector;
...
.method private ensureRouter()V
    ...
    .line 60
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteDiscoveryFragment;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-static/range {v0 .. v0}, Landroid/support/v7/media/MediaRouter;->getInstance(Landroid/content/Context;)Landroid/support/v7/media/MediaRouter;
...
.method public getMediaRouter()Landroid/support/v7/media/MediaRouter;
    ...
    .line 54
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteDiscoveryFragment;->ensureRouter()V

    .line 55
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteDiscoveryFragment;->mRouter:Landroid/support/v7/media/MediaRouter;
...
.method public getRouteSelector()Landroid/support/v7/media/MediaRouteSelector;
    ...
    .line 70
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteDiscoveryFragment;->ensureRouteSelector()V

    .line 71
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteDiscoveryFragment;->mSelector:Landroid/support/v7/media/MediaRouteSelector;
...
.method public onStart()V
    ...
    .line 148
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteDiscoveryFragment;->onCreateCallback()Landroid/support/v7/media/MediaRouter$Callback;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteDiscoveryFragment;->onPrepareCallbackFlags()I

    move-result p0

    invoke-virtual {v0, v1, v2, p0}, Landroid/support/v7/media/MediaRouter;->addCallback(Landroid/support/v7/media/MediaRouteSelector;Landroid/support/v7/media/MediaRouter$Callback;I)V
...
.method public setRouteSelector(Landroid/support/v7/media/MediaRouteSelector;)V
    ...
    .line 93
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouteSelector;->asBundle()Landroid/os/Bundle;
    ...
    invoke-virtual {p1, v0, v1, p0}, Landroid/support/v7/media/MediaRouter;->addCallback(Landroid/support/v7/media/MediaRouteSelector;Landroid/support/v7/media/MediaRouter$Callback;I)V
