...
.method static createDescriptorBundleForClientVersion(Landroid/support/v7/media/MediaRouteProviderDescriptor;I)Landroid/os/Bundle;
    ...
    .line 433
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouteProviderDescriptor;->getRoutes()Ljava/util/List;
    ...
    .line 434
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouteDescriptor;->getMinClientVersion()I
    ...
    .line 435
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouteDescriptor;->getMaxClientVersion()I
    ...
    .line 439
    :cond_2
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/media/MediaRouteProviderDescriptor$Builder;->build()Landroid/support/v7/media/MediaRouteProviderDescriptor;

    move-result-object p0

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouteProviderDescriptor;->asBundle()Landroid/os/Bundle;
...
.method private getClient(Landroid/os/Messenger;)Landroid/support/v7/media/MediaRouteProviderService$ClientRecord;
    ...
    .line 474
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/media/MediaRouteProviderService;->findClient(Landroid/os/Messenger;)I
    ...
    .line 475
    iget-object p0, p0, Landroid/support/v7/media/MediaRouteProviderService;->mClients:Ljava/util/ArrayList;

    invoke-virtual {p0, p1}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/support/v7/media/MediaRouteProviderService$ClientRecord;
...
.method static sendReply(Landroid/os/Messenger;IIILjava/lang/Object;Landroid/os/Bundle;)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v7/media/MediaRouteProviderService;->getClientId(Landroid/os/Messenger;)Ljava/lang/String;
...
.method public onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    .line 151
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouteProviderService;->onCreateMediaRouteProvider()Landroid/support/v7/media/MediaRouteProvider;
    ...
    .line 153
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouteProvider;->getMetadata()Landroid/support/v7/media/MediaRouteProvider$ProviderMetadata;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouteProvider$ProviderMetadata;->getPackageName()Ljava/lang/String;

    move-result-object v0

    .line 154
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouteProviderService;->getPackageName()Ljava/lang/String;
    ...
    .line 167
    iget-object p0, p0, Landroid/support/v7/media/MediaRouteProviderService;->mReceiveMessenger:Landroid/os/Messenger;
...
.method onBinderDied(Landroid/os/Messenger;)V
    ...
    .line 226
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouteProviderService$ClientRecord;->dispose()V
...
.method onCreateRouteController(Landroid/os/Messenger;IILjava/lang/String;Ljava/lang/String;)Z
    ...
    .line 232
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/media/MediaRouteProviderService;->getClient(Landroid/os/Messenger;)Landroid/support/v7/media/MediaRouteProviderService$ClientRecord;
    ...
    .line 234
    invoke-virtual {p0, p4, p5, p3}, Landroid/support/v7/media/MediaRouteProviderService$ClientRecord;->createRouteController(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    .line 239
    :cond_0
    invoke-static/range {p1 .. p2}, Landroid/support/v7/media/MediaRouteProviderService;->sendGenericSuccess(Landroid/os/Messenger;I)V
...
.method onRegisterClient(Landroid/os/Messenger;II)Z
    ...
    .line 186
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/media/MediaRouteProviderService$ClientRecord;->register()Z
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouteProvider;->getDescriptor()Landroid/support/v7/media/MediaRouteProviderDescriptor;
    ...
    .line 193
    iget p3, v1, Landroid/support/v7/media/MediaRouteProviderService$ClientRecord;->mVersion:I

    .line 195
    invoke-static {p0, p3}, Landroid/support/v7/media/MediaRouteProviderService;->createDescriptorBundleForClientVersion(Landroid/support/v7/media/MediaRouteProviderDescriptor;I)Landroid/os/Bundle;
...
.method onReleaseRouteController(Landroid/os/Messenger;II)Z
    ...
    .line 250
    invoke-virtual {p0, p3}, Landroid/support/v7/media/MediaRouteProviderService$ClientRecord;->releaseRouteController(I)Z
...
.method onSelectRoute(Landroid/os/Messenger;II)Z
    ...
    .line 267
    invoke-virtual {p0, p3}, Landroid/support/v7/media/MediaRouteProviderService$ClientRecord;->getRouteController(I)Landroid/support/v7/media/MediaRouteProvider$RouteController;
...
.method onSetDiscoveryRequest(Landroid/os/Messenger;ILandroid/support/v7/media/MediaRouteDiscoveryRequest;)Z
    ...
    iget-object p0, p0, Landroid/support/v7/media/MediaRouteProviderService;->mCompositeDiscoveryRequest:Landroid/support/v7/media/MediaRouteDiscoveryRequest;
...
.method onSetRouteVolume(Landroid/os/Messenger;III)Z
    ...
    .line 307
    invoke-virtual {v0, p4}, Landroid/support/v7/media/MediaRouteProvider$RouteController;->onSetVolume(I)V
...
.method public onUnbind(Landroid/content/Intent;)Z
    ...
    .line 178
    :cond_0
    invoke-super/range {p0 .. p1}, Landroid/app/Service;->onUnbind(Landroid/content/Intent;)Z
...
.method onUnselectRoute(Landroid/os/Messenger;III)Z
    ...
    .line 288
    invoke-virtual {v0, p4}, Landroid/support/v7/media/MediaRouteProvider$RouteController;->onUnselect(I)V
...
.method onUpdateRouteVolume(Landroid/os/Messenger;III)Z
    ...
    .line 326
    invoke-virtual {v0, p4}, Landroid/support/v7/media/MediaRouteProvider$RouteController;->onUpdateVolume(I)V
...
.method updateCompositeDiscoveryRequest()Z
    ...
    .line 450
    invoke-virtual/range {v6 .. v6}, Landroid/support/v7/media/MediaRouteDiscoveryRequest;->getSelector()Landroid/support/v7/media/MediaRouteSelector;

    move-result-object v7

    invoke-virtual/range {v7 .. v7}, Landroid/support/v7/media/MediaRouteSelector;->isEmpty()Z

    move-result v7

    if-eqz v7, :cond_0

    invoke-virtual/range {v6 .. v6}, Landroid/support/v7/media/MediaRouteDiscoveryRequest;->isActiveScan()Z
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/support/v7/media/MediaRouteDiscoveryRequest;->getSelector()Landroid/support/v7/media/MediaRouteSelector;
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/media/MediaRouteSelector$Builder;->build()Landroid/support/v7/media/MediaRouteSelector;
    ...
    invoke-virtual {p0, v5}, Landroid/support/v7/media/MediaRouteProvider;->setDiscoveryRequest(Landroid/support/v7/media/MediaRouteDiscoveryRequest;)V
