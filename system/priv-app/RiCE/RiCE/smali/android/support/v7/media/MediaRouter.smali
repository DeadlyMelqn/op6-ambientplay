...
.method synthetic constructor <init>(Landroid/content/Context;Landroid/support/v7/media/MediaRouter$1;)V
    ...
    .line 81
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/media/MediaRouter;-><init>(Landroid/content/Context;)V
...
.method public static getInstance(Landroid/content/Context;)Landroid/support/v7/media/MediaRouter;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->start()V
...
.method public addCallback(Landroid/support/v7/media/MediaRouteSelector;Landroid/support/v7/media/MediaRouter$Callback;I)V
    ...
    .line 596
    iget-object p0, p0, Landroid/support/v7/media/MediaRouter;->mCallbackRecords:Ljava/util/ArrayList;
    ...
    .line 602
    iget p0, v0, Landroid/support/v7/media/MediaRouter$CallbackRecord;->mFlags:I

    or-int/2addr p0, p3

    iput p0, v0, Landroid/support/v7/media/MediaRouter$CallbackRecord;->mFlags:I

    move p0, v1

    .line 605
    :cond_2
    iget-object p2, v0, Landroid/support/v7/media/MediaRouter$CallbackRecord;->mSelector:Landroid/support/v7/media/MediaRouteSelector;

    invoke-virtual {p2, p1}, Landroid/support/v7/media/MediaRouteSelector;->contains(Landroid/support/v7/media/MediaRouteSelector;)Z
    ...
    .line 606
    new-instance p0, Landroid/support/v7/media/MediaRouteSelector$Builder;

    iget-object p2, v0, Landroid/support/v7/media/MediaRouter$CallbackRecord;->mSelector:Landroid/support/v7/media/MediaRouteSelector;

    invoke-direct {p0, p2}, Landroid/support/v7/media/MediaRouteSelector$Builder;-><init>(Landroid/support/v7/media/MediaRouteSelector;)V

    .line 607
    invoke-virtual {p0, p1}, Landroid/support/v7/media/MediaRouteSelector$Builder;->addSelector(Landroid/support/v7/media/MediaRouteSelector;)Landroid/support/v7/media/MediaRouteSelector$Builder;

    move-result-object p0

    .line 608
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouteSelector$Builder;->build()Landroid/support/v7/media/MediaRouteSelector;

    move-result-object p0

    iput-object p0, v0, Landroid/support/v7/media/MediaRouter$CallbackRecord;->mSelector:Landroid/support/v7/media/MediaRouteSelector;
    ...
    .line 612
    sget-object p0, Landroid/support/v7/media/MediaRouter;->sGlobal:Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->updateDiscoveryRequest()V
...
.method public addProvider(Landroid/support/v7/media/MediaRouteProvider;)V
    ...
    .line 668
    sget-boolean p0, Landroid/support/v7/media/MediaRouter;->DEBUG:Z
...
.method public getMediaSessionToken()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->getMediaSessionToken()Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method public getProviders()Ljava/util/List;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->getProviders()Ljava/util/List;
...
.method public getRoutes()Ljava/util/List;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->getRoutes()Ljava/util/List;
...
.method public getSelectedRoute()Landroid/support/v7/media/MediaRouter$RouteInfo;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->getSelectedRoute()Landroid/support/v7/media/MediaRouter$RouteInfo;
...
.method public isRouteAvailable(Landroid/support/v7/media/MediaRouteSelector;I)Z
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->isRouteAvailable(Landroid/support/v7/media/MediaRouteSelector;I)Z
...
.method public removeCallback(Landroid/support/v7/media/MediaRouter$Callback;)V
    ...
    .line 633
    :cond_0
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/media/MediaRouter;->findCallbackRecord(Landroid/support/v7/media/MediaRouter$Callback;)I
...
.method public removeProvider(Landroid/support/v7/media/MediaRouteProvider;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->removeProvider(Landroid/support/v7/media/MediaRouteProvider;)V
...
.method public removeRemoteControlClient(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->removeRemoteControlClient(Ljava/lang/Object;)V
...
.method public selectRoute(Landroid/support/v7/media/MediaRouter$RouteInfo;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->selectRoute(Landroid/support/v7/media/MediaRouter$RouteInfo;)V
...
.method public setMediaSessionCompat(Landroid/support/v4/media/session/MediaSessionCompat;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->setMediaSessionCompat(Landroid/support/v4/media/session/MediaSessionCompat;)V
...
.method public unselect(I)V
    ...
    invoke-virtual {v0, p0, p1}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->selectRoute(Landroid/support/v7/media/MediaRouter$RouteInfo;I)V
    ...
    invoke-virtual {p0, v0, p1}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->selectRoute(Landroid/support/v7/media/MediaRouter$RouteInfo;I)V
...
.method public updateSelectedRoute(Landroid/support/v7/media/MediaRouteSelector;)Landroid/support/v7/media/MediaRouter$RouteInfo;
    ...
    .line 382
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/MediaRouter$RouteInfo;->isDefaultOrBluetooth()Z

    move-result v0

    if-nez v0, :cond_1

    invoke-virtual {p0, p1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->matchesSelector(Landroid/support/v7/media/MediaRouteSelector;)Z
    ...
    invoke-virtual {p1, p0}, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter;->selectRoute(Landroid/support/v7/media/MediaRouter$RouteInfo;)V
