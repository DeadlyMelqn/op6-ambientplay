...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 124
    invoke-static/range {p1 .. p1}, Landroid/support/v7/app/MediaRouterThemeHelper;->createThemedButtonContext(Landroid/content/Context;)Landroid/content/Context;
    ...
    .line 125
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteButton;->getContext()Landroid/content/Context;
    ...
    :cond_1
    :goto_0
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteButton;->updateContentDescription()V
...
.method private getFragmentManager()Landroid/support/v4/app/FragmentManager;
    ...
    .line 268
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteButton;->getActivity()Landroid/app/Activity;
...
.method protected drawableStateChanged()V
    ...
    .line 324
    invoke-super/range {p0 .. p0}, Landroid/view/View;->drawableStateChanged()V
    ...
    .line 327
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteButton;->getDrawableState()[I
    ...
    .line 329
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteButton;->invalidate()V
...
.method public getDialogFactory()Landroid/support/v7/app/MediaRouteDialogFactory;
    ...
    .line 200
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteButton;->mDialogFactory:Landroid/support/v7/app/MediaRouteDialogFactory;
...
.method public getRouteSelector()Landroid/support/v7/media/MediaRouteSelector;
    ...
    .line 164
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteButton;->mSelector:Landroid/support/v7/media/MediaRouteSelector;
...
.method public jumpDrawablesToCurrentState()V
    ...
    .line 382
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteButton;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    .line 388
    iget-object p0, p0, Landroid/support/v7/app/MediaRouteButton;->mRemoteIndicator:Landroid/graphics/drawable/Drawable;

    invoke-static/range {p0 .. p0}, Landroid/support/v4/graphics/drawable/DrawableCompat;->jumpToCurrentState(Landroid/graphics/drawable/Drawable;)V
...
.method public onAttachedToWindow()V
    ...
    .line 409
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteButton;->refreshRoute()V
...
.method protected onCreateDrawableState(I)[I
    ...
    .line 315
    sget-object p0, Landroid/support/v7/app/MediaRouteButton;->CHECKABLE_STATE_SET:[I

    invoke-static {p1, p0}, Landroid/support/v7/app/MediaRouteButton;->mergeDrawableStates([I[I)[I

    goto :goto_0

    .line 316
    :cond_0
    iget-boolean p0, p0, Landroid/support/v7/app/MediaRouteButton;->mRemoteActive:Z

    if-eqz p0, :cond_1

    .line 317
    sget-object p0, Landroid/support/v7/app/MediaRouteButton;->CHECKED_STATE_SET:[I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 470
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteButton;->getPaddingLeft()I

    move-result v0

    .line 471
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteButton;->getWidth()I

    move-result v1

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteButton;->getPaddingRight()I
    ...
    .line 472
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteButton;->getPaddingTop()I

    move-result v2

    .line 473
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteButton;->getHeight()I

    move-result v3

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteButton;->getPaddingBottom()I
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/graphics/drawable/Drawable;->getIntrinsicHeight()I
...
.method public performClick()Z
    ...
    .line 299
    invoke-super/range {p0 .. p0}, Landroid/view/View;->performClick()Z
    ...
    .line 303
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteButton;->showDialog()Z
...
.method refreshRoute()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouter;->getSelectedRoute()Landroid/support/v7/media/MediaRouter$RouteInfo;

    move-result-object v0

    .line 488
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouter$RouteInfo;->isDefaultOrBluetooth()Z
    ...
    .line 489
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouter$RouteInfo;->isConnecting()Z
    ...
    .line 502
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteButton;->refreshDrawableState()V
    ...
    .line 509
    invoke-virtual/range {v4 .. v4}, Landroid/graphics/drawable/Drawable;->getCurrent()Landroid/graphics/drawable/Drawable;
    ...
    .line 511
    iget-boolean p0, p0, Landroid/support/v7/app/MediaRouteButton;->mAttachedToWindow:Z
    ...
    .line 512
    :cond_6
    invoke-virtual/range {v4 .. v4}, Landroid/graphics/drawable/AnimationDrawable;->isRunning()Z
    ...
    .line 513
    invoke-virtual/range {v4 .. v4}, Landroid/graphics/drawable/AnimationDrawable;->start()V
    ...
    .line 519
    invoke-virtual/range {v4 .. v4}, Landroid/graphics/drawable/AnimationDrawable;->stop()V

    .line 521
    :cond_8
    invoke-virtual/range {v4 .. v4}, Landroid/graphics/drawable/AnimationDrawable;->getNumberOfFrames()I
...
.method public setRemoteIndicatorDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 352
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteButton;->getVisibility()I
    ...
    .line 358
    invoke-virtual/range {p1 .. p1}, Landroid/graphics/drawable/Drawable;->getCurrent()Landroid/graphics/drawable/Drawable;
    ...
    .line 361
    invoke-virtual/range {p1 .. p1}, Landroid/graphics/drawable/AnimationDrawable;->isRunning()Z
    ...
    .line 366
    invoke-virtual/range {p1 .. p1}, Landroid/graphics/drawable/AnimationDrawable;->stop()V
...
.method public showDialog()Z
    ...
    .line 240
    :cond_0
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteButton;->getFragmentManager()Landroid/support/v4/app/FragmentManager;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/media/MediaRouter;->getSelectedRoute()Landroid/support/v7/media/MediaRouter$RouteInfo;

    move-result-object v2

    .line 246
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/media/MediaRouter$RouteInfo;->isDefaultOrBluetooth()Z
    ...
    const-string p0, "MediaRouteButton"
    ...
    .line 261
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/MediaRouteDialogFactory;->onCreateControllerDialogFragment()Landroid/support/v7/app/MediaRouteControllerDialogFragment;
    ...
    .line 262
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/app/MediaRouteControllerDialogFragment;->show(Landroid/support/v4/app/FragmentManager;Ljava/lang/String;)V
    ...
    .line 252
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/app/MediaRouteDialogFactory;->onCreateChooserDialogFragment()Landroid/support/v7/app/MediaRouteChooserDialogFragment;
    ...
    invoke-virtual {v1, p0}, Landroid/support/v7/app/MediaRouteChooserDialogFragment;->setRouteSelector(Landroid/support/v7/media/MediaRouteSelector;)V

    const-string p0, "android.support.v7.mediarouter:MediaRouteChooserDialogFragment"

    .line 254
    invoke-virtual {v1, v0, p0}, Landroid/support/v7/app/MediaRouteChooserDialogFragment;->show(Landroid/support/v4/app/FragmentManager;Ljava/lang/String;)V
...
.method protected verifyDrawable(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 375
    invoke-super/range {p0 .. p1}, Landroid/view/View;->verifyDrawable(Landroid/graphics/drawable/Drawable;)Z
