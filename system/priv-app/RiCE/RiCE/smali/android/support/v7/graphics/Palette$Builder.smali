...
.method public constructor <init>(Landroid/graphics/Bitmap;)V
    ...
    .line 630
    iget-object p0, p0, Landroid/support/v7/graphics/Palette$Builder;->mTargets:Ljava/util/List;

    sget-object p1, Landroid/support/v7/graphics/Target;->DARK_MUTED:Landroid/support/v7/graphics/Target;
...
.method private scaleBitmapDown(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    .line 914
    iget p0, p0, Landroid/support/v7/graphics/Palette$Builder;->mResizeArea:I
    ...
    invoke-static/range {v1 .. v2}, Ljava/lang/Math;->sqrt(D)D
    ...
    .line 919
    iget p0, p0, Landroid/support/v7/graphics/Palette$Builder;->mResizeMaxDimension:I
...
.method public generate(Landroid/support/v7/graphics/Palette$PaletteAsyncListener;)Landroid/os/AsyncTask;
    ...
    iget-object p0, p0, Landroid/support/v7/graphics/Palette$Builder;->mBitmap:Landroid/graphics/Bitmap;
...
.method public generate()Landroid/support/v7/graphics/Palette;
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/graphics/Bitmap;->getWidth()I
    ...
    invoke-static/range {v4 .. v5}, Ljava/lang/Math;->floor(D)D
    ...
    .line 827
    :cond_2
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/graphics/ColorCutQuantizer;->getQuantizedColors()Ljava/util/List;
    ...
    invoke-direct {v1, v0, p0}, Landroid/support/v7/graphics/Palette;-><init>(Ljava/util/List;Ljava/util/List;)V

    .line 840
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/graphics/Palette;->generate()V
