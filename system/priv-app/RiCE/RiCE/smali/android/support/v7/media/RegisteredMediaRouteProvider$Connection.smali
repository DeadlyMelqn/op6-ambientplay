...
.method private sendRequest(IIILjava/lang/Object;Landroid/os/Bundle;)Z
    ...
    .line 631
    :try_start_0
    iget-object p0, p0, Landroid/support/v7/media/RegisteredMediaRouteProvider$Connection;->mServiceMessenger:Landroid/os/Messenger;
...
.method public dispose()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/RegisteredMediaRouteProvider$ReceiveHandler;->dispose()V
...
.method failPendingCallbacks()V
    ...
    .line 489
    :cond_0
    iget-object p0, p0, Landroid/support/v7/media/RegisteredMediaRouteProvider$Connection;->mPendingCallbacks:Landroid/util/SparseArray;

    invoke-virtual/range {p0 .. p0}, Landroid/util/SparseArray;->clear()V
...
.method public onDescriptorChanged(Landroid/os/Bundle;)Z
    ...
    .line 527
    invoke-static/range {p1 .. p1}, Landroid/support/v7/media/MediaRouteProviderDescriptor;->fromBundle(Landroid/os/Bundle;)Landroid/support/v7/media/MediaRouteProviderDescriptor;
...
.method public onGenericFailure(I)Z
    ...
    .line 500
    invoke-virtual {v0, p0, p0}, Landroid/support/v7/media/MediaRouter$ControlRequestCallback;->onError(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public onRegistered(IILandroid/os/Bundle;)Z
    ...
    .line 517
    invoke-static/range {p3 .. p3}, Landroid/support/v7/media/MediaRouteProviderDescriptor;->fromBundle(Landroid/os/Bundle;)Landroid/support/v7/media/MediaRouteProviderDescriptor;
...
.method public register()Z
    ...
    .line 466
    :catch_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/RegisteredMediaRouteProvider$Connection;->binderDied()V
...
.method public setDiscoveryRequest(Landroid/support/v7/media/MediaRouteDiscoveryRequest;)V
    ...
    .line 619
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouteDiscoveryRequest;->asBundle()Landroid/os/Bundle;
