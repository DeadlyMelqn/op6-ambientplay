...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/graphics/ColorCutQuantizer$1;-><init>()V
...
.method constructor <init>([II[Landroid/support/v7/graphics/Palette$Filter;)V
    ...
    invoke-static/range {v2 .. v2}, Landroid/support/v7/graphics/ColorCutQuantizer;->quantizeFromRgb888(I)I
    ...
    invoke-static/range {v1 .. v1}, Landroid/support/v7/graphics/ColorCutQuantizer;->approximateToRgb888(I)I
...
.method private static approximateToRgb888(I)I
    ...
    .line 481
    invoke-static/range {p0 .. p0}, Landroid/support/v7/graphics/ColorCutQuantizer;->quantizedRed(I)I

    move-result v0

    invoke-static/range {p0 .. p0}, Landroid/support/v7/graphics/ColorCutQuantizer;->quantizedGreen(I)I

    move-result v1

    invoke-static/range {p0 .. p0}, Landroid/support/v7/graphics/ColorCutQuantizer;->quantizedBlue(I)I
...
.method private generateAverageColors(Ljava/util/Collection;)Ljava/util/List;
    ...
    .line 198
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/graphics/ColorCutQuantizer$Vbox;->getAverageColor()Landroid/support/v7/graphics/Palette$Swatch;
...
.method static modifySignificantOctet([IIII)V
    ...
    .line 422
    invoke-static/range {p1 .. p1}, Landroid/support/v7/graphics/ColorCutQuantizer;->quantizedBlue(I)I
    ...
    .line 423
    invoke-static/range {p1 .. p1}, Landroid/support/v7/graphics/ColorCutQuantizer;->quantizedGreen(I)I
    ...
    .line 424
    invoke-static/range {p1 .. p1}, Landroid/support/v7/graphics/ColorCutQuantizer;->quantizedRed(I)I
...
.method private shouldIgnoreColor(I)Z
    ...
    .line 431
    invoke-static/range {p1 .. p1}, Landroid/support/v7/graphics/ColorCutQuantizer;->approximateToRgb888(I)I
...
.method private splitBoxes(Ljava/util/PriorityQueue;I)V
    ...
    .line 173
    :goto_0
    invoke-virtual/range {p1 .. p1}, Ljava/util/PriorityQueue;->size()I
    ...
    check-cast p0, Landroid/support/v7/graphics/ColorCutQuantizer$Vbox;
    ...
    .line 178
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/graphics/ColorCutQuantizer$Vbox;->splitBox()Landroid/support/v7/graphics/ColorCutQuantizer$Vbox;
...
.method getQuantizedColors()Ljava/util/List;
    ...
    .line 144
    iget-object p0, p0, Landroid/support/v7/graphics/ColorCutQuantizer;->mQuantizedColors:Ljava/util/List;
