...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/media/SystemMediaRouteProvider$SyncCallback;)V
    ...
    .line 262
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/media/SystemMediaRouteProvider;-><init>(Landroid/content/Context;)V
    ...
    .line 264
    invoke-static/range {p1 .. p1}, Landroid/support/v7/media/MediaRouterJellybean;->getMediaRouter(Landroid/content/Context;)Ljava/lang/Object;
    ...
    .line 265
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->createCallbackObj()Ljava/lang/Object;
    ...
    .line 266
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->createVolumeCallbackObj()Ljava/lang/Object;
    ...
    .line 272
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->updateSystemRoutes()V
...
.method private addSystemRouteNoPublish(Ljava/lang/Object;)Z
    ...
    .line 332
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->getUserRouteRecord(Ljava/lang/Object;)Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$UserRouteRecord;
    ...
    .line 333
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->findSystemRouteRecord(Ljava/lang/Object;)I
    ...
    .line 334
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->assignRouteId(Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 337
    iget-object p0, p0, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->mSystemRouteRecords:Ljava/util/ArrayList;
...
.method private assignRouteId(Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 347
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->getDefaultRoute()Ljava/lang/Object;
    ...
    .line 349
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->getRouteName(Ljava/lang/Object;)Ljava/lang/String;
...
.method private updateSystemRoutes()V
    ...
    .line 321
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->updateCallback()V

    .line 323
    iget-object v0, p0, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->mRouterObj:Ljava/lang/Object;

    invoke-static/range {v0 .. v0}, Landroid/support/v7/media/MediaRouterJellybean;->getRoutes(Ljava/lang/Object;)Ljava/util/List;
    ...
    .line 327
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->publishRoutes()V
...
.method protected createCallbackObj()Ljava/lang/Object;
    ...
    .line 646
    invoke-static/range {p0 .. p0}, Landroid/support/v7/media/MediaRouterJellybean;->createCallback(Landroid/support/v7/media/MediaRouterJellybean$Callback;)Ljava/lang/Object;
...
.method protected createVolumeCallbackObj()Ljava/lang/Object;
    ...
    .line 650
    invoke-static/range {p0 .. p0}, Landroid/support/v7/media/MediaRouterJellybean;->createVolumeCallback(Landroid/support/v7/media/MediaRouterJellybean$VolumeCallback;)Ljava/lang/Object;
...
.method protected getDefaultRoute()Ljava/lang/Object;
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/media/MediaRouterJellybean$GetDefaultRouteWorkaround;-><init>()V
    ...
    iget-object p0, p0, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->mRouterObj:Ljava/lang/Object;

    invoke-virtual {v0, p0}, Landroid/support/v7/media/MediaRouterJellybean$GetDefaultRouteWorkaround;->getDefaultRoute(Ljava/lang/Object;)Ljava/lang/Object;
...
.method protected getRouteName(Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 591
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->getContext()Landroid/content/Context;

    move-result-object p0

    invoke-static {p1, p0}, Landroid/support/v7/media/MediaRouterJellybean$RouteInfo;->getName(Ljava/lang/Object;Landroid/content/Context;)Ljava/lang/CharSequence;
...
.method protected getSystemRoute(Landroid/support/v7/media/MediaRouter$RouteInfo;)Ljava/lang/Object;
    ...
    .line 674
    :cond_0
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getDescriptorId()Ljava/lang/String;
    ...
    check-cast p0, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$SystemRouteRecord;

    iget-object p0, p0, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$SystemRouteRecord;->mRouteObj:Ljava/lang/Object;
...
.method protected getUserRouteRecord(Ljava/lang/Object;)Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$UserRouteRecord;
    ...
    .line 573
    invoke-static/range {p1 .. p1}, Landroid/support/v7/media/MediaRouterJellybean$RouteInfo;->getTag(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    .line 574
    instance-of p1, p0, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$UserRouteRecord;

    if-eqz p1, :cond_0

    check-cast p0, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$UserRouteRecord;
...
.method protected onBuildSystemRouteDescriptor(Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$SystemRouteRecord;Landroid/support/v7/media/MediaRouteDescriptor$Builder;)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v7/media/MediaRouterJellybean$RouteInfo;->getSupportedTypes(Ljava/lang/Object;)I
    ...
    .line 603
    sget-object p0, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->LIVE_VIDEO_CONTROL_FILTERS:Ljava/util/ArrayList;

    invoke-virtual {p2, p0}, Landroid/support/v7/media/MediaRouteDescriptor$Builder;->addControlFilters(Ljava/util/Collection;)Landroid/support/v7/media/MediaRouteDescriptor$Builder;
    ...
    .line 607
    invoke-static/range {p0 .. p0}, Landroid/support/v7/media/MediaRouterJellybean$RouteInfo;->getPlaybackType(Ljava/lang/Object;)I

    move-result p0

    .line 606
    invoke-virtual {p2, p0}, Landroid/support/v7/media/MediaRouteDescriptor$Builder;->setPlaybackType(I)Landroid/support/v7/media/MediaRouteDescriptor$Builder;

    .line 608
    iget-object p0, p1, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$SystemRouteRecord;->mRouteObj:Ljava/lang/Object;

    .line 609
    invoke-static/range {p0 .. p0}, Landroid/support/v7/media/MediaRouterJellybean$RouteInfo;->getPlaybackStream(Ljava/lang/Object;)I

    move-result p0

    .line 608
    invoke-virtual {p2, p0}, Landroid/support/v7/media/MediaRouteDescriptor$Builder;->setPlaybackStream(I)Landroid/support/v7/media/MediaRouteDescriptor$Builder;

    .line 610
    iget-object p0, p1, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$SystemRouteRecord;->mRouteObj:Ljava/lang/Object;

    .line 611
    invoke-static/range {p0 .. p0}, Landroid/support/v7/media/MediaRouterJellybean$RouteInfo;->getVolume(Ljava/lang/Object;)I

    move-result p0

    .line 610
    invoke-virtual {p2, p0}, Landroid/support/v7/media/MediaRouteDescriptor$Builder;->setVolume(I)Landroid/support/v7/media/MediaRouteDescriptor$Builder;

    .line 612
    iget-object p0, p1, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$SystemRouteRecord;->mRouteObj:Ljava/lang/Object;

    .line 613
    invoke-static/range {p0 .. p0}, Landroid/support/v7/media/MediaRouterJellybean$RouteInfo;->getVolumeMax(Ljava/lang/Object;)I

    move-result p0

    .line 612
    invoke-virtual {p2, p0}, Landroid/support/v7/media/MediaRouteDescriptor$Builder;->setVolumeMax(I)Landroid/support/v7/media/MediaRouteDescriptor$Builder;

    .line 614
    iget-object p0, p1, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$SystemRouteRecord;->mRouteObj:Ljava/lang/Object;

    .line 615
    invoke-static/range {p0 .. p0}, Landroid/support/v7/media/MediaRouterJellybean$RouteInfo;->getVolumeHandling(Ljava/lang/Object;)I

    move-result p0

    .line 614
    invoke-virtual {p2, p0}, Landroid/support/v7/media/MediaRouteDescriptor$Builder;->setVolumeHandling(I)Landroid/support/v7/media/MediaRouteDescriptor$Builder;
...
.method public onCreateRouteController(Ljava/lang/String;)Landroid/support/v7/media/MediaRouteProvider$RouteController;
    ...
    .line 277
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->findSystemRouteRecordByDescriptorId(Ljava/lang/String;)I
    ...
    .line 280
    new-instance p1, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$SystemRouteController;

    iget-object p0, p0, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$SystemRouteRecord;->mRouteObj:Ljava/lang/Object;

    invoke-direct {p1, p0}, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$SystemRouteController;-><init>(Ljava/lang/Object;)V
...
.method public onDiscoveryRequestChanged(Landroid/support/v7/media/MediaRouteDiscoveryRequest;)V
    ...
    .line 290
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouteDiscoveryRequest;->getSelector()Landroid/support/v7/media/MediaRouteSelector;

    move-result-object v1

    .line 291
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/media/MediaRouteSelector;->getControlCategories()Ljava/util/List;
    ...
    .line 303
    :cond_2
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouteDiscoveryRequest;->isActiveScan()Z
...
.method public onRouteAdded(Ljava/lang/Object;)V
    ...
    .line 315
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->addSystemRouteNoPublish(Ljava/lang/Object;)Z
...
.method public onRouteSelected(ILjava/lang/Object;)V
    ...
    .line 413
    iget-object p0, p1, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$UserRouteRecord;->mRoute:Landroid/support/v7/media/MediaRouter$RouteInfo;
    ...
    .line 420
    iget-object p0, p0, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->mSyncCallback:Landroid/support/v7/media/SystemMediaRouteProvider$SyncCallback;
    ...
    invoke-interface {p0, p1}, Landroid/support/v7/media/SystemMediaRouteProvider$SyncCallback;->onSystemRouteSelectedByDescriptorId(Ljava/lang/String;)V
...
.method public onRouteVolumeChanged(Ljava/lang/Object;)V
    ...
    .line 390
    invoke-static/range {p1 .. p1}, Landroid/support/v7/media/MediaRouterJellybean$RouteInfo;->getVolume(Ljava/lang/Object;)I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/media/MediaRouteDescriptor;->getVolume()I
...
.method public onSyncRouteAdded(Landroid/support/v7/media/MediaRouter$RouteInfo;)V
    ...
    invoke-static {p0, v0}, Landroid/support/v7/media/MediaRouterJellybean;->addUserRoute(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    .line 477
    iget-object p0, p0, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$SystemRouteRecord;->mRouteDescriptorId:Ljava/lang/String;
    ...
    .line 478
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->select()V
...
.method public onSyncRouteChanged(Landroid/support/v7/media/MediaRouter$RouteInfo;)V
    ...
    .line 500
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->findUserRouteRecord(Landroid/support/v7/media/MediaRouter$RouteInfo;)I
...
.method public onSyncRouteRemoved(Landroid/support/v7/media/MediaRouter$RouteInfo;)V
    ...
    invoke-static {p0, p1}, Landroid/support/v7/media/MediaRouterJellybean;->removeUserRoute(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public onSyncRouteSelected(Landroid/support/v7/media/MediaRouter$RouteInfo;)V
    ...
    .line 510
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->isSelected()Z
...
.method public onVolumeSetRequest(Ljava/lang/Object;I)V
    ...
    .line 445
    iget-object p0, p0, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$UserRouteRecord;->mRoute:Landroid/support/v7/media/MediaRouter$RouteInfo;

    invoke-virtual {p0, p2}, Landroid/support/v7/media/MediaRouter$RouteInfo;->requestSetVolume(I)V
...
.method public onVolumeUpdateRequest(Ljava/lang/Object;I)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/media/MediaRouter$RouteInfo;->requestUpdateVolume(I)V
...
.method protected publishRoutes()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/media/MediaRouteProviderDescriptor$Builder;-><init>()V
    ...
    .line 539
    :cond_0
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouteProviderDescriptor$Builder;->build()Landroid/support/v7/media/MediaRouteProviderDescriptor;
...
.method protected selectRoute(Ljava/lang/Object;)V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/media/MediaRouterJellybean$SelectRouteWorkaround;-><init>()V
    ...
    invoke-virtual {v0, p0, v1, p1}, Landroid/support/v7/media/MediaRouterJellybean$SelectRouteWorkaround;->selectRoute(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method protected updateCallback()V
    ...
    iget-object p0, p0, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl;->mCallbackObj:Ljava/lang/Object;

    invoke-static {v0, v1, p0}, Landroid/support/v7/media/MediaRouterJellybean;->addCallback(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method protected updateSystemRouteDescriptor(Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$SystemRouteRecord;)V
    ...
    .line 583
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouteDescriptor$Builder;->build()Landroid/support/v7/media/MediaRouteDescriptor;

    move-result-object p0

    iput-object p0, p1, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$SystemRouteRecord;->mRouteDescriptor:Landroid/support/v7/media/MediaRouteDescriptor;
...
.method protected updateUserRouteProperties(Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$UserRouteRecord;)V
    ...
    .line 619
    iget-object p0, p1, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$UserRouteRecord;->mRouteObj:Ljava/lang/Object;

    iget-object v0, p1, Landroid/support/v7/media/SystemMediaRouteProvider$JellybeanImpl$UserRouteRecord;->mRoute:Landroid/support/v7/media/MediaRouter$RouteInfo;

    .line 620
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getName()Ljava/lang/String;

    move-result-object v0

    .line 619
    invoke-static {p0, v0}, Landroid/support/v7/media/MediaRouterJellybean$UserRouteInfo;->setName(Ljava/lang/Object;Ljava/lang/CharSequence;)V
    ...
    .line 622
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getPlaybackType()I

    move-result v0

    .line 621
    invoke-static {p0, v0}, Landroid/support/v7/media/MediaRouterJellybean$UserRouteInfo;->setPlaybackType(Ljava/lang/Object;I)V
    ...
    .line 624
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getPlaybackStream()I

    move-result v0

    .line 623
    invoke-static {p0, v0}, Landroid/support/v7/media/MediaRouterJellybean$UserRouteInfo;->setPlaybackStream(Ljava/lang/Object;I)V
    ...
    .line 626
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getVolume()I

    move-result v0

    .line 625
    invoke-static {p0, v0}, Landroid/support/v7/media/MediaRouterJellybean$UserRouteInfo;->setVolume(Ljava/lang/Object;I)V
    ...
    .line 628
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getVolumeMax()I

    move-result v0

    .line 627
    invoke-static {p0, v0}, Landroid/support/v7/media/MediaRouterJellybean$UserRouteInfo;->setVolumeMax(Ljava/lang/Object;I)V
    ...
    .line 630
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/media/MediaRouter$RouteInfo;->getVolumeHandling()I

    move-result p1

    .line 629
    invoke-static {p0, p1}, Landroid/support/v7/media/MediaRouterJellybean$UserRouteInfo;->setVolumeHandling(Ljava/lang/Object;I)V
