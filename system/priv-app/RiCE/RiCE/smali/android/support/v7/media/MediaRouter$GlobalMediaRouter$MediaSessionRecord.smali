...
.method public configureVolume(III)V
    ...
    .line 2782
    iget-object p0, p0, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter$MediaSessionRecord;->mVpCompat:Landroid/support/v4/media/VolumeProviderCompat;

    invoke-virtual {p0, p3}, Landroid/support/v4/media/VolumeProviderCompat;->setCurrentVolume(I)V
    ...
    invoke-virtual {p1, p0}, Landroid/support/v4/media/session/MediaSessionCompat;->setPlaybackToRemote(Landroid/support/v4/media/VolumeProviderCompat;)V
...
.method public getToken()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    .line 2820
    iget-object p0, p0, Landroid/support/v7/media/MediaRouter$GlobalMediaRouter$MediaSessionRecord;->mMsCompat:Landroid/support/v4/media/session/MediaSessionCompat;
