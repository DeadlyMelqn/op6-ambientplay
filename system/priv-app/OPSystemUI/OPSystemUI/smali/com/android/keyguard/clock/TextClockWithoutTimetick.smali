...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/keyguard/clock/TextClockWithoutTimetick$1;,
        Lcom/android/keyguard/clock/TextClockWithoutTimetick$2;,
        Lcom/android/keyguard/clock/TextClockWithoutTimetick$3;,
...
# direct methods
.method static synthetic -get0(Lcom/android/keyguard/clock/TextClockWithoutTimetick;)Ljava/lang/Runnable;
    .locals 1
    .param p0, "-this"    # Lcom/android/keyguard/clock/TextClockWithoutTimetick;
...
.method static synthetic -get1(Lcom/android/keyguard/clock/TextClockWithoutTimetick;)Ljava/lang/String;
    .locals 1
    .param p0, "-this"    # Lcom/android/keyguard/clock/TextClockWithoutTimetick;
...
.method static synthetic -wrap0(Lcom/android/keyguard/clock/TextClockWithoutTimetick;)V
    .locals 0
    .param p0, "-this"    # Lcom/android/keyguard/clock/TextClockWithoutTimetick;
...
.method static synthetic -wrap1(Lcom/android/keyguard/clock/TextClockWithoutTimetick;Ljava/lang/String;)V
    .locals 0
    .param p0, "-this"    # Lcom/android/keyguard/clock/TextClockWithoutTimetick;
...
.method static synthetic -wrap2(Lcom/android/keyguard/clock/TextClockWithoutTimetick;)V
    .locals 0
    .param p0, "-this"    # Lcom/android/keyguard/clock/TextClockWithoutTimetick;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 163
    new-instance v1, Lcom/android/keyguard/clock/TextClockWithoutTimetick$1;

    invoke-direct {v1, p0}, Lcom/android/keyguard/clock/TextClockWithoutTimetick$1;-><init>(Lcom/android/keyguard/clock/TextClockWithoutTimetick;)V

    iput-object v1, p0, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->mIntentReceiver:Landroid/content/BroadcastReceiver;

    .line 174
    new-instance v1, Lcom/android/keyguard/clock/TextClockWithoutTimetick$2;

    invoke-direct {v1, p0}, Lcom/android/keyguard/clock/TextClockWithoutTimetick$2;-><init>(Lcom/android/keyguard/clock/TextClockWithoutTimetick;)V

    iput-object v1, p0, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->mTicker:Ljava/lang/Runnable;

    .line 554
    new-instance v1, Lcom/android/keyguard/clock/TextClockWithoutTimetick$3;

    invoke-direct {v1, p0}, Lcom/android/keyguard/clock/TextClockWithoutTimetick$3;-><init>(Lcom/android/keyguard/clock/TextClockWithoutTimetick;)V

    iput-object v1, p0, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->mMonitorCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
...
.method private chooseFormat(Z)V
    ...
    iget-object v4, p0, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->mFormat12:Ljava/lang/CharSequence;

    iget-object v5, v2, Llibcore/icu/LocaleData;->timeFormat_Hm:Ljava/lang/String;

    invoke-static {v3, v4, v5}, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->abc(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v3

    iput-object v3, p0, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->mFormat:Ljava/lang/CharSequence;

    .line 498
    iget-object v3, p0, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->mDescFormat24:Ljava/lang/CharSequence;

    iget-object v4, p0, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->mDescFormat12:Ljava/lang/CharSequence;

    iget-object v5, p0, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->mFormat:Ljava/lang/CharSequence;

    invoke-static {v3, v4, v5}, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->abc(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v3

    iput-object v3, p0, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->mDescFormat:Ljava/lang/CharSequence;

    .line 504
    :goto_0
    iget-boolean v1, p0, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->mHasSeconds:Z
    ...
    iget-object v4, p0, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->mFormat24:Ljava/lang/CharSequence;
    ...
    iget-object v4, p0, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->mDescFormat24:Ljava/lang/CharSequence;
...
.method private init()V
    ...
    :cond_2
    iget-object v1, p0, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->mTimeZone:Ljava/lang/String;

    invoke-direct {p0, v1}, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->createTime(Ljava/lang/String;)V

    .line 257
    const/4 v1, 0x0

    invoke-direct {p0, v1}, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->chooseFormat(Z)V
...
.method private registerObserver()V
    ...
    .line 588
    new-instance v1, Lcom/android/keyguard/clock/TextClockWithoutTimetick$FormatChangeObserver;

    invoke-virtual {p0}, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->getHandler()Landroid/os/Handler;

    move-result-object v2

    invoke-direct {v1, p0, v2}, Lcom/android/keyguard/clock/TextClockWithoutTimetick$FormatChangeObserver;-><init>(Lcom/android/keyguard/clock/TextClockWithoutTimetick;Landroid/os/Handler;)V

    iput-object v1, p0, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->mFormatChangeObserver:Landroid/database/ContentObserver;
    ...
    .line 593
    iget-object v2, p0, Lcom/android/keyguard/clock/TextClockWithoutTimetick;->mFormatChangeObserver:Landroid/database/ContentObserver;
