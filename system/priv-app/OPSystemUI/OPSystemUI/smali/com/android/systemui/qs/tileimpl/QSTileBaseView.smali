...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/plugins/qs/QSIconView;Z)V
    ...
    .line 41
    new-instance v4, Lcom/android/systemui/qs/tileimpl/QSTileBaseView$H;

    invoke-direct {v4, p0}, Lcom/android/systemui/qs/tileimpl/QSTileBaseView$H;-><init>(Lcom/android/systemui/qs/tileimpl/QSTileBaseView;)V

    iput-object v4, p0, Lcom/android/systemui/qs/tileimpl/QSTileBaseView;->mHandler:Lcom/android/systemui/qs/tileimpl/QSTileBaseView$H;
    ...
    iput-object v4, p0, Lcom/android/systemui/qs/tileimpl/QSTileBaseView;->mIconFrame:Landroid/widget/FrameLayout;
    ...
    invoke-virtual {p0, v4, v5}, Lcom/android/systemui/qs/tileimpl/QSTileBaseView;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 77
    iget-object v2, p0, Lcom/android/systemui/qs/tileimpl/QSTileBaseView;->mTileBackground:Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    invoke-virtual {p0, v8}, Lcom/android/systemui/qs/tileimpl/QSTileBaseView;->setImportantForAccessibility(I)V

    .line 83
    iget-object v4, p0, Lcom/android/systemui/qs/tileimpl/QSTileBaseView;->mTileBackground:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p0, v4}, Lcom/android/systemui/qs/tileimpl/QSTileBaseView;->setBackground(Landroid/graphics/drawable/Drawable;)V

    .line 85
    invoke-virtual {p0, v6, v6, v6, v6}, Lcom/android/systemui/qs/tileimpl/QSTileBaseView;->setPadding(IIII)V

    .line 86
    invoke-virtual {p0, v6}, Lcom/android/systemui/qs/tileimpl/QSTileBaseView;->setClipChildren(Z)V

    .line 87
    invoke-virtual {p0, v6}, Lcom/android/systemui/qs/tileimpl/QSTileBaseView;->setClipToPadding(Z)V

    .line 88
    iput-boolean p3, p0, Lcom/android/systemui/qs/tileimpl/QSTileBaseView;->mCollapsedView:Z

    .line 89
    invoke-virtual {p0, v8}, Lcom/android/systemui/qs/tileimpl/QSTileBaseView;->setFocusable(Z)V

    .line 90
    return-void
.end method

.method static synthetic lambda$-com_android_systemui_qs_tileimpl_QSTileBaseView_4620(Lcom/android/systemui/plugins/qs/QSTile;Landroid/view/View;)V
    .locals 0
...
.method static synthetic lambda$-com_android_systemui_qs_tileimpl_QSTileBaseView_4639(Lcom/android/systemui/plugins/qs/QSTile;Landroid/view/View;)V
    .locals 0
    .param p0, "tile"    # Lcom/android/systemui/plugins/qs/QSTile;
    .param p1, "v"    # Landroid/view/View;
...
.method static synthetic lambda$-com_android_systemui_qs_tileimpl_QSTileBaseView_4667(Lcom/android/systemui/plugins/qs/QSTile;Landroid/view/View;)Z
    .locals 1
    .param p0, "tile"    # Lcom/android/systemui/plugins/qs/QSTile;
...
.method public init(Lcom/android/systemui/plugins/qs/QSTile;)V
    ...
    invoke-direct {v0, v1, p1}, Lcom/android/systemui/qs/tileimpl/-$Lambda$HWR9Y5oviVQDQwcpVJqL0gX3vIE;-><init>(BLjava/lang/Object;)V

    new-instance v1, Lcom/android/systemui/qs/tileimpl/-$Lambda$HWR9Y5oviVQDQwcpVJqL0gX3vIE;

    const/4 v2, 0x1

    invoke-direct {v1, v2, p1}, Lcom/android/systemui/qs/tileimpl/-$Lambda$HWR9Y5oviVQDQwcpVJqL0gX3vIE;-><init>(BLjava/lang/Object;)V

    new-instance v2, Lcom/android/systemui/qs/tileimpl/-$Lambda$HWR9Y5oviVQDQwcpVJqL0gX3vIE$1;

    invoke-direct {v2, p1}, Lcom/android/systemui/qs/tileimpl/-$Lambda$HWR9Y5oviVQDQwcpVJqL0gX3vIE$1;-><init>(Ljava/lang/Object;)V
