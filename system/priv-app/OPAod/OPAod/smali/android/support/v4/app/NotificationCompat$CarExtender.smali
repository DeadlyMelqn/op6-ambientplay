...
.method private static getUnreadConversationFromBundle(Landroid/os/Bundle;)Landroid/support/v4/app/NotificationCompat$CarExtender$UnreadConversation;
    ...
    .line 4168
    .local v16, "parcelableMessages":[Landroid/os/Parcelable;
    const/4 v13, 0x0

    .line 4169
    .local v13, "messages":[Ljava/lang/String;
    if-eqz v16, :cond_2
    ...
    .line 4190
    .end local v12    # "i":I
    .end local v13    # "messages":[Ljava/lang/String;
    ...
    .line 4191
    .local v14, "onRead":Landroid/app/PendingIntent;
    ...
    .line 4193
    .local v15, "onReply":Landroid/app/PendingIntent;
    ...
    check-cast v17, Landroid/app/RemoteInput;

    .line 4195
    .local v17, "remoteInput":Landroid/app/RemoteInput;
    ...
    .line 4177
    .end local v9    # "participants":[Ljava/lang/String;
    .end local v14    # "onRead":Landroid/app/PendingIntent;
    .end local v15    # "onReply":Landroid/app/PendingIntent;
    .end local v17    # "remoteInput":Landroid/app/RemoteInput;
    .restart local v12    # "i":I
    .restart local v13    # "messages":[Ljava/lang/String;
    .restart local v18    # "success":Z
    .restart local v19    # "tmp":[Ljava/lang/String;
    :cond_4
    aget-object v3, v16, v12
    ...
    .end local v18    # "success":Z
    .end local v19    # "tmp":[Ljava/lang/String;
    .restart local v9    # "participants":[Ljava/lang/String;
    .restart local v14    # "onRead":Landroid/app/PendingIntent;
    .restart local v15    # "onReply":Landroid/app/PendingIntent;
    .restart local v17    # "remoteInput":Landroid/app/RemoteInput;
    :cond_7
    if-eqz v17, :cond_8
    ...
    .line 4209
    :goto_2
    new-instance v4, Landroid/support/v4/app/NotificationCompat$CarExtender$UnreadConversation;
    ...
    .local v2, "remoteInputCompat":Landroid/support/v4/app/RemoteInput;
    goto :goto_2
.end method
