...
.method private fadeImageAlpha(Landroid/widget/ImageView;ZJ)V
    ...
    .prologue
    .line 71
    new-instance v2, Lcom/oneplus/doze/-$Lambda$P2LRqI0oamewV800DteElZkN1xk;

    const/4 v0, 0x0

    invoke-direct {v2, v0, p0, p1}, Lcom/oneplus/doze/-$Lambda$P2LRqI0oamewV800DteElZkN1xk;-><init>(BLjava/lang/Object;Ljava/lang/Object;)V
    ...
    .line 71
    invoke-virtual/range {v1 .. v6}, Lcom/oneplus/doze/NotificationIconDozeHelper;->startIntensityAnimation(Landroid/animation/ValueAnimator$AnimatorUpdateListener;ZJLandroid/animation/Animator$AnimatorListener;)V
...
.method private updateImageColorFilter(Landroid/widget/ImageView;F)V
    ...
    .line 82
    iget v3, p0, Lcom/oneplus/doze/NotificationIconDozeHelper;->mColor:I

    const/4 v4, -0x1

    invoke-static {v3, v4, p2}, Lcom/oneplus/doze/NotificationUtils;->interpolateColors(IIF)I
...
# virtual methods
.method synthetic lambda$-com_oneplus_doze_NotificationIconDozeHelper_2254(Landroid/widget/ImageView;Landroid/animation/ValueAnimator;)V
    .locals 1
    .param p1, "target"    # Landroid/widget/ImageView;
...
.method synthetic lambda$-com_oneplus_doze_NotificationIconDozeHelper_2520(Landroid/widget/ImageView;Landroid/animation/ValueAnimator;)V
    .locals 3
    .param p1, "target"    # Landroid/widget/ImageView;
    .param p2, "animation"    # Landroid/animation/ValueAnimator;
    ...
    iget v2, p0, Lcom/oneplus/doze/NotificationIconDozeHelper;->mImageDarkAlpha:I
