...
.method static synthetic -get0(Lcom/android/settings/location/LocationSettings;)Lcom/android/settings/location/SettingsInjector;
    .locals 1
    .param p0, "-this"    # Lcom/android/settings/location/LocationSettings;
...
.method static synthetic -get2(Lcom/android/settings/location/LocationSettings;)Lcom/oneplus/settings/ui/OPRestrictedSwitchPreference;
    .locals 1
    .param p0, "-this"    # Lcom/android/settings/location/LocationSettings;

    .prologue
    iget-object v0, p0, Lcom/android/settings/location/LocationSettings;->mManagedProfileSwitch:Lcom/oneplus/settings/ui/OPRestrictedSwitchPreference;
...
.method static synthetic -wrap0(Lcom/android/settings/location/LocationSettings;)Landroid/support/v7/preference/PreferenceScreen;
    .locals 1
    .param p0, "-this"    # Lcom/android/settings/location/LocationSettings;
...
.method static synthetic -wrap2(Lcom/android/settings/location/LocationSettings;Lcom/android/settingslib/applications/ApplicationsState$AppEntry;Lcom/oneplus/settings/ui/OPButtonPreference;)V
    .locals 0
    .param p0, "-this"    # Lcom/android/settings/location/LocationSettings;
    ...
    .prologue
    invoke-direct {p0, p1, p2}, Lcom/android/settings/location/LocationSettings;->forceStopPackage(Lcom/android/settingslib/applications/ApplicationsState$AppEntry;Lcom/oneplus/settings/ui/OPButtonPreference;)V
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/location/LocationSettings;->mCheckKillProcessesReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, Lcom/android/settings/location/LocationSettings;->mHighPowerChangeReceiver:Landroid/content/BroadcastReceiver;
...
.method private addLocationServices(Landroid/content/Context;Landroid/support/v7/preference/PreferenceScreen;Z)V
    ...
    new-instance v3, Lcom/android/settings/location/LocationSettings$8;

    invoke-direct {v3, p0}, Lcom/android/settings/location/LocationSettings$8;-><init>(Lcom/android/settings/location/LocationSettings;)V
    ...
    .line 504
    iget-object v3, p0, Lcom/android/settings/location/LocationSettings;->mOPPreferenceDivider:Lcom/oneplus/settings/ui/OPPreferenceDivider;
...
.method private addPreferencesSorted(Ljava/util/List;Landroid/support/v7/preference/PreferenceGroup;)V
    ...
    new-instance v2, Lcom/android/settings/location/LocationSettings$5;

    invoke-direct {v2, p0}, Lcom/android/settings/location/LocationSettings$5;-><init>(Lcom/android/settings/location/LocationSettings;)V
...
.method private changeManagedProfileLocationAccessStatus(Z)V
    ...
    .line 442
    iget-object v4, p0, Lcom/android/settings/location/LocationSettings;->mManagedProfileSwitch:Lcom/oneplus/settings/ui/OPRestrictedSwitchPreference;
    ...
    invoke-virtual {v4, v7}, Lcom/oneplus/settings/ui/OPRestrictedSwitchPreference;->setChecked(Z)V
    ...
    invoke-virtual {v4, p1}, Lcom/oneplus/settings/ui/OPRestrictedSwitchPreference;->setEnabled(Z)V
    ...
    invoke-virtual {v4, v5}, Lcom/oneplus/settings/ui/OPRestrictedSwitchPreference;->setChecked(Z)V
...
.method private createPreferenceHierarchy()Landroid/support/v7/preference/PreferenceScreen;
    ...
    iput-object v0, v1, Lcom/android/settings/location/LocationSettings;->mLocationMode:Landroid/support/v7/preference/Preference;

    .line 235
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings/location/LocationSettings;->mLocationMode:Landroid/support/v7/preference/Preference;

    move-object/from16 v20, v0

    .line 236
    new-instance v21, Lcom/android/settings/location/LocationSettings$6;

    move-object/from16 v0, v21

    move-object/from16 v1, p0

    invoke-direct {v0, v1, v4}, Lcom/android/settings/location/LocationSettings$6;-><init>(Lcom/android/settings/location/LocationSettings;Lcom/android/settings/SettingsActivity;)V
    ...
    iput-object v0, v1, Lcom/android/settings/location/LocationSettings;->mOPPreferenceDivider:Lcom/oneplus/settings/ui/OPPreferenceDivider;

    .line 252
    new-instance v13, Lcom/android/settingslib/location/RecentLocationApps;

    invoke-direct {v13, v4}, Lcom/android/settingslib/location/RecentLocationApps;-><init>(Landroid/content/Context;)V

    .line 255
    .local v13, "recentApps":Lcom/android/settingslib/location/RecentLocationApps;
    invoke-direct/range {p0 .. p0}, Lcom/android/settings/location/LocationSettings;->getCurrentUsingGpsListForUid()Ljava/util/List;
    ...
    .line 259
    invoke-virtual {v13}, Lcom/android/settingslib/location/RecentLocationApps;->getAppList()Ljava/util/List;

    move-result-object v15

    .line 260
    .local v15, "recentLocationRequests":Ljava/util/List;, "Ljava/util/List<Lcom/android/settingslib/location/RecentLocationApps$Request;>;"
    ...
    check-cast v16, Lcom/android/settingslib/location/RecentLocationApps$Request;

    .line 262
    .local v16, "request":Lcom/android/settingslib/location/RecentLocationApps$Request;
    const-string/jumbo v20, "LocationSettings"
    ...
    iget v0, v0, Lcom/android/settingslib/location/RecentLocationApps$Request;->uid:I
    ...
    iget-object v0, v0, Lcom/android/settingslib/location/RecentLocationApps$Request;->icon:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, v0, Lcom/android/settingslib/location/RecentLocationApps$Request;->label:Ljava/lang/CharSequence;
    ...
    iget-object v0, v0, Lcom/android/settingslib/location/RecentLocationApps$Request;->userHandle:Landroid/os/UserHandle;
    ...
    iget-object v0, v0, Lcom/android/settings/location/LocationSettings;->mState:Lcom/android/settingslib/applications/ApplicationsState;

    move-object/from16 v20, v0

    move-object/from16 v0, v16

    iget-object v0, v0, Lcom/android/settingslib/location/RecentLocationApps$Request;->packageName:Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/android/settings/location/LocationSettings;->mDpm:Landroid/app/admin/DevicePolicyManager;
    ...
    :goto_1
    new-instance v20, Lcom/android/settings/location/LocationSettings$PackageEntryClickedListener;
    ...
    .line 282
    .restart local v5    # "appEntry":Lcom/android/settingslib/applications/ApplicationsState$AppEntry;
    .restart local v10    # "mAppsControlDisallowedBySystem":Z
    .restart local v11    # "packageHasActiveAdmins":Z
    .restart local v19    # "userId":I
    :cond_2
    const v20, 0x7f0f0405
    ...
    .line 285
    const v20, 0x7f0f0404

    move-object/from16 v0, p0

    move/from16 v1, v20

    invoke-virtual {v0, v1}, Lcom/android/settings/location/LocationSettings;->getString(I)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v5, v12}, Lcom/android/settings/location/LocationSettings$7;-><init>(Lcom/android/settings/location/LocationSettings;Lcom/android/settingslib/applications/ApplicationsState$AppEntry;Lcom/oneplus/settings/ui/OPButtonPreference;)V
    ...
    .end local v16    # "request":Lcom/android/settingslib/location/RecentLocationApps$Request;
    :cond_4
    invoke-interface {v15}, Ljava/util/List;->size()I
    ...
    invoke-direct {v0, v14, v1}, Lcom/android/settings/location/LocationSettings;->addPreferencesSorted(Ljava/util/List;Landroid/support/v7/preference/PreferenceGroup;)V
...
.method private forceStopPackage(Lcom/android/settingslib/applications/ApplicationsState$AppEntry;Lcom/oneplus/settings/ui/OPButtonPreference;)V
    .locals 7
    .param p1, "mAppEntry"    # Lcom/android/settingslib/applications/ApplicationsState$AppEntry;
    .param p2, "pref"    # Lcom/oneplus/settings/ui/OPButtonPreference;
    ...
    .line 379
    iget-object v4, p0, Lcom/android/settings/location/LocationSettings;->mState:Lcom/android/settingslib/applications/ApplicationsState;

    invoke-virtual {v4, v2, v3}, Lcom/android/settingslib/applications/ApplicationsState;->invalidatePackage(Ljava/lang/String;I)V

    .line 380
    iget-object v4, p0, Lcom/android/settings/location/LocationSettings;->mState:Lcom/android/settingslib/applications/ApplicationsState;

    invoke-virtual {v4, v2, v3}, Lcom/android/settingslib/applications/ApplicationsState;->getEntry(Ljava/lang/String;I)Lcom/android/settingslib/applications/ApplicationsState$AppEntry;

    move-result-object v1

    .line 381
    .local v1, "newEnt":Lcom/android/settingslib/applications/ApplicationsState$AppEntry;
    invoke-virtual {p0, v1, p2}, Lcom/android/settings/location/LocationSettings;->checkForceStop(Lcom/android/settingslib/applications/ApplicationsState$AppEntry;Lcom/oneplus/settings/ui/OPButtonPreference;)V
...
.method private getCurrentUsingGpsList()Ljava/util/List;
    ...
    iget-object v5, p0, Lcom/android/settings/location/LocationSettings;->mLocationManager:Landroid/location/LocationManager;
...
.method private setupManagedProfileCategory(Landroid/support/v7/preference/PreferenceScreen;)V
    ...
    .line 433
    iput-object v1, p0, Lcom/android/settings/location/LocationSettings;->mManagedProfileSwitch:Lcom/oneplus/settings/ui/OPRestrictedSwitchPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/location/LocationSettings;->mManagedProfileSwitch:Lcom/oneplus/settings/ui/OPRestrictedSwitchPreference;
...
.method public checkForceStop(Lcom/android/settingslib/applications/ApplicationsState$AppEntry;Lcom/oneplus/settings/ui/OPButtonPreference;)V
    ...
    iget-object v4, p0, Lcom/android/settings/location/LocationSettings;->mCheckKillProcessesReceiver:Landroid/content/BroadcastReceiver;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iput-object v1, p0, Lcom/android/settings/location/LocationSettings;->mState:Lcom/android/settingslib/applications/ApplicationsState;
    ...
    iput-object v1, p0, Lcom/android/settings/location/LocationSettings;->mDpm:Landroid/app/admin/DevicePolicyManager;
    ...
    iput-object v1, p0, Lcom/android/settings/location/LocationSettings;->mLocationManager:Landroid/location/LocationManager;
    ...
    iput-object v1, p0, Lcom/android/settings/location/LocationSettings;->mIntentFilter:Landroid/content/IntentFilter;
...
.method public onModeChanged(IZ)V
    ...
    .line 560
    iget-object v5, p0, Lcom/android/settings/location/LocationSettings;->mLocationMode:Landroid/support/v7/preference/Preference;

    invoke-virtual {v5, v3}, Landroid/support/v7/preference/Preference;->setSummary(I)V
    ...
    invoke-virtual {v5, v0}, Lcom/android/settings/widget/SwitchBar;->setDisabledByAdmin(Lcom/android/settingslib/RestrictedLockUtils$EnforcedAdmin;)V
    ...
    :cond_1
    invoke-virtual {v5, v4}, Landroid/support/v7/preference/Preference;->setEnabled(Z)V
...
.method public onPause()V
    ...
    iget-object v3, p0, Lcom/android/settings/location/LocationSettings;->mHighPowerChangeReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-boolean v2, p0, Lcom/android/settings/location/LocationSettings;->mValidListener:Z
...
.method public onResume()V
    ...
    iget-object v1, p0, Lcom/android/settings/location/LocationSettings;->mHighPowerChangeReceiver:Landroid/content/BroadcastReceiver;
