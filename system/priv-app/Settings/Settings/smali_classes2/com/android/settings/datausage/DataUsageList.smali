...
.method static synthetic -get0(Lcom/android/settings/datausage/DataUsageList;)Landroid/support/v7/preference/PreferenceGroup;
    .locals 1
    .param p0, "-this"    # Lcom/android/settings/datausage/DataUsageList;
...
.method static synthetic -get10(Lcom/android/settings/datausage/DataUsageList;)I
    .locals 1
    .param p0, "-this"    # Lcom/android/settings/datausage/DataUsageList;
...
.method static synthetic -get11(Lcom/android/settings/datausage/DataUsageList;)Landroid/net/NetworkTemplate;
    .locals 1
    .param p0, "-this"    # Lcom/android/settings/datausage/DataUsageList;
...
.method static synthetic -get12(Lcom/android/settings/datausage/DataUsageList;)Landroid/support/v7/preference/Preference;
    .locals 1
    .param p0, "-this"    # Lcom/android/settings/datausage/DataUsageList;
...
.method static synthetic -wrap0(Lcom/android/settings/datausage/DataUsageList;)Landroid/content/Context;
    .locals 1
    .param p0, "-this"    # Lcom/android/settings/datausage/DataUsageList;
...
.method static synthetic -wrap2(Lcom/android/settings/datausage/DataUsageList;J)V
    .locals 1
    .param p0, "-this"    # Lcom/android/settings/datausage/DataUsageList;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/datausage/DataUsageList;->mExecutor:Ljava/util/concurrent/ExecutorService;
...
.method private updateBody()V
    ...
    iput-boolean v5, p0, Lcom/android/settings/datausage/DataUsageList;->mBinding:Z
    ...
    .line 319
    iget-object v6, p0, Lcom/android/settings/datausage/DataUsageList;->mTemplate:Landroid/net/NetworkTemplate;

    const/4 v7, 0x0

    invoke-static {v6, v7}, Lcom/android/settingslib/net/ChartDataLoader;->buildArgs(Landroid/net/NetworkTemplate;Lcom/android/settingslib/AppItem;)Landroid/os/Bundle;

    move-result-object v6

    iget-object v7, p0, Lcom/android/settings/datausage/DataUsageList;->mChartDataCallbacks:Landroid/app/LoaderManager$LoaderCallbacks;
    ...
    .line 329
    iget-boolean v5, p0, Lcom/android/settings/datausage/DataUsageList;->mDataSelectionEnable:Z
    ...
    .line 332
    iget-object v5, p0, Lcom/android/settings/datausage/DataUsageList;->services:Lcom/android/settings/datausage/TemplatePreference$NetworkServices;
    ...
    .line 333
    iget v6, p0, Lcom/android/settings/datausage/DataUsageList;->mSubId:I
    ...
    iget-object v5, p0, Lcom/android/settings/datausage/DataUsageList;->mChart:Lcom/android/settings/datausage/ChartDataUsagePreference;

    invoke-virtual {v5, v3, v2}, Lcom/android/settings/datausage/ChartDataUsagePreference;->setColors(II)V

    .line 343
    .end local v2    # "secondaryColor":I
    .end local v3    # "seriesColor":I
    :cond_2
    iget-boolean v5, p0, Lcom/android/settings/datausage/DataUsageList;->mShowDataUsage:Z
    ...
    iget-object v6, p0, Lcom/android/settings/datausage/DataUsageList;->mUsageSummary:Landroid/support/v7/preference/Preference;
...
.method private updatePolicy(Z)V
    ...
    .line 356
    iget-boolean v2, p0, Lcom/android/settings/datausage/DataUsageList;->mDataSelectionEnable:Z

    if-eqz v2, :cond_1

    .line 357
    iget-object v2, p0, Lcom/android/settings/datausage/DataUsageList;->mChartDeprecated:Lcom/android/settings/datausage/ChartDataUsageDeprecatedPreference;

    invoke-virtual {v2, v1}, Lcom/android/settings/datausage/ChartDataUsageDeprecatedPreference;->bindNetworkPolicy(Landroid/net/NetworkPolicy;)V
    ...
    invoke-virtual {v2, v3, v8, v9}, Lcom/android/settingslib/NetworkPolicyEditor;->setPolicyLimitBytes(Landroid/net/NetworkTemplate;J)V
    ...
    invoke-virtual {v2, v6}, Lcom/android/settings/datausage/ChartDataUsageDeprecatedPreference;->bindNetworkPolicy(Landroid/net/NetworkPolicy;)V
    ...
    invoke-virtual {v2, v6}, Lcom/android/settings/datausage/ChartDataUsagePreference;->setNetworkPolicy(Landroid/net/NetworkPolicy;)V
...
.method public bindStats(Landroid/net/NetworkStats;[I)V
    ...
    .line 501
    invoke-static/range {v33 .. v33}, Lcom/android/settingslib/net/UidDetailProvider;->buildKeyForUser(I)I
    ...
    check-cast v24, Lcom/android/settingslib/AppItem;

    .line 543
    .local v24, "item":Lcom/android/settingslib/AppItem;
    if-nez v24, :cond_b

    .line 544
    new-instance v24, Lcom/android/settingslib/AppItem;

    .end local v24    # "item":Lcom/android/settingslib/AppItem;
    ...
    .line 545
    .restart local v24    # "item":Lcom/android/settingslib/AppItem;
    ...
    :goto_8
    new-instance v15, Lcom/android/settings/datausage/AppDataUsagePreference;
    ...
    check-cast v17, Lcom/android/settingslib/AppItem;
    ...
    iget-object v0, v0, Lcom/android/settings/datausage/DataUsageList;->mExecutor:Ljava/util/concurrent/ExecutorService;

    move-object/from16 v20, v0

    invoke-direct/range {v15 .. v20}, Lcom/android/settings/datausage/AppDataUsagePreference;-><init>(Landroid/content/Context;Lcom/android/settingslib/AppItem;ILcom/android/settingslib/net/UidDetailProvider;Ljava/util/concurrent/ExecutorService;)V

    .line 559
    .local v15, "preference":Lcom/android/settings/datausage/AppDataUsagePreference;
    move/from16 v0, v22
    ...
    invoke-virtual {v15}, Lcom/android/settings/datausage/AppDataUsagePreference;->getTitle()Ljava/lang/CharSequence;
    ...
    .line 556
    .end local v15    # "preference":Lcom/android/settings/datausage/AppDataUsagePreference;
    ...
    .line 561
    .restart local v15    # "preference":Lcom/android/settings/datausage/AppDataUsagePreference;
    :cond_f
    ...
    invoke-virtual {v15, v6}, Lcom/android/settings/datausage/AppDataUsagePreference;->setOnPreferenceClickListener(Landroid/support/v7/preference/Preference$OnPreferenceClickListener;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v4}, Landroid/net/NetworkTemplate;->isMatchRuleMobile()Z

    move-result v4

    xor-int/lit8 v4, v4, 0x1

    invoke-virtual {v3, v4}, Lcom/android/settings/datausage/ChartDataUsagePreference;->setShowWifi(Z)V
    ...
    invoke-virtual {v3, v4}, Lcom/android/settings/datausage/ChartDataUsagePreference;->setSubId(I)V
    ...
    invoke-virtual {v3, v4}, Lcom/android/settings/datausage/ChartDataUsageDeprecatedPreference;->setShowWifi(Z)V
    ...
    invoke-virtual {v3, v4}, Lcom/android/settings/datausage/ChartDataUsageDeprecatedPreference;->setSubId(I)V
...
.method public onDestroy()V
    ...
    .line 282
    iget-object v0, p0, Lcom/android/settings/datausage/DataUsageList;->mExecutor:Ljava/util/concurrent/ExecutorService;
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings/datausage/DataUsageList;->setPinnedHeaderView(I)Landroid/view/View;

    move-result-object v2

    iput-object v2, p0, Lcom/android/settings/datausage/DataUsageList;->mHeader:Landroid/view/View;
    ...
    iput-object v2, p0, Lcom/android/settings/datausage/DataUsageList;->mCycleSpinner:Landroid/widget/Spinner;
    ...
    iput-object v2, p0, Lcom/android/settings/datausage/DataUsageList;->tv_filter_datetime:Landroid/widget/TextView;
    ...
    invoke-static {v2, v3}, Lcom/android/settings/datausage/OPDataUsageUtils;->getDataUsageSectionTimeMillByAccountDay(Landroid/content/Context;I)[J
    ...
    iget-object v2, p0, Lcom/android/settings/datausage/DataUsageList;->tv_filter_datetime:Landroid/widget/TextView;
    ...
    new-instance v4, Lcom/android/settings/datausage/DataUsageList$5;

    invoke-direct {v4, p0}, Lcom/android/settings/datausage/DataUsageList$5;-><init>(Lcom/android/settings/datausage/DataUsageList;)V

    .line 236
    iget-object v5, p0, Lcom/android/settings/datausage/DataUsageList;->mCycleListener:Landroid/widget/AdapterView$OnItemSelectedListener;

    .line 216
    invoke-direct {v2, v3, v4, v5, v8}, Lcom/android/settings/datausage/CycleAdapter;-><init>(Landroid/content/Context;Lcom/android/settings/datausage/CycleAdapter$SpinnerInterface;Landroid/widget/AdapterView$OnItemSelectedListener;Z)V
    ...
    .line 242
    invoke-virtual {p0, v8, v8}, Lcom/android/settings/datausage/DataUsageList;->setLoading(ZZ)V
