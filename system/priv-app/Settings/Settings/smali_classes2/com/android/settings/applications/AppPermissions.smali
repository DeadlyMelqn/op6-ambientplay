...
.method private getPackageInfo(Ljava/lang/String;)Landroid/content/pm/PackageInfo;
    ...
    .line 52
    :try_start_0
    iget-object v1, p0, Lcom/android/settings/applications/AppPermissions;->mContext:Landroid/content/Context;
...
.method private loadPermissionGroups()V
    ...
    .line 81
    iget-object v11, p0, Lcom/android/settings/applications/AppPermissions;->mGroups:Landroid/util/ArrayMap;

    invoke-virtual {v11}, Landroid/util/ArrayMap;->clear()V

    .line 82
    iget-object v11, p0, Lcom/android/settings/applications/AppPermissions;->mPackageInfo:Landroid/content/pm/PackageInfo;
    ...
    .line 86
    invoke-static {v11}, Lcom/android/settings/applications/AppPermissions;->appSupportsRuntime(Landroid/content/pm/ApplicationInfo;)Z
    ...
    :try_start_0
    iget-object v11, p0, Lcom/android/settings/applications/AppPermissions;->mContext:Landroid/content/Context;
    ...
    check-cast v3, Lcom/android/settings/applications/AppPermissions$PermissionGroup;

    .line 104
    .local v3, "group":Lcom/android/settings/applications/AppPermissions$PermissionGroup;
    if-nez v3, :cond_1

    .line 105
    new-instance v3, Lcom/android/settings/applications/AppPermissions$PermissionGroup;

    .end local v3    # "group":Lcom/android/settings/applications/AppPermissions$PermissionGroup;
    invoke-direct {v3, v14}, Lcom/android/settings/applications/AppPermissions$PermissionGroup;-><init>(Lcom/android/settings/applications/AppPermissions$PermissionGroup;)V

    .line 106
    .restart local v3    # "group":Lcom/android/settings/applications/AppPermissions$PermissionGroup;
    iget-object v11, p0, Lcom/android/settings/applications/AppPermissions;->mGroups:Landroid/util/ArrayMap;
    ...
    .local v2, "granted":Z
    :goto_3
    new-instance v8, Lcom/android/settings/applications/AppPermissions$Permission;

    invoke-direct {v8, v10, v2}, Lcom/android/settings/applications/AppPermissions$Permission;-><init>(ZZ)V

    .line 115
    .local v8, "permission":Lcom/android/settings/applications/AppPermissions$Permission;
    invoke-virtual {v3, v8, v7}, Lcom/android/settings/applications/AppPermissions$PermissionGroup;->addPermission(Lcom/android/settings/applications/AppPermissions$Permission;Ljava/lang/String;)V
    ...
    .end local v8    # "permission":Lcom/android/settings/applications/AppPermissions$Permission;
    ...
    check-cast v11, Lcom/android/settings/applications/AppPermissions$PermissionGroup;

    invoke-static {v11}, Lcom/android/settings/applications/AppPermissions$PermissionGroup;->-get0(Lcom/android/settings/applications/AppPermissions$PermissionGroup;)Z
