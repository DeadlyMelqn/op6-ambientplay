...
# direct methods
.method static synthetic -get0(Lcom/android/settings/applications/AppPermissions$PermissionGroup;)Z
    .locals 1
    .param p0, "-this"    # Lcom/android/settings/applications/AppPermissions$PermissionGroup;
...
.method synthetic constructor <init>(Lcom/android/settings/applications/AppPermissions$PermissionGroup;)V
    .locals 0
    .param p1, "-this0"    # Lcom/android/settings/applications/AppPermissions$PermissionGroup;
...
.method addPermission(Lcom/android/settings/applications/AppPermissions$Permission;Ljava/lang/String;)V
    ...
    .line 154
    invoke-static {p1}, Lcom/android/settings/applications/AppPermissions$Permission;->-get1(Lcom/android/settings/applications/AppPermissions$Permission;)Z
...
.method public areRuntimePermissionsGranted()Z
    ...
    check-cast v1, Lcom/android/settings/applications/AppPermissions$Permission;

    .line 141
    .local v1, "permission":Lcom/android/settings/applications/AppPermissions$Permission;
    invoke-static {v1}, Lcom/android/settings/applications/AppPermissions$Permission;->-get1(Lcom/android/settings/applications/AppPermissions$Permission;)Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-static {v1}, Lcom/android/settings/applications/AppPermissions$Permission;->-get0(Lcom/android/settings/applications/AppPermissions$Permission;)Z
    ...
    .line 145
    .end local v1    # "permission":Lcom/android/settings/applications/AppPermissions$Permission;
    :cond_1
    const/4 v3, 0x1
