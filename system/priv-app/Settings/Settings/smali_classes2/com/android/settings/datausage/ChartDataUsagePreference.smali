...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 51
    iput v4, p0, Lcom/android/settings/datausage/ChartDataUsagePreference;->mSubId:I

    .line 52
    iput-boolean v2, p0, Lcom/android/settings/datausage/ChartDataUsagePreference;->mShowWifi:Z
...
.method private getLabel(JII)Ljava/lang/CharSequence;
    ...
    invoke-static {v2, p1, p2, v6}, Lcom/oneplus/settings/utils/OPFormatter;->formatBytes(Landroid/content/res/Resources;JI)Lcom/oneplus/settings/utils/OPFormatter$BytesResult;

    move-result-object v1

    .line 169
    .local v1, "result":Lcom/oneplus/settings/utils/OPFormatter$BytesResult;
    invoke-virtual {p0}, Lcom/android/settings/datausage/ChartDataUsagePreference;->getContext()Landroid/content/Context;
    ...
    .line 170
    iget-object v4, v1, Lcom/oneplus/settings/utils/OPFormatter$BytesResult;->value:Ljava/lang/String;

    aput-object v4, v3, v5

    iget-object v4, v1, Lcom/oneplus/settings/utils/OPFormatter$BytesResult;->units:Ljava/lang/String;
...
.method public setNetworkPolicy(Landroid/net/NetworkPolicy;)V
    ...
    iget v4, p0, Lcom/android/settings/datausage/ChartDataUsagePreference;->mSubId:I

    invoke-static {v3, v4}, Lcom/android/settings/datausage/OPDataUsageUtils;->getDataWarnState(Landroid/content/Context;I)I
    ...
    invoke-static {v3, v4}, Lcom/android/settings/datausage/OPDataUsageUtils;->getDataWarnBytes(Landroid/content/Context;I)J
