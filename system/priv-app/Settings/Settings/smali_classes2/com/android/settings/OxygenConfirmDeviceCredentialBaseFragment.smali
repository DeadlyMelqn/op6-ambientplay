.class public abstract Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment$1;
    }
.end annotation
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mReturnCredentials:Z
    ...
    iput-object v0, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mHandler:Landroid/os/Handler;

    .line 305
    new-instance v0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment$1;

    invoke-direct {v0, p0}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment$1;-><init>(Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;)V

    iput-object v0, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mResetErrorRunnable:Ljava/lang/Runnable;
...
.method private isFingerprintDisabledByAdmin()Z
    ...
    .line 127
    invoke-virtual {p0}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->getActivity()Landroid/app/Activity;
    ...
    iget v3, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mEffectiveUserId:I
...
.method private isFingerprintDisallowedByStrongAuth()Z
    ...
    .line 138
    iget-object v1, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    iget v2, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mEffectiveUserId:I

    invoke-virtual {v1, v2}, Lcom/android/internal/widget/LockPatternUtils;->isFingerprintAllowedForUser(I)Z
    ...
    iget v2, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mUserId:I

    invoke-virtual {v1, v2}, Landroid/security/KeyStore;->state(I)Landroid/security/KeyStore$State;
...
.method private setWorkChallengeBackground(Landroid/view/View;I)V
    ...
    .line 244
    invoke-virtual {p0}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->getResources()Landroid/content/res/Resources;
...
.method private showDialog(Ljava/lang/String;Ljava/lang/String;IZ)V
    ...
    .line 331
    new-instance v2, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment$3;

    invoke-direct {v2, p0, p4}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment$3;-><init>(Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;Z)V
...
.method protected isProfileChallenge()Z
    ...
    .prologue
    .line 258
    invoke-virtual {p0}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->getContext()Landroid/content/Context;
    ...
    iget v1, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mEffectiveUserId:I
...
.method public onAuthenticated()V
    ...
    .line 191
    invoke-virtual {p0}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->authenticationSucceeded()V

    .line 192
    invoke-virtual {p0}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->checkForPendingIntent()V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v3, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mAllowFpAuthentication:Z
    ...
    iput-boolean v3, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mReturnCredentials:Z
    ...
    iput v3, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mUserId:I
    ...
    iget v3, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mUserId:I

    invoke-virtual {v1, v3}, Landroid/os/UserManager;->getCredentialOwnerProfile(I)I

    move-result v3

    iput v3, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mEffectiveUserId:I
    ...
    iput-object v3, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    .line 94
    invoke-direct {p0}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->isFingerprintDisallowedByStrongAuth()Z

    move-result v3

    iput-boolean v3, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mIsStrongAuthRequired:Z

    .line 95
    iget-boolean v3, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mAllowFpAuthentication:Z

    if-eqz v3, :cond_0

    invoke-direct {p0}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->isFingerprintDisabledByAdmin()Z
    ...
    .line 96
    iget-boolean v3, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mReturnCredentials:Z
    ...
    .line 96
    iget-boolean v2, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mIsStrongAuthRequired:Z

    xor-int/lit8 v2, v2, 0x1

    .line 95
    :cond_0
    iput-boolean v2, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mAllowFpAuthentication:Z
...
.method public onPause()V
    ...
    .line 179
    iget-object v0, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mFingerprintHelper:Lcom/android/settings/fingerprint/FingerprintUiHelper;
...
.method public onResume()V
    ...
    .line 145
    invoke-virtual {p0}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->refreshLockScreen()V
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    iput-object v2, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mCancelButton:Landroid/widget/Button;
    ...
    iput-object v2, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mFingerprintIcon:Landroid/widget/ImageView;

    .line 104
    new-instance v4, Lcom/android/settings/fingerprint/FingerprintUiHelper;

    .line 105
    iget-object v5, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mFingerprintIcon:Landroid/widget/ImageView;
    ...
    iget v6, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mEffectiveUserId:I
    ...
    iput-object v4, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mFingerprintHelper:Lcom/android/settings/fingerprint/FingerprintUiHelper;
    ...
    iget-object v4, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mCancelButton:Landroid/widget/Button;
    ...
    .line 110
    iget-object v2, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mCancelButton:Landroid/widget/Button;

    new-instance v3, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment$2;

    invoke-direct {v3, p0}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment$2;-><init>(Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;)V
    ...
    .line 122
    invoke-direct {p0, p1, v0}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->setWorkChallengeBackground(Landroid/view/View;I)V
...
.method protected refreshLockScreen()V
    ...
    .prologue
    .line 149
    iget-boolean v0, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mAllowFpAuthentication:Z
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->isProfileChallenge()Z
    ...
    .line 157
    iget-object v0, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->updateErrorMessage(I)V
...
.method protected showError(IJ)V
    ...
    .prologue
    .line 324
    invoke-virtual {p0, p1}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->getText(I)Ljava/lang/CharSequence;

    move-result-object v0

    invoke-virtual {p0, v0, p2, p3}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->showError(Ljava/lang/CharSequence;J)V
...
.method protected showError(Ljava/lang/CharSequence;J)V
    ...
    .prologue
    .line 313
    iget-object v0, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mErrorTextView:Landroid/widget/TextView;

    invoke-virtual {v0, p1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    .line 314
    invoke-virtual {p0}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->onShowError()V

    .line 315
    iget-object v0, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mHandler:Landroid/os/Handler;

    iget-object v1, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mResetErrorRunnable:Ljava/lang/Runnable;
...
.method protected updateErrorMessage(I)V
    ...
    .line 281
    iget-object v4, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    iget v5, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mEffectiveUserId:I
    ...
    invoke-virtual {p0}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->getLastTryErrorMessage()I
    ...
    invoke-direct {p0, v3, v1, v4, v7}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->showDialog(Ljava/lang/String;Ljava/lang/String;IZ)V
    ...
    :cond_0
    :goto_0
    iget-object v4, p0, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->mErrorTextView:Landroid/widget/TextView;
    ...
    invoke-virtual {p0, v1, v4, v5}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->showError(Ljava/lang/CharSequence;J)V
    ...
    invoke-direct {p0, v6, v1, v4, v8}, Lcom/android/settings/OxygenConfirmDeviceCredentialBaseFragment;->showDialog(Ljava/lang/String;Ljava/lang/String;IZ)V
