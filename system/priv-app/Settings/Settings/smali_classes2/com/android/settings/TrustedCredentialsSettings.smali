...
.method static synthetic -get0(Lcom/android/settings/TrustedCredentialsSettings;)Ljava/util/Set;
    .locals 1
    .param p0, "-this"    # Lcom/android/settings/TrustedCredentialsSettings;
...
.method static synthetic -set0(Lcom/android/settings/TrustedCredentialsSettings;Lcom/android/settings/TrustedCredentialsSettings$AliasOperation;)Lcom/android/settings/TrustedCredentialsSettings$AliasOperation;
    .locals 0
    .param p0, "-this"    # Lcom/android/settings/TrustedCredentialsSettings;
    .param p1, "-value"    # Lcom/android/settings/TrustedCredentialsSettings$AliasOperation;
...
.method private addTab(Lcom/android/settings/TrustedCredentialsSettings$Tab;)V
    ...
    invoke-direct {v1, p0, p1, v8}, Lcom/android/settings/TrustedCredentialsSettings$GroupAdapter;-><init>(Lcom/android/settings/TrustedCredentialsSettings;Lcom/android/settings/TrustedCredentialsSettings$Tab;Lcom/android/settings/TrustedCredentialsSettings$GroupAdapter;)V

    .line 284
    .local v1, "groupAdapter":Lcom/android/settings/TrustedCredentialsSettings$GroupAdapter;
    iget-object v8, p0, Lcom/android/settings/TrustedCredentialsSettings;->mGroupAdapters:Ljava/util/ArrayList;
    ...
    invoke-static {v8}, Lcom/oneplus/settings/utils/OPUtils;->hasMultiAppProfiles(Landroid/os/UserManager;)Z
    ...
    invoke-virtual {v1, v8}, Lcom/android/settings/TrustedCredentialsSettings$GroupAdapter;->getChildAdapter(I)Lcom/android/settings/TrustedCredentialsSettings$ChildAdapter;
    ...
    .line 296
    invoke-virtual {v1, v11}, Lcom/android/settings/TrustedCredentialsSettings$GroupAdapter;->getUserInfoByGroup(I)Landroid/content/pm/UserInfo;
    ...
    invoke-virtual {v2, v8}, Lcom/android/settings/TrustedCredentialsSettings$ChildAdapter;->setContainerViewId(I)V

    .line 301
    invoke-virtual {v2, v11}, Lcom/android/settings/TrustedCredentialsSettings$ChildAdapter;->showHeader(Z)V
    ...
    invoke-virtual {v6, v8}, Lcom/android/settings/TrustedCredentialsSettings$ChildAdapter;->setContainerViewId(I)V

    .line 308
    invoke-virtual {v6, v11}, Lcom/android/settings/TrustedCredentialsSettings$ChildAdapter;->showHeader(Z)V

    .line 309
    invoke-virtual {v6, v11}, Lcom/android/settings/TrustedCredentialsSettings$ChildAdapter;->showDivider(Z)V
    ...
    .restart local v3    # "personalIndex":I
    goto :goto_2
