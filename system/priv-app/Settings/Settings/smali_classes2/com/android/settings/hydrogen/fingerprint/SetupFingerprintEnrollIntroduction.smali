.class public Lcom/android/settings/hydrogen/fingerprint/SetupFingerprintEnrollIntroduction;
.super Lcom/android/settings/hydrogen/fingerprint/FingerprintEnrollIntroduction;
...
.method public constructor <init>()V
    ...
    .prologue
    .line 44
    invoke-direct {p0}, Lcom/android/settings/hydrogen/fingerprint/FingerprintEnrollIntroduction;-><init>()V
...
.method public finish()V
    ...
    .prologue
    .line 148
    invoke-super {p0}, Lcom/android/settings/hydrogen/fingerprint/FingerprintEnrollIntroduction;->finish()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/settings/hydrogen/fingerprint/SetupFingerprintEnrollIntroduction;->overridePendingTransition(II)V
...
.method protected getChooseLockIntent()Landroid/content/Intent;
    ...
    invoke-virtual {p0}, Lcom/android/settings/hydrogen/fingerprint/SetupFingerprintEnrollIntroduction;->getIntent()Landroid/content/Intent;
...
.method protected getFindSensorIntent()Landroid/content/Intent;
    ...
    const-class v1, Lcom/android/settings/hydrogen/fingerprint/SetupFingerprintEnrollFindSensor;
...
.method protected initViews()V
    ...
    .line 71
    invoke-virtual {p0}, Lcom/android/settings/hydrogen/fingerprint/SetupFingerprintEnrollIntroduction;->getActionBar()Landroid/app/ActionBar;
    ...
    invoke-virtual {p0, v6}, Lcom/android/settings/hydrogen/fingerprint/SetupFingerprintEnrollIntroduction;->findViewById(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v6}, Lcom/android/settings/hydrogen/fingerprint/SetupFingerprintEnrollIntroduction;->getText(I)Ljava/lang/CharSequence;
    ...
    .line 89
    invoke-virtual {p0}, Lcom/android/settings/hydrogen/fingerprint/SetupFingerprintEnrollIntroduction;->getNavigationBar()Lcom/android/setupwizardlib/view/NavigationBar;
    ...
    .line 94
    invoke-virtual {p0}, Lcom/android/settings/hydrogen/fingerprint/SetupFingerprintEnrollIntroduction;->getResources()Landroid/content/res/Resources;
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 125
    invoke-virtual {p0, v2}, Lcom/android/settings/hydrogen/fingerprint/SetupFingerprintEnrollIntroduction;->startActivity(Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, v4, v5}, Lcom/android/settings/hydrogen/fingerprint/SetupFingerprintEnrollIntroduction;->overridePendingTransition(II)V

    .line 127
    invoke-virtual {p0}, Lcom/android/settings/hydrogen/fingerprint/SetupFingerprintEnrollIntroduction;->finish()V
    :try_end_0
    ...
    :cond_1
    :goto_1
    invoke-super {p0, p1, p2, p3}, Lcom/android/settings/hydrogen/fingerprint/FingerprintEnrollIntroduction;->onActivityResult(IILandroid/content/Intent;)V
...
.method protected onApplyThemeResource(Landroid/content/res/Resources$Theme;IZ)V
    ...
    .line 66
    invoke-super {p0, p1, p2, p3}, Lcom/android/settings/hydrogen/fingerprint/FingerprintEnrollIntroduction;->onApplyThemeResource(Landroid/content/res/Resources$Theme;IZ)V
...
.method protected onCancelButtonClick()V
    ...
    .line 140
    invoke-static {v1}, Lcom/android/settings/hydrogen/fingerprint/SetupSkipDialog;->newInstance(Z)Lcom/android/settings/hydrogen/fingerprint/SetupSkipDialog;

    move-result-object v0

    .line 142
    .local v0, "dialog":Lcom/android/settings/hydrogen/fingerprint/SetupSkipDialog;
    invoke-virtual {p0}, Lcom/android/settings/hydrogen/fingerprint/SetupFingerprintEnrollIntroduction;->getFragmentManager()Landroid/app/FragmentManager;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/android/settings/hydrogen/fingerprint/SetupSkipDialog;->show(Landroid/app/FragmentManager;)V
