...
.method public static formatBytes(Landroid/content/res/Resources;JI)Lcom/oneplus/settings/utils/OPFormatter$BytesResult;
    ...
    .line 177
    .local v5, "rounded":Lcom/oneplus/settings/utils/OPFormatter$RoundedBytesResult;
    ...
    iget v7, v5, Lcom/oneplus/settings/utils/OPFormatter$RoundedBytesResult;->fractionDigits:I

    invoke-static {v2, v7}, Lcom/oneplus/settings/utils/OPFormatter;->getNumberFormatter(Ljava/util/Locale;I)Landroid/icu/text/NumberFormat;

    move-result-object v3

    .line 179
    .local v3, "numberFormatter":Landroid/icu/text/NumberFormat;
    iget v7, v5, Lcom/oneplus/settings/utils/OPFormatter$RoundedBytesResult;->value:F
    ...
    iget-object v7, v5, Lcom/oneplus/settings/utils/OPFormatter$RoundedBytesResult;->units:Landroid/icu/util/MeasureUnit;
    ...
    sget-object v8, Lcom/oneplus/settings/utils/OPFormatter;->PETABYTE:Landroid/icu/util/MeasureUnit;
    ...
    invoke-static {p0, v7}, Lcom/oneplus/settings/utils/OPFormatter;->getSuffixOverride(Landroid/content/res/Resources;Landroid/icu/util/MeasureUnit;)Ljava/lang/String;
    ...
    :goto_0
    new-instance v7, Lcom/oneplus/settings/utils/OPFormatter$BytesResult;

    iget-wide v8, v5, Lcom/oneplus/settings/utils/OPFormatter$RoundedBytesResult;->roundedBytes:J

    invoke-direct {v7, v1, v6, v8, v9}, Lcom/oneplus/settings/utils/OPFormatter$BytesResult;-><init>(Ljava/lang/String;Ljava/lang/String;J)V
    ...
    iget-object v8, v5, Lcom/oneplus/settings/utils/OPFormatter$RoundedBytesResult;->units:Landroid/icu/util/MeasureUnit;

    .line 188
    invoke-static {v2, v3, v7, v8}, Lcom/oneplus/settings/utils/OPFormatter;->formatMeasureShort(Ljava/util/Locale;Landroid/icu/text/NumberFormat;FLandroid/icu/util/MeasureUnit;)Ljava/lang/String;

    move-result-object v0

    .line 190
    .local v0, "formattedMeasure":Ljava/lang/String;
    invoke-static {v0, v1}, Lcom/oneplus/settings/utils/OPFormatter;->deleteFirstFromString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    .line 191
    .local v4, "numberRemoved":Ljava/lang/String;
    sget-object v7, Lcom/oneplus/settings/utils/OPFormatter;->SPACES_AND_CONTROLS:Landroid/icu/text/UnicodeSetSpanner;
...
.method private static formatRoundedBytesResult(Landroid/content/Context;Lcom/oneplus/settings/utils/OPFormatter$RoundedBytesResult;)Ljava/lang/String;
    ...
    iget v3, p1, Lcom/oneplus/settings/utils/OPFormatter$RoundedBytesResult;->fractionDigits:I

    invoke-static {v1, v3}, Lcom/oneplus/settings/utils/OPFormatter;->getNumberFormatter(Ljava/util/Locale;I)Landroid/icu/text/NumberFormat;
    ...
    sget-object v4, Lcom/oneplus/settings/utils/OPFormatter;->PETABYTE:Landroid/icu/util/MeasureUnit;

    if-ne v3, v4, :cond_1

    .line 166
    :cond_0
    iget v3, p1, Lcom/oneplus/settings/utils/OPFormatter$RoundedBytesResult;->value:F
    ...
    iget-object v5, p1, Lcom/oneplus/settings/utils/OPFormatter$RoundedBytesResult;->units:Landroid/icu/util/MeasureUnit;

    invoke-static {v4, v5}, Lcom/oneplus/settings/utils/OPFormatter;->getSuffixOverride(Landroid/content/res/Resources;Landroid/icu/util/MeasureUnit;)Ljava/lang/String;
    ...
    iget-object v4, p1, Lcom/oneplus/settings/utils/OPFormatter$RoundedBytesResult;->units:Landroid/icu/util/MeasureUnit;

    invoke-static {v1, v2, v3, v4}, Lcom/oneplus/settings/utils/OPFormatter;->formatMeasureShort(Ljava/util/Locale;Landroid/icu/text/NumberFormat;FLandroid/icu/util/MeasureUnit;)Ljava/lang/String;
...
.method public static formatShortElapsedTimeRoundingUpToMinutes(Landroid/content/Context;J)Ljava/lang/String;
    ...
    invoke-static {p0, v4, v5}, Lcom/oneplus/settings/utils/OPFormatter;->formatShortElapsedTime(Landroid/content/Context;J)Ljava/lang/String;
