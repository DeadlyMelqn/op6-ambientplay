...
.method static synthetic -get0(Lcom/oneplus/settings/quickpay/QuickPaySettings;)Landroid/support/v14/preference/SwitchPreference;
    .locals 1
    .param p0, "-this"    # Lcom/oneplus/settings/quickpay/QuickPaySettings;
...
.method private showConfirmChangeHomeAction(ZI)V
    ...
    invoke-virtual {v3, v5, v4}, Lcom/android/settings/SettingsActivity;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v4}, Lcom/android/settings/SettingsActivity;->getString(I)Ljava/lang/String;
...
.method private updatePreferenceState()V
    ...
    .line 206
    new-instance v8, Lcom/android/settings/location/RadioButtonPreference;

    iget-object v11, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->mActivity:Lcom/android/settings/SettingsActivity;

    invoke-direct {v8, v11}, Lcom/android/settings/location/RadioButtonPreference;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v8, v11}, Lcom/android/settings/location/RadioButtonPreference;->setKey(Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v11}, Lcom/android/settings/location/RadioButtonPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v8, v11}, Lcom/android/settings/location/RadioButtonPreference;->setChecked(Z)V
    ...
    check-cast v11, Lcom/android/settings/location/RadioButtonPreference;

    const/4 v12, 0x1

    invoke-virtual {v11, v12}, Lcom/android/settings/location/RadioButtonPreference;->setChecked(Z)V
    ...
    invoke-virtual {v11, v12}, Landroid/support/v14/preference/SwitchPreference;->setEnabled(Z)V
...
.method public onPreferenceClick(Landroid/support/v7/preference/Preference;)Z
    ...
    check-cast v2, Lcom/android/settings/location/RadioButtonPreference;

    .line 320
    .local v2, "p":Lcom/android/settings/location/RadioButtonPreference;
    invoke-virtual {v2, v8}, Lcom/android/settings/location/RadioButtonPreference;->setChecked(Z)V

    goto :goto_1

    .end local v2    # "p":Lcom/android/settings/location/RadioButtonPreference;
    :cond_0
    move-object v4, p1
    ...
    .line 323
    .local v4, "rbp":Lcom/android/settings/location/RadioButtonPreference;
    invoke-virtual {v4, v9}, Lcom/android/settings/location/RadioButtonPreference;->setChecked(Z)V
    ...
    .end local v4    # "rbp":Lcom/android/settings/location/RadioButtonPreference;
    :cond_1
    add-int/lit8 v0, v0, 0x1
