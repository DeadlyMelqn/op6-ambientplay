...
.method private getElementById(Lcom/caverock/androidsvg/SVG$SvgContainer;Ljava/lang/String;)Lcom/caverock/androidsvg/SVG$SvgElementBase;
    ...
    .line 2032
    .local v3, "elem":Lcom/caverock/androidsvg/SVG$SvgElementBase;
    ...
    .line 2039
    .local v2, "childElem":Lcom/caverock/androidsvg/SVG$SvgElementBase;
    ...
    .end local v2    # "childElem":Lcom/caverock/androidsvg/SVG$SvgElementBase;
    ...
    .restart local v1    # "child":Lcom/caverock/androidsvg/SVG$SvgObject;
    .restart local v2    # "childElem":Lcom/caverock/androidsvg/SVG$SvgElementBase;
    :cond_2
    return-object v2
...
.method private getElementsByTagName(Lcom/caverock/androidsvg/SVG$SvgContainer;Ljava/lang/Class;)Ljava/util/List;
    ...
    .line 2065
    .local v2, "result":Ljava/util/List;, "Ljava/util/List<Lcom/caverock/androidsvg/SVG$SvgObject;>;"
    ...
    .line 2071
    :goto_2
    instance-of v3, v1, Lcom/caverock/androidsvg/SVG$SvgContainer;
...
.method public getDocumentAspectRatio()F
    ...
    iget-object v1, v2, Lcom/caverock/androidsvg/SVG$Svg;->width:Lcom/caverock/androidsvg/SVG$Length;

    .line 744
    .local v1, "w":Lcom/caverock/androidsvg/SVG$Length;
    iget-object v2, p0, Lcom/caverock/androidsvg/SVG;->rootElement:Lcom/caverock/androidsvg/SVG$Svg;

    iget-object v0, v2, Lcom/caverock/androidsvg/SVG$Svg;->height:Lcom/caverock/androidsvg/SVG$Length;
    ...
    .line 741
    .end local v0    # "h":Lcom/caverock/androidsvg/SVG$Length;
    .end local v1    # "w":Lcom/caverock/androidsvg/SVG$Length;
    :cond_2
    new-instance v2, Ljava/lang/IllegalArgumentException;

    const-string/jumbo v3, "SVG document is empty"
    ...
    .line 747
    .restart local v0    # "h":Lcom/caverock/androidsvg/SVG$Length;
    .restart local v1    # "w":Lcom/caverock/androidsvg/SVG$Length;
    :cond_3
    if-eqz v0, :cond_0
...
.method public getViewList()Ljava/util/Set;
    ...
    .line 512
    const-class v5, Lcom/caverock/androidsvg/SVG$View;

    invoke-virtual {p0, v5}, Lcom/caverock/androidsvg/SVG;->getElementsByTagName(Ljava/lang/Class;)Ljava/util/List;

    move-result-object v3

    .line 514
    .local v3, "viewElems":Ljava/util/List;, "Ljava/util/List<Lcom/caverock/androidsvg/SVG$SvgObject;>;"
    ...
    .line 515
    .local v4, "viewIds":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    invoke-interface {v3}, Ljava/util/List;->iterator()Ljava/util/Iterator;
    ...
    .local v1, "elem":Lcom/caverock/androidsvg/SVG$SvgObject;
    move-object v2, v1
    ...
    iget-object v5, v2, Lcom/caverock/androidsvg/SVG$View;->id:Ljava/lang/String;

    if-nez v5, :cond_1

    .line 521
    const-string/jumbo v5, "AndroidSVG"

    const-string/jumbo v6, "getViewList(): found a <view> without an id attribute"
    ...
    .end local v1    # "elem":Lcom/caverock/androidsvg/SVG$SvgObject;
    .end local v2    # "view":Lcom/caverock/androidsvg/SVG$View;
    .end local v3    # "viewElems":Ljava/util/List;, "Ljava/util/List<Lcom/caverock/androidsvg/SVG$SvgObject;>;"
    .end local v4    # "viewIds":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    :cond_0
    new-instance v5, Ljava/lang/IllegalArgumentException;

    const-string/jumbo v6, "SVG document is empty"
    ...
    .restart local v1    # "elem":Lcom/caverock/androidsvg/SVG$SvgObject;
    .restart local v2    # "view":Lcom/caverock/androidsvg/SVG$View;
    .restart local v3    # "viewElems":Ljava/util/List;, "Ljava/util/List<Lcom/caverock/androidsvg/SVG$SvgObject;>;"
    .restart local v4    # "viewIds":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    :cond_1
    iget-object v5, v2, Lcom/caverock/androidsvg/SVG$View;->id:Ljava/lang/String;
...
.method public renderToPicture()Landroid/graphics/Picture;
    ...
    .line 262
    .end local v0    # "h":F
    .restart local v1    # "height":Lcom/caverock/androidsvg/SVG$Length;
    :cond_2
    iget v5, p0, Lcom/caverock/androidsvg/SVG;->renderDPI:F
...
.method public renderViewToCanvas(Ljava/lang/String;Landroid/graphics/Canvas;Landroid/graphics/RectF;)V
    ...
    .line 421
    .restart local v3    # "view":Lcom/caverock/androidsvg/SVG$View;
    :cond_2
    const-string/jumbo v4, "AndroidSVG"

    const-string/jumbo v5, "View element is missing a viewBox attribute."
...
.method public renderViewToPicture(Ljava/lang/String;II)Landroid/graphics/Picture;
    ...
    invoke-direct {v5, v9, v9, v6, v7}, Lcom/caverock/androidsvg/SVG$Box;-><init>(FFFF)V
    ...
    invoke-virtual {v3, p0, v6, v7, v10}, Lcom/caverock/androidsvg/SVGAndroidRenderer;->renderDocument(Lcom/caverock/androidsvg/SVG;Lcom/caverock/androidsvg/SVG$Box;Lcom/caverock/androidsvg/PreserveAspectRatio;Z)V
    ...
    .end local v3    # "renderer":Lcom/caverock/androidsvg/SVGAndroidRenderer;
    ...
    .line 322
    .restart local v4    # "view":Lcom/caverock/androidsvg/SVG$View;
    :cond_2
    const-string/jumbo v6, "AndroidSVG"

    const-string/jumbo v7, "View element is missing a viewBox attribute."
...
.method public setDocumentHeight(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "SVG document is empty"
