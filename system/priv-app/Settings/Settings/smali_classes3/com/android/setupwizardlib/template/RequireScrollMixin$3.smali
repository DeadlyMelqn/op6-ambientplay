...
.method public onRequireScrollStateChanged(Z)V
    ...
    .prologue
    .line 202
    iget-object v1, p0, Lcom/android/setupwizardlib/template/RequireScrollMixin$3;->val$button:Landroid/widget/Button;

    if-eqz p1, :cond_0

    iget-object v0, p0, Lcom/android/setupwizardlib/template/RequireScrollMixin$3;->val$moreText:Ljava/lang/CharSequence;
    ...
    .line 202
    :cond_0
    iget-object v0, p0, Lcom/android/setupwizardlib/template/RequireScrollMixin$3;->val$nextText:Ljava/lang/CharSequence;
