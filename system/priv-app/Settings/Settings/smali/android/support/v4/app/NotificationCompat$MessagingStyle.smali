...
.method public apply(Landroid/support/v4/app/NotificationBuilderWithBuilderAccessor;)V
    ...
    iget-object v10, p0, Landroid/support/v4/app/NotificationCompat$MessagingStyle;->mUserDisplayName:Ljava/lang/CharSequence;

    invoke-direct {v9, v10}, Landroid/app/Notification$MessagingStyle;-><init>(Ljava/lang/CharSequence;)V
    ...
    .line 2184
    .local v8, "style":Landroid/app/Notification$MessagingStyle;
    ...
    .local v6, "message$iterator":Ljava/util/Iterator;
    :goto_0
    ...
    .line 2193
    :cond_0
    invoke-virtual {v8, v1}, Landroid/app/Notification$MessagingStyle;->addMessage(Landroid/app/Notification$MessagingStyle$Message;)Landroid/app/Notification$MessagingStyle;
    ...
    invoke-virtual {v8, v9}, Landroid/app/Notification$MessagingStyle;->setBuilder(Landroid/app/Notification$Builder;)V

    .line 2229
    .end local v6    # "message$iterator":Ljava/util/Iterator;
    .end local v8    # "style":Landroid/app/Notification$MessagingStyle;
    :cond_2
    :goto_1
    return-void
    ...
    invoke-virtual {v0, v12, v9}, Landroid/text/SpannableStringBuilder;->insert(ILjava/lang/CharSequence;)Landroid/text/SpannableStringBuilder;

    .line 2222
    :cond_6
    invoke-virtual {v0, v12, v4}, Landroid/text/SpannableStringBuilder;->insert(ILjava/lang/CharSequence;)Landroid/text/SpannableStringBuilder;
    ...
    invoke-virtual {v9, v11}, Landroid/app/Notification$BigTextStyle;->setBigContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$BigTextStyle;
